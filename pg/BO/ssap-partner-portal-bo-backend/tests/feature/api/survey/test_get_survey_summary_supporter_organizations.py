...
class TestGetSurveySummarySupporterOrganizations:
    ...
    def test_sales_ok(
        ...
        response = client.get(
            "/api/surveys/summary/supporter-organizations?yearMonthFrom=202203&yearMonthTo=202212",
    ...
    def test_validation(self, mock_auth_admin, query_params):
        ...
        response = client.get(
            f"/api/surveys/summary/supporter-organizations{query_params}",
            headers=REQUEST_HEADERS,
        )
