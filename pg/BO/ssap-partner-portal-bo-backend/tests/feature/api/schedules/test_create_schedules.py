...
@freezegun.freeze_time("2022/03/31")
class TestCreateSchedules:
    @pytest.mark.parametrize(
        "project_id, body, expected, project_model",
        [
            (
                ...
                },
                {
                    ...
                    "projectSchedules": [
                        {
                            "yearMonth": "2022/04",
                            "scheduleId": "1788310e-a4ea-443d-8fb9-41b6f0bc4a91",
                            "scheduleGroupId": "627657ce-726f-4927-b024-36ac630d3f05",
                            ...
                            "createAt": "2022-06-15T01:01:44.650Z",
                            "updateId": None,
                            "updateAt": "2022-06-15T01:01:44.650Z",
                        },
                        {
                            "yearMonth": "2022/04",
                            "scheduleId": "1788310e-a4ea-443d-8fb9-41b6f0bc4a91",
    ...
    def test_ok_monthly(
        ...
        response = client.post(
            f"/api/schedules/support/{project_id}", json=body, headers=REQUEST_HEADERS
        )
    ...
    def test_not_found_project(self, mocker, mock_auth_admin):
        """プロジェクトが存在しない場合"""
        mock_auth_admin([UserRoleType.SYSTEM_ADMIN.key])
        mock_project = mocker.patch.object(ProjectModel, "get")
