<template>
  <DetailContainer
    :title="$t('survey.pages.index.section.completion')"
    :is-editing="false"
      ...
      <v-container fluid pa-0>
        <v-row no-gutters>
          <v-col>
            ...
            />
            <p class="mt-5 mb-0">
              <TextLink to="/survey/list?type=completion">
          ...
          <v-col class="pl-10">
            <Chart
              type="line"
              chart-id="SurveyTopCompletionContainer-chart-1"
              :width="530"
              :height="180"
...
import SurveyTopCompletionSort, {
  SearchParam,
} from '~/components/survey/organisms/SurveyTopCompletionSort.vue'
import SurveyTopCompletionTable from '~/components/survey/molecules/SurveyTopCompletionTable.vue'
...
export default BaseComponent.extend({
  ...
  data() {
    return {
      ...
      labels: {
        ...
        recommended: this.$t('survey.pages.index.table.label.recommended2'),
      } as any,
  ...
  methods: {
    ...
    search() {
      ...
      this.$emit(this.apiName, 'Completion', request)
    },
    /**
