<template>
  <CommonSort
    ...
    @clear="clear"
  >
    <SurveyTopServiceAndCompletionSortInput
      :param="param"
      v-on="$listeners"
      @update="update"
    />
...
import SurveyTopServiceAndCompletionSortInput from '~/components/survey/molecules/SurveyTopServiceAndCompletionSortInput.vue'
