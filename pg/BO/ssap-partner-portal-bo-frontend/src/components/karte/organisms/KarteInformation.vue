<template>
  <Sheet class="o-karte-information" style-set="infomation">
    <v-container pa-0>
      <!-- 支援期間 -->
      <v-row class="o-karte-information__unit">
        <v-col cols="auto">
          <p class="o-karte-information__label">
            {{ $t('karte.pages.list.infomation.supportDateFromTo') }}
          </p>
        </v-col>
        <v-col>
          {{ project.supportDateFrom }} 〜 {{ project.supportDateTo }}
        </v-col>
        <v-col class="d-flex justify-end pb-0 pt-2">
          <Button
            outlined
      ...
      <v-row class="o-karte-information__unit">
        <v-col cols="auto">
          <p class="o-karte-information__label">
            {{ $t('karte.pages.list.infomation.customerUsers') }}
          </p>
        </v-col>
        <v-col class="pt-1">
      ...
      <v-row class="o-karte-information__unit">
        <v-col cols="auto">
          <p class="o-karte-information__label">
            {{ $t('karte.pages.list.infomation.serviceManager') }}
          </p>
        </v-col>
        <v-col class="pt-1">
          <ul class="o-karte-information__list">
      ...
      <v-row class="o-karte-information__unit">
        <v-col cols="auto">
          <p class="o-karte-information__label">
            {{ $t('karte.pages.list.infomation.producer') }}
          </p>
        </v-col>
        <v-col class="pt-1">
          <ul class="o-karte-information__list">
      ...
      <v-row class="o-karte-information__unit">
        <v-col cols="auto">
          <p class="o-karte-information__label">
            {{ $t('karte.pages.list.infomation.accelerator') }}
          </p>
        </v-col>
        <v-col class="pt-1">
          <ul class="o-karte-information__list">
        ...
        <v-col>
          <v-col class="o-karte-information-customer-success">
            <v-col class="o-karte-information-customer-success__title mb-3">
              ...
              <p class="o-karte-information__label">
                {{ $t('karte.pages.list.infomation.customerSuccess') }}
              </p>
            </v-col>
