    ...
    async save() {
      ...
      if (!this.isAssigned) {
        if (!this.selectedCustomerId) {
          ...
          this.localCustomer.customerId = this.selectedCustomerId
