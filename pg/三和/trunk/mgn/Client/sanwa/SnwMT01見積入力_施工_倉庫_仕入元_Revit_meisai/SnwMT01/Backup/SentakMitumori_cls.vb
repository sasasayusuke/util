Option Strict Off
Option Explicit On
Friend Class SentakMitumori_cls
	...
	Private m_Parent As clsMitumoriH
	...
	Private Sub SentakMitumori_cls_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "見積番号", CInt(VB6.TwipsToPixelsX(1200)))
			.Columns.Add("", "見積日付", CInt(VB6.TwipsToPixelsX(1200)))
			.Columns.Add("", "種別", CInt(VB6.TwipsToPixelsX(1000)))
			.Columns.Add("", "得意先", CInt(VB6.TwipsToPixelsX(900)))
			.Columns.Add("", "見積件名", CInt(VB6.TwipsToPixelsX(3500)))
			.Columns.Add("", "見積金額", CInt(VB6.TwipsToPixelsX(1500)))
			.Columns.Add("", "出力日", CInt(VB6.TwipsToPixelsX(1200)))
			.Columns.Add("", "発注日", CInt(VB6.TwipsToPixelsX(1200)))
			.Columns.Add("", "売上状況", CInt(VB6.TwipsToPixelsX(1200)))
			...
			'UPGRADE_WARNING: コレクション SelListVw.ColumnHeaders の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
			.Columns.Item(6).TextAlign = System.Windows.Forms.HorizontalAlignment.Right
			'UPGRADE_WARNING: コレクション SelListVw.ColumnHeaders の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
			.Columns.Item(7).TextAlign = System.Windows.Forms.HorizontalAlignment.Center
			'UPGRADE_WARNING: コレクション SelListVw.ColumnHeaders の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
			.Columns.Item(8).TextAlign = System.Windows.Forms.HorizontalAlignment.Center
		End With
		
		SelListVw.Width = VB6.TwipsToPixelsX(12900 + 330) 'スクロールバー分プラス
...
Form_Load_Err: 
	...
	Private Sub SentakMitumori_cls_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub SentakMitumori_cls_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
...
EventExitSub: 
	...
	Private Sub SentakMitumori_cls_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
...
Item_Check_Err: 
	...
	Private Function Download() As Boolean
		...
		Do Until rs.EOF
			...
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(1).Value), ""), "yy/mm/dd")))
			...
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(5).Value), ""), "#,##0")))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(6).Value), ""), "yy/mm/dd")))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(7).Value), ""), "yy/mm/dd")))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Private Sub tx_得意先CD_SpcKeyPress(ByRef KeyAscii As Short, ByRef Cancel As Boolean)
