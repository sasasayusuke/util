...
Friend Class SirSen_cls
	...
	Private Sub SirSen_cls_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub SirSen_cls_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub SirSen_cls_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim i, j As Short
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "仕入先CD", CInt(VB6.TwipsToPixelsX(1050)))
			.Columns.Add("", "仕入先名1", CInt(VB6.TwipsToPixelsX(3500)))
			.Columns.Add("", "仕入先名2", CInt(VB6.TwipsToPixelsX(3500)))
		End With
...
Form_Load_Err: 
	...
	Private Sub SirSen_cls_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Function Download() As Boolean
		...
		If [tx_検索ID].Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " 仕入先CD >= '" & SQLString([tx_検索ID]) & "'"
		End If
		If tx_検索名.Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " 仕入先名1 LIKE '%" & SQLString(tx_検索名) & "%'"
		End If
