...
Friend Class HaiSen_cls
	...
	Private Sub HaiSen_cls_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub HaiSen_cls_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub HaiSen_cls_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim i, j As Short
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "配送先CD", CInt(VB6.TwipsToPixelsX(1050)))
			.Columns.Add("", "配送先名1", CInt(VB6.TwipsToPixelsX(3500)))
			.Columns.Add("", "配送先名2", CInt(VB6.TwipsToPixelsX(3500)))
		End With
...
Form_Load_Err: 
	...
	Private Sub HaiSen_cls_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Function Download() As Boolean
		...
		If [tx_検索ID].Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " 配送先CD >= '" & SQLString([tx_検索ID]) & "'"
		End If
		If tx_検索名.Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " 配送先名1 LIKE '%" & SQLString(tx_検索名) & "%'"
		End If
