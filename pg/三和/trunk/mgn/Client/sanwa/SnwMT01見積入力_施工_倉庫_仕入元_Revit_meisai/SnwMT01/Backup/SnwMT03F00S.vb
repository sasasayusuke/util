...
Friend Class SnwMT03F00S
	...
	Private Sub SnwMT03F00S_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "見積番号", CInt(VB6.TwipsToPixelsX(1040)))
			.Columns.Add("", "見積日付", CInt(VB6.TwipsToPixelsX(1040)))
			.Columns.Add("", "種別", CInt(VB6.TwipsToPixelsX(800)))
			...
			.Columns.Add("", "出力日", CInt(VB6.TwipsToPixelsX(900)))
			.Columns.Add("", "発注日", CInt(VB6.TwipsToPixelsX(900)))
...
Form_Load_Err: 
	...
	Private Sub SnwMT03F00S_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub SnwMT03F00S_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
...
EventExitSub: 
	...
	Private Sub SnwMT03F00S_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
...
Item_Check_Err: 
	...
	Private Function Download() As Boolean
		...
		Do Until rs.EOF
			...
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(1).Value), ""), "mm/dd")))
			...
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(5).Value), ""), "#,##0" & KIN_FMT)))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(6).Value), ""), "mm/dd")))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(VB6.Format(NullToZero((rs.Fields(7).Value), ""), "mm/dd")))
			rs.MoveNext()
		Loop 
		ReleaseRs(rs)
