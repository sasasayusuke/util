...
<System.Runtime.InteropServices.ProgId("ExDateTextBoxY_NET.ExDateTextBoxY")> Public Class ExDateTextBoxY
	...
	Public Sub Undo()
		...
		'    lret = SendMessage(ExDateTextY.Hwnd, EM_CANUNDO, 0, 0)
		'    If lret <> 0 Then
		...
		ExDateTextY.Text = vUNDOBUF
		'    End If
		'    Call SendMessage(ExDateTextY.Hwnd, EM_UNDO, 0, ByVal 0&)
		'    Call EmptyUndoBuffer
	End Sub
	
	Public Sub EmptyUndoBuffer()
		'UPGRADE_WARNING: オブジェクト vUNDOBUF の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		vUNDOBUF = ExDateTextY.Text
		'    Call SendMessage(ExDateTextY.Hwnd, EM_EMPTYUNDOBUFFER, 0, ByVal 0&)
	End Sub
	
	'UPGRADE_WARNING: イベント ExDateTextY.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
	Private Sub ExDateTextY_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles ExDateTextY.TextChanged
		RaiseEvent Change(Me, Nothing)
	End Sub
	
	Private Sub ExDateTextY_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles ExDateTextY.Click
		RaiseEvent Click(Me, Nothing)
	End Sub
	
	Private Sub ExDateTextY_DoubleClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles ExDateTextY.DoubleClick
		RaiseEvent DblClick(Me, Nothing)
	End Sub
	
	Private Sub ExDateTextY_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles ExDateTextY.Enter
		ExDateTextY.BackColor = pFocusBackColor
		...
		If pSelectText Then
			If fClicking = False Then
				ExDateTextY.SelectionStart = 0
				ExDateTextY.SelectionLength = Len(ExDateTextY.Text)
			End If
		End If
	End Sub
	
	Private Sub ExDateTextY_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles ExDateTextY.Leave
		If IsNumeric(ExDateTextY.Text) Then
			'''        If ExDateTextY < 1753 Then      '2002/1/11
			'''            ExDateTextY = 1753
			If CDbl(ExDateTextY.Text) < 1900 Then '2002/5/28
				'UPGRADE_WARNING: オブジェクト vUNDOBUF の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				ExDateTextY.Text = vUNDOBUF
			End If
			''''                    If ExDateTextY < 100 Then                   '2005/02/14 ADD
			''''                        ExDateTextY = 2000 + ExDateTextY
			''''                    Else
			''''                        If ExDateTextY < 1753 Then
			''''                            ExDateTextY = vUNDOBUF
			''''                        End If
			''''                    End If
		End If
		ExDateTextY.BackColor = hBackColor
		On Error Resume Next
	...
	Private Sub ExDateTextY_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles ExDateTextY.KeyDown
		...
		''                If Len(ExDateTextY.Text) <> 0 Then
		''                    If Len(ExDateTextY.Text) <> Len(ExDateTextY.SelText) Then
		''                        ExDateTextY.SelStart = Len(ExDateTextY.Text) - 1
		''                        ExDateTextY.SelLength = Len(ExDateTextY.Text)
		''                    End If
		''                End If
		''        End Select
		''    End If
		...
		ElseIf KeyCode = System.Windows.Forms.Keys.Down Then 
			If pCanNextSetFocus = True And CtlCursorCondition(ExDateTextY) = -1 Then
				KeyCode = 0
				Call NextSetFocus()
			Else
				KeyCode = 0
		...
		ElseIf KeyCode = System.Windows.Forms.Keys.Up Then 
			If pCanForwardSetFocus = True And CtlCursorCondition(ExDateTextY) = -1 Then
				KeyCode = 0
		...
		ElseIf KeyCode = System.Windows.Forms.Keys.Insert Then 
			'入力モードにする
			KeyCode = 0
			If CtlCursorCondition(ExDateTextY) = -1 Then
				ExDateTextY.SelectionStart = Len(ExDateTextY.Text)
			Else
				ExDateTextY.SelectionStart = 0
				ExDateTextY.SelectionLength = Len(ExDateTextY.Text)
			End If
	...
	Private Sub ExDateTextY_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles ExDateTextY.KeyPress
		...
		If KeyAscii <> 8 Then ' バックスペースは例外
			If InStr(Numbers, Chr(KeyAscii)) = 0 Then
				...
				GoTo EventExitSub
			End If
			strText = InsStrToTextBox(ExDateTextY, Chr(KeyAscii))
			If InStr(strText, "0") = 1 Then '2005/02/14 del
				KeyAscii = 0
			End If
			''        If Len(strText) <= 4 Then
			''            If strText < 1753 Then
			''                KeyAscii = 0
			''            End If
			''        Else
			''            KeyAscii = 0
...
EventExitSub: 
	...
	Private Sub ExDateTextY_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles ExDateTextY.KeyUp
		Dim KeyCode As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		RaiseEvent KeyUp(Me, New KeyUpEventArgs(KeyCode, Shift))
	End Sub
	
	Private Sub ExDateTextY_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles ExDateTextY.MouseDown
	...
	Private Sub ExDateTextY_MouseMove(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles ExDateTextY.MouseMove
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
	...
	Private Sub ExDateTextY_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles ExDateTextY.MouseUp
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
	...
	Private Sub ExDateTextBoxY_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Enter
		fGotFocus = True
		On Error Resume Next
		If Me.Hwnd <> MyParentName Then
			'UPGRADE_WARNING: オブジェクト vUNDOBUF の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Private Sub ExDateTextBoxY_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Leave
		fGotFocus = False
		fClicking = False
	End Sub
	
	Private Sub ExDateTextBoxY_GotFocus(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.GotFocus
		fGotFocus = True
	End Sub
	
	Private Sub ExDateTextBoxY_LostFocus(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.LostFocus
		fGotFocus = False
	End Sub
	...
	Private Sub UserControl_Terminate()
		...
		'WinMEでimm32.dllがこける。
		ExDateTextY.IMEMode = System.Windows.Forms.ImeMode.NoControl
	End Sub
	
	Private Sub ExDateTextBoxY_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
		With ExDateTextY
			.Top = 0
			.Left = 0
			.Width = MyBase.Width
			'UPGRADE_ISSUE: UserControl プロパティ ExDateTextBoxY.Extender はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
	...
	Private Sub UserControl_ReadProperties(ByRef PropBag As Object)
		...
		ExDateTextY.Text = PropBag.ReadProperty("Text", Text)
		'    ExDateTextY.Text = PropBag.ReadProperty("Appearance", 1)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Me.MaxLength = PropBag.ReadProperty("MaxLength", 4)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		'    ExDateTextY.IMEMode = PropBag.ReadProperty("IMEMode", 0)
		'UPGRADE_ISSUE: AmbientProperties プロパティ Ambient.Font はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		ExDateTextY.TextAlign = PropBag.ReadProperty("Alignment", 0)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_ISSUE: TextBox プロパティ ExDateTextY.Appearance はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		ExDateTextY.Appearance = PropBag.ReadProperty("Appearance", 1)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.ReadProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PropBag.ReadProperty() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		ExDateTextY.BorderStyle = PropBag.ReadProperty("BorderStyle", 1)
	...
	Private Sub UserControl_WriteProperties(ByRef PropBag As Object)
		...
		Call PropBag.WriteProperty("Text", ExDateTextY.Text)
		'    Call PropBag.WriteProperty("Text", ExDateTextY.Appearance)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.WriteProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		...
		'    Call PropBag.WriteProperty("IMEMode", ExDateTextY.IMEMode)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.WriteProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		...
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.WriteProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		Call PropBag.WriteProperty("Alignment", ExDateTextY.TextAlign, 0)
		'UPGRADE_ISSUE: TextBox プロパティ ExDateTextY.Appearance はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.WriteProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		Call PropBag.WriteProperty("Appearance", ExDateTextY.Appearance, 1)
		'UPGRADE_ISSUE: PropertyBag メソッド PropBag.WriteProperty はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		Call PropBag.WriteProperty("BorderStyle", ExDateTextY.BorderStyle, 1)
	...
	'''
	'''    fUndo = SendMessage(ExDateTextY.Hwnd, EM_CANUNDO, 0, ByVal 0&)
	'''
	...
	Public Overrides Property Text() As String
		Get
			Text = ExDateTextY.Text
		End Get
		Set(ByVal Value As String)
			ExDateTextY.Text = Value
	...
	Public Property Alignment() As System.Drawing.ContentAlignment
		Get
			Alignment = ExDateTextY.TextAlign
		End Get
		Set(ByVal Value As System.Drawing.ContentAlignment)
			ExDateTextY.TextAlign = Value
	...
	Public Property Appearance() As AppearanceType
		Get
			'UPGRADE_ISSUE: TextBox プロパティ ExDateTextY.Appearance はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
			Appearance = ExDateTextY.Appearance
		End Get
		Set(ByVal Value As AppearanceType)
			'UPGRADE_ISSUE: TextBox プロパティ ExDateTextY.Appearance はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
			ExDateTextY.Appearance = Value
	...
	Public Shadows Property BorderStyle() As BorderStyleType
		Get
			BorderStyle = ExDateTextY.BorderStyle
		End Get
		Set(ByVal Value As BorderStyleType)
			ExDateTextY.BorderStyle = Value
	...
	Public Shadows Property Enabled() As Boolean
		Get
			'''    Enabled = ExDateTextY.Enabled
			Enabled = MyBase.Enabled
		End Get
		Set(ByVal Value As Boolean)
			'''    ExDateTextY.Enabled = New_Enabled
	...
	Public Property Locked() As Boolean
		Get
			Locked = ExDateTextY.ReadOnly
		End Get
		Set(ByVal Value As Boolean)
			'    SendMessage m_hWnd, EM_SETREADONLY, NewProp, ByVal 0&
			ExDateTextY.ReadOnly = Value
	...
	Public Property MaxLength() As Integer
		Get
			'UPGRADE_WARNING: TextBox プロパティ ExDateTextY.MaxLength には新しい動作が含まれます。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"' をクリックしてください。
			MaxLength = ExDateTextY.Maxlength
		End Get
		Set(ByVal Value As Integer)
			'UPGRADE_WARNING: TextBox プロパティ ExDateTextY.MaxLength には新しい動作が含まれます。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"' をクリックしてください。
			ExDateTextY.Maxlength = Value
	...
	Public Property SelStart() As Integer
		Get
			SelStart = ExDateTextY.SelectionStart
		End Get
		Set(ByVal Value As Integer)
			If Not DesignMode = False Then Err.Raise(382)
			ExDateTextY.SelectionStart = Value
	...
	Public Property SelLength() As Integer
		Get
			SelLength = ExDateTextY.SelectionLength
		End Get
		Set(ByVal Value As Integer)
			If Not DesignMode = False Then Err.Raise(382)
			ExDateTextY.SelectionLength = Value
	...
	Public Property SelText() As String
		Get
			SelText = ExDateTextY.SelectedText
		End Get
		Set(ByVal Value As String)
			If Not DesignMode = False Then Err.Raise(382)
			ExDateTextY.SelectedText = Value
	...
	Public Overrides Property ForeColor() As System.Drawing.Color
		Get
			ForeColor = ExDateTextY.ForeColor
		End Get
		Set(ByVal Value As System.Drawing.Color)
			ExDateTextY.ForeColor = Value
	...
	Public Overrides Property BackColor() As System.Drawing.Color
		Get
			BackColor = ExDateTextY.BackColor
		End Get
		Set(ByVal Value As System.Drawing.Color)
			ExDateTextY.BackColor = Value
			hBackColor = Value
	...
	Public Overrides Property Font() As System.Drawing.Font
		Get
			Font = ExDateTextY.Font
		End Get
		Set(ByVal Value As System.Drawing.Font)
			ExDateTextY.Font = Value
			Call ExDateTextBoxY_Resize(Me, New System.EventArgs())
	...
	Public ReadOnly Property Hwnd() As Integer
		Get
			Hwnd = ExDateTextY.Handle.ToInt32
		End Get
	End Property
	'矢印キーでコントロール移動するか
	...
	Public Sub NextSetFocus()
		...
		If fGotFocus = True Then
			...
			Call PostMessage(ExDateTextY.Handle.ToInt32, WM_KEYDOWN, System.Windows.Forms.Keys.Tab, 0)
