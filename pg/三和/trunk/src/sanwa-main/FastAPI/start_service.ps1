...
$env:APP_ROOT = "C:\Users\NT-210174\Desktop\work\util\pg\三和\trunk\src\sanwa-main\FastAPI"
...
$env:DB_HOST = "192.168.10.54"

$env:DB_PORT = "1433"

# $env:DB_NAME = "SanwaSDB"
$env:DB_NAME = "SanwaSDB_241016"
# $env:DB_NAME = "SanwaOrg"
...
if ($env:ENVIRONMENT -in @('development', 'local', 'test-development-backup')) {
    try {
...
} elseif ($env:ENVIRONMENT -in @('product')) {
} else {
