...
Friend Class clsCSVReader
	...
	' Private フィールド
	Private mTextStream As Scripting.TextStream
...
Exception:
	...
	Public Sub CloseStream()
		If mTextStream IsNot Nothing Then
	...
	Private Function ReadForStateFindQuoteInQuote(ByVal stItem As String, ByVal chNext As String) As String
		Select Case chNext
			...
			Case """"
				...
				stItem = stItem & """"
			Case Else
				mState = EnumState.Error_Renamed
		End Select
