...
''' 2024/07/23 oosawa      予定業種区分が抜けていたので追加
''' </summary>
Public Class clsBukken
	...
	Private m_予定業種区分 As Integer '2024/07/23 ADD
	'2022/10/20↑
	...
	'   業種区分
	'//////////////////////////////////////
	Public Property 予定業種区分() As Integer
		Get
			予定業種区分 = m_予定業種区分
		End Get
		Set(ByVal Value As Integer)
	...
	Public Function GetbyID() As Boolean
		...
		With rs
			...
			Else
				...
				Me.見積予定日付 = .Fields("見積予定日付").Value
				Me.受注予定日付 = .Fields("受注予定日付").Value
				Me.仕入予定日付 = .Fields("仕入予定日付").Value
				Me.売上予定日付 = .Fields("売上予定日付").Value
				Me.検収予定日付 = .Fields("検収予定日付").Value
				Me.請求予定日付 = .Fields("請求予定日付").Value
				...
				Me.予定開始納期 = .Fields("予定納期S").Value
				Me.予定終了納期 = .Fields("予定納期E").Value
				Me.予定オープン日 = .Fields("予定オープン日").Value
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Me.予定物件種別 = NullToZero(.Fields("予定物件種別").Value)
				Me.予定受付日付 = .Fields("予定受付日付").Value
				Me.予定完工日付 = .Fields("予定完工日付").Value
				Me.予定請求予定日付 = .Fields("予定請求予定日付").Value
				'2022/10/20 ADD↑

				Me.予定業種区分 = NullToZero(.Fields("予定業種区分").Value) '2024/07/23 ADD
...
GetRs_Err:
	...
	Public Function Upload() As Boolean
		...
		With rs
			...
			.Fields("予定業種区分").Value = Me.予定業種区分 '2024/07/23 ADD
	...
	Private Function Get合計関係() As Boolean
		...
		With rs
			...
			Else
				...
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Me.出精値引計 = NullToZero(.Fields("出精値引計").Value)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Me.合計金額計 = NullToZero(.Fields("合計金額計").Value)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Me.原価金額合計 = NullToZero(.Fields("原価金額合計").Value)
				...
				If NullToZero(.Fields("合計金額計").Value) + NullToZero(.Fields("出精値引計").Value) = 0 Then
					Me.原価率計 = 0
				Else
					'UPGRADE_WARNING: オブジェクト NullToZero(rs!出精値引計) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'UPGRADE_WARNING: オブジェクト NullToZero(rs!合計金額計) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					Me.原価率計 = System.Math.Round(NullToZero(.Fields("原価金額合計").Value) / (NullToZero(.Fields("合計金額計").Value) + NullToZero(.Fields("出精値引計").Value)) * 100, 2)
				End If
			End If
		End With
