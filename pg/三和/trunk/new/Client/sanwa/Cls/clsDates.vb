...
Friend Class clsDates
	...
	Private Shared Function GetComputerName(lpBuffer As StringBuilder, ByRef nSize As Integer) As Boolean
	End Function
	...
	Public Function GetPCName() As String
		Dim strComputerNameBuffer As New StringBuilder(255) ' 最大255文字のバッファを用意
		...
		' コンピュータ名を表示
		GetPCName = Left(strComputerNameBuffer.ToString, InStr(strComputerNameBuffer.ToString, vbNullChar) - 1)
	End Function
	...
	Public Sub Initialize()
		'初期化
		'初期値を1桁多く設定する
		m_DateID = New String(" "c, m_MaxLength + 1)
