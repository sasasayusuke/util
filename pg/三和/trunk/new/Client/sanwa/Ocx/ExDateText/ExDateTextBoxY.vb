...
'	Implements ISupportInitialize
	...
	Public Sub Undo()
		...
		ExDateTextY.Text = vUNDOBUF.ToString
		'    End If
	...
	Private Sub ExDateTextY_TextChanged(sender As Object, e As EventArgs) Handles ExDateTextY.TextChanged
	...
	Private Sub ExDateTextY_Click(sender As Object, e As EventArgs) Handles ExDateTextY.Click
		RaiseEvent Click(Me, Nothing)
	End Sub

	Private Sub ExDateTextY_DoubleClick(sender As Object, e As EventArgs) Handles ExDateTextY.DoubleClick
		RaiseEvent DblClick(Me, Nothing)
	End Sub

	Private Sub ExDateTextY_Enter(sender As Object, e As EventArgs) Handles ExDateTextY.Enter
	...
	Private Sub ExDateTextY_Leave(sender As Object, e As EventArgs) Handles ExDateTextY.Leave
	...
	Private Sub ExDateTextY_KeyDown(sender As Object, e As KeyEventArgs) Handles ExDateTextY.KeyDown
	...
	Private Sub ExDateTextY_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles ExDateTextY.KeyPress
	...
	Private Sub ExDateTextY_KeyUp(sender As Object, e As KeyEventArgs) Handles ExDateTextY.KeyUp
		Dim KeyCode As Integer = e.KeyCode
		Dim Shift As Integer = e.KeyData \ &H10000
		'RaiseEvent KeyUp(Me, e)
	End Sub

	Private Sub ExDateTextY_MouseDown(sender As Object, e As MouseEventArgs) Handles ExDateTextY.MouseDown
	...
	Private Sub ExDateTextY_MouseMove(sender As Object, e As MouseEventArgs) Handles ExDateTextY.MouseMove
		Dim Button As Integer = e.Button \ &H100000
		Dim Shift As Integer = System.Windows.Forms.Control.ModifierKeys \ &H10000
		'Dim X As Single = VB6Conv.PixelsToTwipsX(eventArgs.X)
		'Dim Y As Single = VB6Conv.PixelsToTwipsY(eventArgs.Y)
	...
	Private Sub ExDateTextY_MouseUp(sender As Object, e As MouseEventArgs) Handles ExDateTextY.MouseUp
		Dim Button As Integer = e.Button \ &H100000
		Dim Shift As Integer = System.Windows.Forms.Control.ModifierKeys \ &H10000
		'Dim X As Single = VB6Conv.PixelsToTwipsX(eventArgs.X)
		'Dim Y As Single = VB6Conv.PixelsToTwipsY(eventArgs.Y)
	...
	Private Sub ExDateTextBoxY_Enter(sender As Object, e As EventArgs) Handles MyBase.Enter
		fGotFocus = True
		Try
	...
	Private Sub ExDateTextBoxY_Leave(sender As Object, e As EventArgs) Handles MyBase.Leave
		fGotFocus = False
		fClicking = False
	End Sub
	...
	Private Sub ExDateTextBoxY_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
		With ExDateTextY
			.Top = 0
			.Left = 0
			.Width = MyBase.Width
	...
	'	_DisplayName = My.Settings.Y_DisplayName
	'	ExDateTextY.Text = _DisplayName ' Ambient.DisplayName
	'
	'	Me.Enabled = My.Settings.Y_Enabled
	'	Me.Locked = My.Settings.Y_Locked
	'	Me.MaxLength = My.Settings.Y_MaxLength
	'	Me.ForeColor = My.Settings.Y_ForeColor
	'	Me.BackColor = My.Settings.Y_BackColor
	'	Me.Font = My.Settings.Y_Font
	'
	'	pFocusBackColor = My.Settings.Y_FocusBackColor
	'	pCanNextSetFocus = My.Settings.Y_CanNextSetFocus
	'	pCanForwardSetFocus = My.Settings.Y_CanForwardSetFocus
	'	pSelectText = My.Settings.Y_SelectText
	'	pEditMode = My.Settings.Y_EditMode
	'
	'	'ExDateTextY.Alignment = My.Settings.Y_Alignment
	'	'ExDateTextY.Appearance = My.Settings.Y_Appearance
	'	ExDateTextY.BorderStyle = My.Settings.Y_BorderStyle
	'
	'	vUNDOBUF = My.Settings.Y_OldValue
	'End Sub
	...
	'
	'	My.Settings.Y_DisplayName = _DisplayName
	'	My.Settings.Y_Enabled = Me.Enabled
	'	My.Settings.Y_Locked = Me.Locked
	'	My.Settings.Y_MaxLength = Me.MaxLength
	'	My.Settings.Y_ForeColor = Me.ForeColor
	'	My.Settings.Y_BackColor = Me.BackColor
	'	My.Settings.Y_Font = Me.Font
	'
	'	My.Settings.Y_FocusBackColor = pFocusBackColor
	'	My.Settings.Y_CanNextSetFocus = pCanNextSetFocus
	'	My.Settings.Y_CanForwardSetFocus = pCanForwardSetFocus
	'	My.Settings.Y_SelectText = pSelectText
	'	My.Settings.Y_EditMode = pEditMode
	'
	'	'My.Settings.Y_Alignment = ExDateTextY.Alignment
	'	'My.Settings.Y_Appearance = ExDateTextY.Appearance
	'	My.Settings.Y_BorderStyle = ExDateTextY.BorderStyle
	'
	'	My.Settings.Y_OldValue = vUNDOBUF
	'
	'	My.Settings.Save()
	'End Sub
	...
	Public Overrides Property Text() As String
		...
		Set(ByVal Value As String)
			If ExDateTextY IsNot Nothing Then
	...
	Public Property Alignment() As HorizontalAlignment
		...
		Set(ByVal Value As HorizontalAlignment)
			Select Case Value
				Case 0
					ExDateTextY.TextAlign = HorizontalAlignment.Left
				Case 1
					ExDateTextY.TextAlign = HorizontalAlignment.Right
				Case 2
					ExDateTextY.TextAlign = HorizontalAlignment.Center
				Case Else
					ExDateTextY.TextAlign = HorizontalAlignment.Left
			End Select
	...
	Public Sub NextSetFocus()
		Try
			...
			If fGotFocus = True Then
				...
				Call PostMessage(ExDateTextY.Handle, WM_KEYDOWN, System.Windows.Forms.Keys.Tab, 0)
	...
	Private Sub ExDateTextBoxY_Load(sender As Object, e As EventArgs) Handles Me.Load
		Loaded = True
	End Sub
End Class