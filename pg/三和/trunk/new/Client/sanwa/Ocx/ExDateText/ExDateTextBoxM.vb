...
'	Implements ISupportInitialize
	...
	Public Sub Undo()
		...
		ExDateTextM.Text = vUNDOBUF.ToString
		'    End If
	...
	Private Sub ExDateTextM_TextChanged(sender As Object, e As EventArgs) Handles ExDateTextM.TextChanged
	...
	Private Sub ExDateTextM_Click(sender As Object, e As EventArgs) Handles ExDateTextM.Click
		RaiseEvent Click(Me, Nothing)
	End Sub

	Private Sub ExDateTextM_DoubleClick(sender As Object, e As EventArgs) Handles ExDateTextM.DoubleClick
		RaiseEvent DblClick(Me, Nothing)
	End Sub

	Private Sub ExDateTextM_Enter(sender As Object, e As EventArgs) Handles ExDateTextM.Enter
	...
	Private Sub ExDateTextM_Leave(sender As Object, e As EventArgs) Handles ExDateTextM.Leave
	...
	Private Sub ExDateTextM_KeyDown(sender As Object, e As KeyEventArgs) Handles ExDateTextM.KeyDown
	...
	Private Sub ExDateTextM_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles ExDateTextM.KeyPress
	...
	Private Sub ExDateTextM_KeyUp(sender As Object, e As KeyEventArgs) Handles ExDateTextM.KeyUp
		Dim KeyCode As Integer = e.KeyCode
		Dim Shift As Integer = e.KeyData \ &H10000
		'RaiseEvent KeyUp(Me, e)
	End Sub

	Private Sub ExDateTextM_MouseDown(sender As Object, e As MouseEventArgs) Handles ExDateTextM.MouseDown
	...
	Private Sub ExDateTextM_MouseMove(sender As Object, e As MouseEventArgs) Handles ExDateTextM.MouseMove
		Dim Button As Integer = e.Button \ &H100000
		Dim Shift As Integer = System.Windows.Forms.Control.ModifierKeys \ &H10000
		'Dim X As Single = VB6Conv.PixelsToTwipsX(eventArgs.X)
		'Dim Y As Single = VB6Conv.PixelsToTwipsY(eventArgs.Y)
	...
	Private Sub ExDateTextM_MouseUp(sender As Object, e As MouseEventArgs) Handles ExDateTextM.MouseUp
		Dim Button As Integer = e.Button \ &H100000
		Dim Shift As Integer = System.Windows.Forms.Control.ModifierKeys \ &H10000
		'Dim X As Single = VB6Conv.PixelsToTwipsX(eventArgs.X)
		'Dim Y As Single = VB6Conv.PixelsToTwipsY(eventArgs.Y)
	...
	Private Sub ExDateTextBoxM_Enter(sender As Object, e As EventArgs) Handles MyBase.Enter
		fGotFocus = True
		Try
	...
	Private Sub ExDateTextBoxM_Leave(sender As Object, e As EventArgs) Handles MyBase.Leave
		fGotFocus = False
		fClicking = False
	End Sub
	...
	Private Sub ExDateTextBoxM_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
		With ExDateTextM
			.Top = 0
			.Left = 0
			.Width = MyBase.Width
	...
	'	_DisplayName = My.Settings.M_DisplayName
	'	ExDateTextM.Text = _DisplayName ' Ambient.DisplayName
    '
	'	Me.Enabled = My.Settings.M_Enabled
	'	Me.Locked = My.Settings.M_Locked
	'	Me.MaxLength = My.Settings.M_MaxLength
	'	Me.ForeColor = My.Settings.M_ForeColor
	'	Me.BackColor = My.Settings.M_BackColor
	'	Me.Font = My.Settings.M_Font
    '
	'	pFocusBackColor = My.Settings.M_FocusBackColor
	'	pCanNextSetFocus = My.Settings.M_CanNextSetFocus
	'	pCanForwardSetFocus = My.Settings.M_CanForwardSetFocus
	'	pSelectText = My.Settings.M_SelectText
	'	pEditMode = My.Settings.M_EditMode
    '
	'	'ExDateTextM.Alignment = My.Settings.M_Alignment
	'	'ExDateTextM.Appearance = My.Settings.M_Appearance
	'	ExDateTextM.BorderStyle = My.Settings.M_BorderStyle
    '
	'	vUNDOBUF = My.Settings.M_OldValue
	'End Sub
    ...
    '
	'	My.Settings.M_DisplayName = _DisplayName
	'	My.Settings.M_Enabled = Me.Enabled
	'	My.Settings.M_Locked = Me.Locked
	'	My.Settings.M_MaxLength = Me.MaxLength
	'	My.Settings.M_ForeColor = Me.ForeColor
	'	My.Settings.M_BackColor = Me.BackColor
	'	My.Settings.M_Font = Me.Font
    '
	'	My.Settings.M_FocusBackColor = pFocusBackColor
	'	My.Settings.M_CanNextSetFocus = pCanNextSetFocus
	'	My.Settings.M_CanForwardSetFocus = pCanForwardSetFocus
	'	My.Settings.M_SelectText = pSelectText
	'	My.Settings.M_EditMode = pEditMode
    '
	'	'My.Settings.M_Alignment = ExDateTextM.Alignment
	'	'My.Settings.M_Appearance = ExDateTextM.Appearance
	'	My.Settings.M_BorderStyle = ExDateTextM.BorderStyle
    '
	'	My.Settings.M_OldValue = vUNDOBUF
    '
	'	My.Settings.Save()
	'End Sub
	...
	Public Overrides Property Text() As String
		...
		Set(ByVal Value As String)
			If ExDateTextM IsNot Nothing Then
	...
	Public Property Alignment() As HorizontalAlignment
		...
		Set(ByVal Value As HorizontalAlignment)
			Select Case Value
				Case 0
					ExDateTextM.TextAlign = HorizontalAlignment.Left
				Case 1
					ExDateTextM.TextAlign = HorizontalAlignment.Right
				Case 2
					ExDateTextM.TextAlign = HorizontalAlignment.Center
				Case Else
					ExDateTextM.TextAlign = HorizontalAlignment.Left
			End Select
	...
	Public Sub NextSetFocus()
		Try
			...
			If fGotFocus = True Then
				...
				Call PostMessage(ExDateTextM.Handle, WM_KEYDOWN, System.Windows.Forms.Keys.Tab, 0)
	...
	Private Sub ExDateTextBoxM_Load(sender As Object, e As EventArgs) Handles Me.Load
		Loaded = True
	End Sub
End Class