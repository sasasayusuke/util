...
Friend Class SnwMT02F08
	...
	Private Sub SnwMT02F08_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Load
		'Dim fpSpd As Object
		'Dim Buf As String

		'SPREAD設定
		clsSPD = New clsSPD
		clsSPD.CtlSpd = SnwMT02F00.FpSpd
	...
	Private Sub SnwMT02F08_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
...
Download_Err:
	...
	Private Sub SetupItems(ByRef rs As ADODB.Recordset)
		...
		If SnwMT02F00.FpSpd.ActiveSheet.RowCount < (UBound(RecArry, 2) + 1) Then
			'UPGRADE_WARNING: オブジェクト fpSpd.MaxRows の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			SnwMT02F00.FpSpd.ActiveSheet.RowCount = (UBound(RecArry, 2) + 1)
		End If
			...
			For j = 0 To UBound(RecArry)
				Select Case j + 1
					Case 3
						...
						SnwMT02F00.FpSpd.ActiveSheet.SetText(j + 1, i + 1, If(Trim("" & RecArry(j, i)) = "0", "", Trim("" & RecArry(j, i))))
					Case 5 To 9
						'UPGRADE_WARNING: オブジェクト RecArry() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						SnwMT02F00.FpSpd.ActiveSheet.SetText(j + 1, i + 1, If(Trim("" & RecArry(j, i)) = "0", "", Trim("" & RecArry(j, i))))
					Case Else
						'UPGRADE_WARNING: オブジェクト RecArry() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						SnwMT02F00.FpSpd.ActiveSheet.SetText(j + 1, i + 1, Trim("" & RecArry(j, i)))
				End Select
			Next
			'合計数
