...
Friend Class SnwMT02F09
	...
	Private Sub SnwMT02F09_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim fpSpd As Object
		Dim buf As String
	...
	Private Sub SnwMT02F09_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Function Get担当者DB(ByRef ID As String, ByRef IDName As String) As Boolean
		...
		With rs
			...
			Else
				...
				IDName = NullToZero(.Fields("担当者名"), vbNullString)
				Get担当者DB = True
			End If
		End With
		Call ReleaseRs(rs)
...
Download_Err: 
	...
	Private Sub SetupItems(ByRef rs As ADODB.Recordset)
		...
		RecArry = rs.GetRows(fpSpd.MaxRows,  , New Object(){"日付", "見積番号", "行番号", "見積件名", "残数", "受注数", "売上数", "入庫数"})
