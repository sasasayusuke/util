...
Friend Class SnwMT02F07
	...
	Private Sub SnwMT02F07_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
SysErr_Form_Load: 
	...
	Private Sub SnwMT02F07_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Function Get得意先DB(ByVal ID As String, ByRef IDName1 As String, ByRef IDName2 As String) As Short
		...
		With rs
			...
			Else
				...
				IDName1 = NullToZero(.Fields("得意先名1"), vbNullString)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				IDName2 = NullToZero(.Fields("得意先名2"), vbNullString)
				Get得意先DB = 0
			End If
		End With
		ReleaseRs(rs)
