...
Friend Class SelKokTmp_cls
	...
	Private Sub SelKokTmp_cls_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub SelKokTmp_cls_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim i, j As Short
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "テンプレート名", CInt(VB6.TwipsToPixelsX(4600)))
		End With
		
		SelListVw.Width = VB6.TwipsToPixelsX(4600 + 330) 'スクロールバー分プラス
	...
	Private Function Download() As Boolean
		...
		If [tx_検索名称].Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " テンプレート名 LIKE '%" & SQLString([tx_検索名称]) & "%'"
		End If
