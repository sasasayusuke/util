...
Friend Class SnwMT02F00
	...
	''Private Const ColM区分 As Integer = 25
	...
	'List配列CbFuncのButton
	Public LcbFunc As New List(Of Button)
	'List配列CbFuncSubのButton
	Private LcbFuncSub As New List(Of Button)
	'List配列opDispのRadioButton
	Private LOpDisp As New List(Of RadioButton)

	Private isInitializing As Boolean = True

	Private Sub SnwMT02F00_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
		Debug.WriteLine("SnwMT02F00 Paint")
		' Graphics オブジェクトを取得
		...
		' 線を描く、Welパー算出
		g.DrawLine(pen, 760, 22, 930, 22)

		' 線を描く、見積確定
		g.DrawLine(pen, 940, 22, 1110, 22)

		' 線を描く、見積番号
		g.DrawLine(pen, 12, 40, 130, 40)

		' 線を描く、名称
		g.DrawLine(pen, 150, 40, 415, 40)

		' 線を描く、得意先
		g.DrawLine(pen, 420, 40, 740, 40)

		' 線を描く、税込金額
		g.DrawLine(pen, 760, 40, 930, 40)

		' 線を描く、原価合計
		g.DrawLine(pen, 250, 62, 415, 62)

		' 線を描く、合計金額
		g.DrawLine(pen, 420, 62, 595, 62)

		' 線を描く、原価率
		g.DrawLine(pen, 625, 62, 740, 62)

		' 線を描く、端数
		g.DrawLine(pen, 760, 62, 930, 62)
	...
	Private Sub Cb員数取込_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Cb員数取込.Click
		...
		Try
			...
			With F12
				...
				.ActRow = FpSpd.ActiveSheet.ActiveRowIndex
	...
	Private Sub Ck_DragMode_CheckStateChanged(sender As Object, e As EventArgs) Handles Ck_DragMode.CheckStateChanged
		'Dim fpSpd As Object
		...
		With FpSpd
			If [Ck_DragMode].CheckState = 0 Then
				...
				.ActiveSheet.SelectionStyle = FarPoint.Win.Spread.SelectionStyles.None
				.ActiveSheet.SelectionPolicy = FarPoint.Win.Spread.Model.SelectionPolicy.Single
				.ActiveSheet.SelectionUnit = FarPoint.Win.Spread.Model.SelectionUnit.Cell
				.ActiveSheet.OperationMode = FarPoint.Win.Spread.OperationMode.Normal
				...
				Ck_DragMode.BackColor = System.Drawing.SystemColors.Control
				'            .OperationMode = 0
			Else
				'UPGRADE_WARNING: オブジェクト fpSpd.EditModePermanent の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.EditModePermanent = False
				.ActiveSheet.SelectionStyle = FarPoint.Win.Spread.SelectionStyles.SelectionColors
				.ActiveSheet.SelectionPolicy = FarPoint.Win.Spread.Model.SelectionPolicy.Range
				.ActiveSheet.SelectionUnit = FarPoint.Win.Spread.Model.SelectionUnit.Row
				.ActiveSheet.OperationMode = FarPoint.Win.Spread.OperationMode.Normal
				.ActiveSheet.SelectionBackColor = System.Drawing.Color.Black
				.ActiveSheet.SelectionForeColor = System.Drawing.Color.White
				'UPGRADE_WARNING: オブジェクト fpSpd.SelectBlockOptions の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.SelectBlockOptions = 2 '行選択モード
				.SelectionBlockOptions = FarPoint.Win.Spread.SelectionBlockOptions.Rows

				Ck_DragMode.BackColor = Color.SpringGreen
				'            .OperationMode = 2
			End If
			'UPGRADE_WARNING: オブジェクト fpSpd.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Focus()
			...
			'.ActiveSheet.AddSelection(.ActiveSheet.ActiveRowIndex, 0, .ActiveSheet.RowCount, .ActiveSheet.ColumnCount)
		End With
	End Sub
	'2013/03/28 ADD↑
	...
	Private Sub Ck_MoveMode_CheckedChanged(sender As Object, e As EventArgs) Handles Ck_MoveMode.CheckedChanged
		...
		With FpSpd
			If [Ck_MoveMode].CheckState = 0 Then
				...
				'NOTE SS  EditEnterAction 使用出来ない→アクション マップと入力マップを使用
				'NOTE SS .EditEnterAction = FPSpreadADO.EditEnterActionConstants.EditEnterActionNext '次のセル（左から右、上から下の順）
				'アクティブセルを１列右に移動します。  
				im = .GetInputMap(FarPoint.Win.Spread.InputMapMode.WhenAncestorOfFocused)
				im.Put(New FarPoint.Win.Spread.Keystroke(Keys.Return, Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextColumn)
			...
			Else
				'UPGRADE_WARNING: オブジェクト fpSpd.EditEnterAction の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'NOTE SS  EditEnterAction 使用出来ない→アクション マップと入力マップを使用
				'NOTE SS .EditEnterAction = FPSpreadADO.EditEnterActionConstants.EditEnterActionDown '下のセル
				'アクティブセルを１行下に移動します。  
				im = .GetInputMap(FarPoint.Win.Spread.InputMapMode.WhenAncestorOfFocused)
				im.Put(New FarPoint.Win.Spread.Keystroke(Keys.Return, Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextRow)
				im = .GetInputMap(FarPoint.Win.Spread.InputMapMode.WhenFocused)
				im.Put(New FarPoint.Win.Spread.Keystroke(Keys.Return, Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextRow)
				[Ck_MoveMode].Text = "↓"
			End If
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		With FpSpd
			...
			Dim cRange As FarPoint.Win.Spread.Model.CellRange
			cRange = .ActiveSheet.GetSelection(0)
			'Debug.Print("The selection covers cells " & cRange.Row & ", " & cRange.Column & ", " & cRange.RowCount & ", " & cRange.ColumnCount)
			...
			'rowCount   : クリアする行数
			'columnCount: クリアする列数
			dataModel.ClearData(cRange.Row, cRange.Column, cRange.RowCount, cRange.ColumnCount)
	...
	Private Sub DispFormDate()
		...
		If clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1 = 0 Then
		...
		With FpSpd
			...
			ReDim WkTBLS(clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1, .ActiveSheet.ColumnCount)
			...
			WkTBLS = .ActiveSheet.GetArray(0, 0, clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1, FpSpd.ActiveSheet.ColumnCount)
			...
			For wMaxRow = UBound(WkTBLS, 1) To LBound(WkTBLS, 1) Step -1
				...
				If Not ((IsCheckNull(WkTBLS(wMaxRow, ColPC区分)) = True _
					Or IsCheckNull(WkTBLS(wMaxRow, Col製品NO)) = True _
					Or IsCheckNull(WkTBLS(wMaxRow, Col仕様NO)) = True _
					Or IsCheckNull(WkTBLS(wMaxRow, Col名称)) = True) _
					And CDec(SpcToNull(WkTBLS(wMaxRow, Col発注数), 0)) = 0) Then Exit For '発注数
		...
		Try
			...
			With F16
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				If FpSpd.ActiveSheet.ActiveColumnIndex = Col入庫日 Then '2020/09/16 ADD
					.Col入出庫日 = "入庫日"
				Else
					.Col入出庫日 = "出庫日"
				End If
	...
	Private Sub SnwMT02F00_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Load
		'Dim fpSpd As Object
		Loaded = False

		Debug.WriteLine("SnwMT02F00 Load")
		...
		MeHeight = VB6Conv.PixelsToTwipsY(Me.Height) - FpSpd.Height 'ｽﾌﾟﾚｯﾄﾞ分を抜いた高さ
		...
		FpSpd.Width = Me.ClientSize.Width - 25
		FpSpd.Height = Me.ClientSize.Height - 156
		...
		With FpSpd
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Action = FPSpreadADO.ActionConstants.ActionActiveCell
			.ActiveSheet.SetActiveCell(0, Col見積区分)
		...
		[tx_Welパー算出].Text = NullToZero(GetIni("Disp", "WelPercent", INIFile)).ToString '2017/01/17 ADD
		...
		[tx_見積確定区分].Text = HD_見積確定区分.ToString '2024/06/21 ADD
		...
		'ロード時にオプションボタンを動的に配置する
		AddfrDisp()

		'見積情報を初期表示
		'op_Disp(5).Checked = True
		LOpDisp(5).Checked = True
	...
	Private Sub AddPicFunction()
		...
		For i = 0 To genButtonCount - 1
			...
			' ボタンにEnterイベントを追加
			AddHandler btn.Enter, AddressOf CbFunc_Enter
	...
	Private Sub AddSubFunction()

		' ラベル・ボタンを配置するPanelを指定
		Dim targetPanel As Panel = SubFunction

		Dim genButtonCount As Integer = 5
		Dim genButtonWidth() As Integer = {62, 98, 67, 67, 134}
		Dim genButtonHeight As Integer = 18
		Dim genButtonY As Integer = 2

		Dim LocWidth As Integer
		...
		For i = 0 To genButtonCount - 1
			...
			LocWidth = 0
			For j = 0 To i
				LocWidth += genButtonWidth(j)
			Next
			LocWidth -= genButtonWidth(i)

			' ボタンのプロパティを設定
			btn.Tag = i + 1                     ' IndexをTagプロパティに格納
			btn.TabIndex = i + 1 + 40           ' TabIndexをプロパティに格納
			btn.Name = "CbFuncSub" & i + 1
			btn.Font = New Font("MS Gothic", 7.8, FontStyle.Regular)
			btn.FlatStyle = FlatStyle.Standard

			btn.Size = New Size(genButtonWidth(i), genButtonHeight)
			btn.Location = New Point(LocWidth + 1, genButtonY) ' ボタンの位置を計算
			'Debug.WriteLine($"LocWidth:{LocWidth + 1},genButtonY:{genButtonY}")
			...
			' ボタンにクリックイベントを追加
			AddHandler btn.Click, AddressOf CbFuncSub_Click

			' ボタンにEnterイベントを追加
			AddHandler btn.Enter, AddressOf CbFuncSub_Enter
	...
	Private Sub AddfrDisp()

		' ラジオボタンを配置するPanelを指定
		Dim targetPanel As Panel = fr_Disp

		' 生成数を指定
		Dim genButtonCount As Integer = 6
		Dim genButtonWidth As Integer = 86
		Dim genButtonHeight As Integer = 16
		Dim genButtonY As Integer = 5

		Dim margin As Integer = 268 '248             ' 見出しの余白
		...
		For i = 0 To genButtonCount - 1
			...
			' ボタンのプロパティを設定
			btn.Tag = i + 1                     ' IndexをTagプロパティに格納
			btn.Name = "Op_Disp" & i + 1
			btn.Font = New Font("MS Gothic", 7.8, FontStyle.Regular)
			btn.FlatStyle = FlatStyle.Standard

			btn.Size = New Size(genButtonWidth, genButtonHeight)
			btn.Location = New Point((i * genButtonWidth) + 1 + margin, genButtonY) ' ボタンの位置を計算
			'Debug.WriteLine($"LocWidth:{(i * genButtonWidth) + 1 + margin},genButtonY:{genButtonY}")

			Select Case i
				Case 0
					btn.Text = "見積情報"
					btn.TabIndex = 27           ' TabIndexをプロパティに格納
				Case 1
					btn.Text = "製品情報"
					btn.TabIndex = 28           ' TabIndexをプロパティに格納
				Case 2
					btn.Text = "価格情報"
					btn.TabIndex = 29           ' TabIndexをプロパティに格納
				Case 3
					btn.Text = "取引先情報"
					btn.TabIndex = 30           ' TabIndexをプロパティに格納
				Case 4
					btn.Text = "エラー情報"
					btn.TabIndex = 64           ' TabIndexをプロパティに格納
				Case 5
					btn.Text = "F7情報"
					btn.TabIndex = 64           ' TabIndexをプロパティに格納
				Case Else
			...
			' ボタンにCheckedChangedイベントを追加
			AddHandler btn.CheckedChanged, AddressOf Op_Disp_CheckedChanged

			' ボタンにMouseUpイベントを追加
			AddHandler btn.MouseUp, AddressOf Op_Disp_MouseUp
	...
	Private Sub CbFunc_Click(sender As Object, e As EventArgs)
		...
		Select Case Index
			Case 0
				'行の挿入
				If clsSPD.LineInsert(SPMaxRow) = -1 Then
					System.Windows.Forms.Application.DoEvents()
					Inform("これ以上、挿入できません。")
				Else
					FpSpd.ActiveSheet.Rows(FpSpd.ActiveSheet.ActiveRowIndex).Height = 23
					FpSpd.ActiveSheet.Rows(FpSpd.ActiveSheet.ActiveRowIndex).BackColor = System.Drawing.ColorTranslator.FromOle(&HFFFFC0)
					FpSpd.ActiveSheet.Cells(FpSpd.ActiveSheet.ActiveRowIndex, Col製品NO, FpSpd.ActiveSheet.ActiveRowIndex, Col製品NO).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
					   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
					   .MaxLength = 7
					}
					FpSpd.ActiveSheet.Cells(FpSpd.ActiveSheet.ActiveRowIndex, Col送り先CD, FpSpd.ActiveSheet.ActiveRowIndex, Col送り先CD).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
					   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
					   .MaxLength = 2
					}
					FpSpd.ActiveSheet.Rows(FpSpd.ActiveSheet.ActiveRowIndex + 1).BackColor = System.Drawing.ColorTranslator.FromOle(&HFFFFFF)
					LcbFunc(10).Text = "ﾁｪｯｸ"
				End If
			Case 1
				'            If CCur(NullToZero(clsSPD.GetTextEX(Col仕入済数, fpSpd.ActiveRow))) <> 0 Then '2014/09/09 ADD
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				If CDec(NullToZero(clsSPD.GetTextEX(Col仕入済CNT, FpSpd.ActiveSheet.ActiveRowIndex))) <> 0 Then '2014/09/09 ADD'2018/06/19 ADD
				...
				Else
					'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					If CDec(NullToZero(clsSPD.GetTextEX(Col売上済CNT, FpSpd.ActiveSheet.ActiveRowIndex))) <> 0 Then '2014/09/09 ADD
						CriticalAlarm("売上済みです。")
						'UPGRADE_WARNING: オブジェクト fpSpd.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						FpSpd.Focus()
					Else
						'行の削除
						Call clsSPD.LineDelete(FpSpd.ActiveSheet.ActiveRowIndex)
						With FpSpd
							'UPGRADE_WARNING: オブジェクト fpSpd.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.Focus()
							'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							...
							HoldPc = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, ColPC区分)
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							HoldSei = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col製品NO)
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							HoldSiy = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col仕様NO)
						End With
						Call Calc合計()
						LcbFunc(10).Text = "ﾁｪｯｸ"
					End If
			...
			Case 3
				...
				Else
					...
					Else
						...
						With FpSpd
							...
							'.Value = vbNullString
							.ActiveSheet.SetValue(.ActiveSheet.ActiveRowIndex, Col見積明細連番, vbNullString)
							'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Row = .ActiveSheet.ActiveRowIndex
							'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Value = vbNullString
							.ActiveSheet.SetValue(.ActiveSheet.ActiveRowIndex, Col仕入済数, vbNullString)
							'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Col = Col仕入済CNT '2018/06/19 ADD
							'UPGRADE_WARNING: オブジェクト fpSpd.Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Value = vbNullString '2018/06/19 ADD
							.ActiveSheet.SetValue(.ActiveSheet.ActiveRowIndex, Col仕入済CNT, vbNullString)
							'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Col = Col売上済CNT
							'UPGRADE_WARNING: オブジェクト fpSpd.Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Value = vbNullString
							.ActiveSheet.SetValue(.ActiveSheet.ActiveRowIndex, Col売上済CNT, vbNullString)
							'2014/09/09 ADD↑
							...
							'製品によりロックする
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							Call Lock_Seihin(FpSpd.ActiveSheet.ActiveRowIndex, clsSPD.GetTextEX(Col製品NO, FpSpd.ActiveSheet.ActiveRowIndex), clsSPD.GetTextEX(Col仕様NO, FpSpd.ActiveSheet.ActiveRowIndex)) '2017/02/10 ADD
				...
				End If
			Case 4
				Select Case [LcbFunc](Index).Text
					Case "上へ"
						'一行前の行と入れ替え
						'                    Call clsSPD.LineSwap(-1)
						Call clsSPD.LineSwap2(-1) '2014/11/11 ADD
						LcbFunc(10).Text = "ﾁｪｯｸ"
					Case "原割設"
						F13 = New SnwMT02F13
						Try
							With F13
								'VB6.ShowForm(F13, VB6.FormShowConstants.Modal, Me)
								F13.ShowDialog(Me)
							End With
						Finally
							If F13 IsNot Nothing Then
								F13.Dispose()
								'UPGRADE_NOTE: オブジェクト F13 をガベージ コレクトするまでこのオブジェクトを破棄することはできません。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"' をクリックしてください。
								F13 = Nothing
							End If
						End Try
						...
						'2017/03/30 ADD↓
					Case "左へ"
						Call clsSPD.ColSwap(Col仕分数1, Col仕分数1 + 29, -1)
						LcbFunc(10).Text = "ﾁｪｯｸ"
						'2017/03/30 ADD↑
						'2018/05/03 ADD↓
					Case "日設定"
					...
					Case "明細検"
						...
						If CDec(NullToZero(clsSPD.GetTextEX(Col仕入済CNT, FpSpd.ActiveSheet.ActiveRowIndex))) <> 0 Then '2014/09/09 ADD'2018/06/19 ADD
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						ElseIf CDec(NullToZero(clsSPD.GetTextEX(Col売上済CNT, FpSpd.ActiveSheet.ActiveRowIndex))) <> 0 Then  '2014/09/09 ADD
							CriticalAlarm("売上済みです。")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.Focus()
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						ElseIf Trim(clsSPD.GetTextEX(Col名称, FpSpd.ActiveSheet.ActiveRowIndex)) <> "" Then  '2014/09/09 ADD
				...
				'            '一行前の行と入れ替え
				'            Call clsSPD.LineSwap(-1)
				'            cbFunc(10).Caption = "ﾁｪｯｸ"
			Case 5
				Select Case [LcbFunc](Index).Text
					Case "下へ"
						'一行後ろの行と入れ替え
						'                    Call clsSPD.LineSwap
						Call clsSPD.LineSwap2() '2014/11/11 ADD
						LcbFunc(10).Text = "ﾁｪｯｸ"
					Case "掛率"
						With SnwMT02F11
							.ResCodeCTL = FpSpd
							...
							.ActRow = FpSpd.ActiveSheet.ActiveRowIndex
							.ActColumn = FpSpd.ActiveSheet.ActiveColumnIndex
							'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'fpSpd.Col = fpSpd.ActiveSheet.ActiveColumnIndex
							'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'fpSpd.Row = fpSpd.ActiveSheet.ActiveRowIndex
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, Col原価) '原価
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, Col売価) '売価
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							SnwMT02F11.ShowDialog(Me)
						End With
						'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						Call Get金額(FpSpd.ActiveSheet.ActiveRowIndex)
						Call Calc合計()
						LcbFunc(10).Text = "ﾁｪｯｸ"
						If PreviousControl IsNot Nothing Then
							PreviousControl.Focus()
			...
			Case 7
				Select Case [LcbFunc](Index).Text
					Case "単価参"
						...
						With FpSpd
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							wCol = .ActiveSheet.ActiveColumnIndex
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							wRow = .ActiveSheet.ActiveRowIndex
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(wRow, ColPC区分) 'PC区分
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							If check Then
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								wPCKUBN = getdata.ToString
							Else
								wPCKUBN = ""
							End If
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(wRow, Col製品NO) '製品NO
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							If check Then
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								wSEIHNO = getdata.ToString
							Else
								wSEIHNO = ""
							End If
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(wRow, Col仕様NO) '仕様NO
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							If check Then
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								wSIYONO = getdata.ToString
							Else
								wSIYONO = ""
							End If
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							If .ActiveSheet.ActiveColumnIndex = Col原価 Then
								wGetKBN = 1
								'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							ElseIf .ActiveSheet.ActiveColumnIndex = Col売価 Then
								wGetKBN = 2
							End If
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(wRow, Col仕入先CD) '仕様NO
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							Try
								...
								If tx_Dummy1.Tag <> "" Then
									...
									.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, .ActiveSheet.ActiveColumnIndex, tx_Dummy1.Text)
									'原価・売価
									'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									Call Get率(.ActiveSheet.ActiveRowIndex, .ActiveSheet.ActiveColumnIndex)
									'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									Call Get金額(.ActiveSheet.ActiveRowIndex)
									Call Calc合計()
									SendReturnKey()
									LcbFunc(10).Text = "ﾁｪｯｸ"
								Else
					...
					Case "社在参"
						With FpSpd
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col製品NO) '製品NO
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col仕様NO) '仕様NO
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col名称) '製品名
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
							...
							If check Then
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								wSEIHNM = getdata.ToString
							Else
								wSEIHNM = ""
							End If
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col社内在庫) '社内在庫数
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
					...
					Case "客在参"
						With FpSpd
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getdata = .ActiveSheet.GetText(.ActiveSheet.ActiveRowIndex, Col客先在庫) '客先在庫数
							If getdata.ToString().Trim() = "" Then
								check = False
							Else
								check = True
					...
					Case "数削除"
						If MsgBoxResult.Yes = YesNo("員数部をクリアします。", Me.Text) Then
							...
							With FpSpd
								...
								.ActiveSheet.AutoCalculation = False
								'数量欄のクリア
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.Col = Col仕分数1
								'UPGRADE_WARNING: オブジェクト fpSpd.Col2 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								...
								'rowCount   : クリアする行数
								'columnCount: クリアする列数
								dataModel.Clear(0, Col仕分数1, .ActiveSheet.RowCount, Col仕分数1 + 29)
								...
								'rowCount   : クリアする行数
								'columnCount: クリアする列数
								dataModel.Clear(0, Col社内在庫, .ActiveSheet.RowCount, Col社内在庫)
								...
								'rowCount   : クリアする行数
								'columnCount: クリアする列数
								dataModel.Clear(0, Col客先在庫, .ActiveSheet.RowCount, Col客先在庫)
								...
								'rowCount   : クリアする行数
								'columnCount: クリアする列数
								dataModel.Clear(0, Col転用, .ActiveSheet.RowCount, Col転用)
								'2009/02/26 ADD↑
								...
								'rowCount   : クリアする行数
								'columnCount: クリアする列数
								dataModel.Clear(0, Col金額, .ActiveSheet.RowCount, Col仕入金額)
								...
								'rowCount   : クリアする行数
								'columnCount: クリアする列数
								dataModel.Clear(0, Col消費税額, .ActiveSheet.RowCount, Col消費税額)
								dataModel = Nothing
								...
								'UPGRADE_WARNING: オブジェクト fpSpd.AutoCalc の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.AutoCalculation = True
								'UPGRADE_WARNING: オブジェクト fpSpd.ReDraw の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.ReDraw = True
							End With
			...
			Case 9
				...
				''---------------------------------------
			Case 10
				If [LcbFunc](Index).Text = "ﾁｪｯｸ" Then
					'2004/11/29 ADD
					...
					If Item_Check([LcbFunc](Index).TabIndex) = True Then
						Select Case Upload_Chk()
							Case 0
								[LcbFunc](Index).Text = "登録" '2018/03/26 DEL
								'                            '2018/03/26 ADD↓
							...
							Case -1
								...
								FpSpd.ActiveSheet.SetActiveCell(0, 2)
							Case Else
								'位置付け
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'fpSpd.Col = 3
	...
	Private Sub SnwMT02F00_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Resize
		'Dim fpSpd As Object
		If Me.WindowState <> System.Windows.Forms.FormWindowState.Minimized Then
			...
			'fpSpd.Width = VB6Conv.PixelsToTwipsX(Me.ClientRectangle.Width) - (fpSpd.Left * 2) '2008/06/10 ADD
			...
			'lb_項目(4).Top = VB6Conv.TwipsToPixelsY(fpSpd.Top + fpSpd.Height)
			'_lb_項目_4.Top = VB6Conv.TwipsToPixelsY(fpSpd.Top + fpSpd.Height)
			'UPGRADE_WARNING: オブジェクト fpSpd.Height の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.Top の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'[tx_製品NO].Top = VB6Conv.TwipsToPixelsY(fpSpd.Top + fpSpd.Height)
			'UPGRADE_WARNING: オブジェクト fpSpd.Height の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.Top の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'[Cb検索].Top = VB6Conv.TwipsToPixelsY(fpSpd.Top + fpSpd.Height)
		...
		'UPGRADE_WARNING: オブジェクト fpSpd.Height の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト fpSpd.Top の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		fr_Disp.Top = VB6Conv.TwipsToPixelsY(FpSpd.Top + FpSpd.Height)

		'StatusTripの調整
		sb_Msg_Panel1.Width = Me.ClientSize.Width - 165
	End Sub

	'Protected Overrides Function ProcessCmdKey(ByRef msg As Message, keyData As Keys) As Boolean
	'	Select Case keyData
	'		Case Keys.F2
	'			'MessageBox.Show("F2 キーが押されました。")
	'			LcbFunc_Action(1)
	'			Return True
	'		Case Keys.F3
	'			'MessageBox.Show("F3 キーが押されました。")
	'			LcbFunc_Action(2)
	'			Return True
	'		Case Keys.F4
	'			'MessageBox.Show("F4 キーが押されました。")
	'			LcbFunc_Action(3)
	'			Return True
	'	End Select
	'	' 他のキーは通常通り処理
	...
	Private Sub SnwMT02F00_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
...
Form_KeyDown_Err:
	...
	Private Sub SnwMT02F00_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
	...
	Private Sub SnwMT02F00_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub SetUpFuncs(ByRef Name_Renamed As String)
		...
		Select Case Name_Renamed
			...
			Case "展開", "PC区分", "製品NO", "見積区分" ', "fpSpd"
				...
				Else
					'仕入済数が全てゼロ
					[LcbFunc](7).Text = "数削除" '2008/05/22 ADD
				End If
				'            If ModeF = 1 Then       '追加
				'                cbFunc(9).Caption = ""
				'            Else
			...
			Case "原価"
				...
				[LcbFunc](2).Text = ""
				[LcbFunc](3).Text = ""
				[LcbFunc](4).Text = "原割設" '2008/01/23 ADD
				[LcbFunc](5).Text = ""
				[LcbFunc](6).Text = "表示項"
				[LcbFunc](7).Text = "単価参"
				[LcbFunc](8).Text = ""
	...
	Private Function DoMeisaiKensaku() As Boolean
		...
		If cMitsumoriM.ShowDialog = True Then
			With FpSpd
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColSP区分, cMitsumoriM.SP区分)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColPC区分, cMitsumoriM.PC区分)

				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col製品NO, cMitsumoriM.製品NO)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col仕様NO, cMitsumoriM.仕様NO)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Colベース色, cMitsumoriM.ベース色)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col名称, cMitsumoriM.漢字名称)

				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColW, cMitsumoriM.W)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColD, cMitsumoriM.D)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColH, cMitsumoriM.H)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColD1, cMitsumoriM.D1)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColD2, cMitsumoriM.D2)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColH1, cMitsumoriM.H1)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, ColH2, cMitsumoriM.H2)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col単位, cMitsumoriM.単位名)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col定価, cMitsumoriM.定価)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col原価, cMitsumoriM.仕入単価)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col売価, cMitsumoriM.売上単価)
				'            .SetText ColU区分, .ActiveRow, cMitsumoriM.U区分
				'            .SetText ColM区分, .ActiveRow, cMitsumoriM.M区分
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col仕入業者CD, cMitsumoriM.仕入業者CD)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col仕入業者名, cMitsumoriM.仕入業者名)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col仕入先CD, cMitsumoriM.仕入先CD)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col仕入先名, cMitsumoriM.仕入先名)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col送り先CD, cMitsumoriM.配送先CD)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col送り先名, cMitsumoriM.配送先名)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col作業区分CD, cMitsumoriM.作業区分CD)

				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col売上税区分, cMitsumoriM.売上税区分)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col製品区分, cMitsumoriM.製品区分)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(.ActiveSheet.ActiveRowIndex, Col明細備考, cMitsumoriM.明細備考) '2018/11/03 ADD


				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Call Lock_Seihin(.ActiveSheet.ActiveRowIndex, clsSPD.GetTextEX(Col製品NO, .ActiveSheet.ActiveRowIndex), clsSPD.GetTextEX(Col仕様NO, .ActiveSheet.ActiveRowIndex)) '2020/10/10 ADD
	...
	' 動的に追加したボタンのEnterイベント
	Private Sub CbFunc_Enter(sender As Object, e As EventArgs)
		Dim btn As Button = CType(sender, Button)
		Dim Index As Integer = CType(btn.Tag, Integer) - 1
		'Dim Index As Short = cbFunc.GetIndex(sender)
	...
	' 動的に追加したボタンのクリックイベント
	Private Sub CbFuncSub_Click(sender As Object, e As EventArgs)
		Dim btn As Button = CType(sender, Button)
		Dim Index As Integer = CType(btn.Tag, Integer) - 1
		'Dim Index As Integer = cbFuncSub.GetIndex(eventSender)
		'Dim fpSpd As Object
		Dim wRow As Integer
		...
		Select Case Index
			...
			Case 2
				...
				'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SnwMT02F03.MituNo = CInt(SpcToNull(rf_見積番号.Text, 0))
			...
			Case 3
				...
				'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SnwMT02F04.MituNo = CInt(SpcToNull(rf_見積番号.Text, 0))
			...
			Case 4
				...
				Try
					'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					wRow = FpSpd.ActiveSheet.ActiveRowIndex
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'fpSpd.Action = FPSpreadADO.ActionConstants.ActionActiveCell
					FpSpd.ActiveSheet.SetActiveCell(wRow, 2)
					If DspKokData(wRow) Then
						LcbFunc(10).Text = "ﾁｪｯｸ"
					End If
				Finally
					If F06 IsNot Nothing Then
						F06.Dispose()
				...
				'2009/08/10 ADD
		End Select
		LcbFuncSub(Index).TabStop = False
		'ボタン２重起動防止フラグの初期化
		CLK2F = False
	End Sub

	' 動的に追加したボタンのEnterイベント
	Private Sub CbFuncSub_Enter(sender As Object, e As EventArgs)
		Dim btn As Button = CType(sender, Button)
		Dim Index As Integer = CType(btn.Tag, Integer) - 1
		'Dim Index As Integer = cbFuncSub.GetIndex(eventSender)
		'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
	...
	' 指定したインデックスのボタン動作を実行
	Private Sub LcbFuncSub_Action(index As Integer)
		If index >= 0 AndAlso index < LcbFuncSub.Count Then
			' ボタンのクリックイベントを呼び出す
			LcbFuncSub(index).PerformClick()
		End If
	End Sub

	Private Sub FpSpd_DragDropBlock(sender As Object, e As FarPoint.Win.Spread.DragDropBlockEventArgs) Handles FpSpd.DragDropBlock
		If e.Overwrite = False Then
			e.Cancel = True
		End If
	End Sub
	...
	Private Sub Cb固定列_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Cb固定列.Click
		...
		Dim HCol As Integer
		Dim HRow As Integer
		Dim wColsFrozen As Integer

		Cb固定列.TabStop = True

		'colのHOLD
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		HCol = FpSpd.ActiveSheet.ActiveColumnIndex
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		HRow = FpSpd.ActiveSheet.ActiveRowIndex
		...
		With FpSpd
			...
			If .ActiveSheet.ActiveColumnIndex = 0 Then
				...
				'.ColsFrozen = 0 ' 列
				.ActiveSheet.FrozenColumnCount = 0 ' 列
			Else
				' 固定ｾﾙを設定します。
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				wColsFrozen = .ActiveSheet.ActiveColumnIndex
				'UPGRADE_WARNING: オブジェクト fpSpd.ColsFrozen の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.FrozenColumnCount = .ActiveSheet.ActiveColumnIndex
			End If
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Action = FPSpreadADO.ActionConstants.ActionActiveCell
			.ActiveSheet.SetActiveCell(HRow, HCol)
			'UPGRADE_WARNING: オブジェクト fpSpd.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Focus()
		End With
	...
	'    [sb_Msg].Items.Item(0).Text = "シート名称を入力して下さい。"
	'End Sub
	'
	'Private Sub tx_シート名称_KeyDown(sender As Object, e As KeyEventArgs) Handles tx_シート名称.KeyDown
	'    ReturnF = True
	'End Sub
	'
...
Item_Check_Err:
	...
	Private Sub FpSpd_Initialize()
		...
		'Dim cRange As FarPoint.Win.Spread.Cell
		'Dim row As Integer

		With FpSpd
			'UPGRADE_WARNING: オブジェクト fpSpd.EditModePermanent の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.EditModePermanent = True '常時入力モードを維持するかどうかを設定します。
			.EditModeReplace = True   '編集モード時のテキスト選択する
			.ResizeZeroIndicator = FarPoint.Win.Spread.ResizeZeroIndicator.Default '非表示行と列の非表示
		End With
		...
		With FpSpd
			...
			'.ReDraw = False
			'        .MaxCols = 76
			.ActiveSheet.ColumnCount = 87
			'UPGRADE_WARNING: オブジェクト fpSpd.MaxRows の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.RowCount = SPMaxRow

			.ActiveSheet.Columns(0, FpSpd.ActiveSheet.Columns.Count - 1).Locked = False
			.ActiveSheet.Rows(0, .ActiveSheet.RowCount - 1).Height = 23

			'.ActiveSheet.Columns(Col展開).CellType = New FarPoint.Win.Spread.CellType.CheckBoxCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			.ActiveSheet.Columns(Col見積区分).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 1
			}
			.ActiveSheet.Columns(Col見積区分).ImeMode = System.Windows.Forms.ImeMode.Inherit
			.ActiveSheet.Columns(Colクレーム区分).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .CharacterSet = CellType.CharacterSet.Numeric,
			   .MaxLength = 1
			}
			.ActiveSheet.Columns(Colクレーム区分).ImeMode = System.Windows.Forms.ImeMode.Alpha
			.ActiveSheet.Columns(Col他社伝票番号).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 10
			}
			.ActiveSheet.Columns(Col他社伝票番号).ImeMode = System.Windows.Forms.ImeMode.Inherit
			.ActiveSheet.Columns(ColSP区分).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 1
			}
			.ActiveSheet.Columns(ColSP区分).ImeMode = System.Windows.Forms.ImeMode.Inherit
			.ActiveSheet.Columns(ColPC区分).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .CharacterSet = CellType.CharacterSet.AlphaNumeric,
			   .MaxLength = 1
			}
			.ActiveSheet.Columns(ColPC区分).ImeMode = System.Windows.Forms.ImeMode.Alpha
			.ActiveSheet.Columns(Col追番R).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 1
			}
			.ActiveSheet.Columns(Col追番R).ImeMode = System.Windows.Forms.ImeMode.Inherit

			.ActiveSheet.Columns(Col製品NO).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			  .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			  .MaxLength = 7
			}
			.ActiveSheet.Columns(Col製品NO).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Col仕様NO).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 7
			}
			.ActiveSheet.Columns(Col仕様NO).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Colベース色).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 7
			}
			.ActiveSheet.Columns(Colベース色).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Col名称).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 40
			}
			.ActiveSheet.Columns(Col名称).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColW).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColW).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColW).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(ColD).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColD).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColD).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(ColH).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColH).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColH).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(ColD1).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColD1).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColD1).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(ColD2).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColD2).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColD2).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(ColH1).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColH1).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColH1).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(ColH2).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(ColH2).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(ColH2).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
			.ActiveSheet.Columns(Col明細備考).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 60
			}
			.ActiveSheet.Columns(Col明細備考).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Colエラー内容).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 60
			}
			.ActiveSheet.Columns(Colエラー内容).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Col定価).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			   .ShowSeparator = True,
			   .NegativeFormat = FarPoint.Win.Spread.CellType.NegativeFormat.NegativeSignBefore,
			   .NegativeRed = True
			}
			.ActiveSheet.Columns(Col定価).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(ColU区分).CellType = New GrapeCity.Win.Spread.InputMan.CellType.GcTextBoxCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			.ActiveSheet.Columns(Col原価).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col原価).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Col仕入率).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col仕入率).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Col売価).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col売価).ImeMode = System.Windows.Forms.ImeMode.Off
			.ActiveSheet.Columns(Col売上率).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col売上率).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(ColM区分).CellType = New GrapeCity.Win.Spread.InputMan.CellType.GcTextBoxCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col見積数量).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 2,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			.ActiveSheet.Columns(Col単位).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 6
			}
			.ActiveSheet.Columns(Col単位).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(Col金額).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col仕入金額).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col売上税区分).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col消費税額).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			.ActiveSheet.Columns(Col仕入業者CD).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(Col仕入業者CD).ImeMode = System.Windows.Forms.ImeMode.Alpha
			'.ActiveSheet.Columns(Col仕入業者名).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			'  .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'  .MaxLength = 40
			'}
			.ActiveSheet.Columns(Col仕入先CD).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 4
			}
			.ActiveSheet.Columns(Col仕入先CD).ImeMode = System.Windows.Forms.ImeMode.Alpha
			'.ActiveSheet.Columns(Col仕入先名).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			'  .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'  .MaxLength = 40
			'}
			.ActiveSheet.Columns(Col送り先CD).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 2
			}
			.ActiveSheet.Columns(Col送り先CD).ImeMode = System.Windows.Forms.ImeMode.Alpha
			'.ActiveSheet.Columns(Col送り先名).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			'  .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'  .MaxLength = 40
			'}
			.ActiveSheet.Columns(Col作業区分CD).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .MaxLength = 1
			}
			.ActiveSheet.Columns(Col作業区分CD).ImeMode = System.Windows.Forms.ImeMode.Alpha
			'.ActiveSheet.Columns(Col作業区分名).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			'  .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'  .MaxLength = 60
			'}
			'.ActiveSheet.Columns(Col入庫日).CellType = New GrapeCity.Win.Spread.InputMan.CellType.GcDateTimeCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col出庫日).CellType = New GrapeCity.Win.Spread.InputMan.CellType.GcDateTimeCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col社内在庫).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col社内在庫).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(Col社内在庫参照).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			.ActiveSheet.Columns(Col客先在庫).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col客先在庫).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(Col客先在庫).CellType = New FarPoint.Win.Spread.CellType.GeneralCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col客先在庫参照).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			.ActiveSheet.Columns(Col転用).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col転用).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(Col転用).CellType = New FarPoint.Win.Spread.CellType.GeneralCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col発注調整数).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col発注数).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col数量合計).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			.ActiveSheet.Columns(Col仕分数1, Col製品区分 - 1).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			   .DecimalPlaces = 2,
			   .DecimalSeparator = ".",
			   .Separator = ",",
			...
			.ActiveSheet.Columns(Col仕分数1, Col製品区分 - 1).ImeMode = System.Windows.Forms.ImeMode.Off
			'.ActiveSheet.Columns(Col製品区分).CellType = New FarPoint.Win.Spread.CellType.TextCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'}
			'.ActiveSheet.Columns(Col見積明細連番).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col仕入済数).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 2,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col仕入済CNT).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'   .ReadOnly = True
			'}
			'.ActiveSheet.Columns(Col売上済CNT).CellType = New FarPoint.Win.Spread.CellType.NumberCellType With {
			'   .AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None,
			'   .DecimalPlaces = 0,
			'   .DecimalSeparator = ".",
			'   .Separator = ",",
			...
			'NOTE SS .UnitType = FPSpreadADO.UnitTypeConstants.UnitTypeTwips 'Twips単位
			'列の幅を設定する。
			...
			'rowCount   : クリアする行数
			'columnCount: クリアする列数
			dataModel.ClearData(0, 0, .ActiveSheet.RowCount - 1, .ActiveSheet.ColumnCount - 1)
			dataModel = Nothing
		End With
		...
		'行ヘッダのロック表示解除
		FpSpd.ActiveSheet.ColumnHeader.Rows(0).Locked = False
		'列ヘッダのロック表示解除
		FpSpd.ActiveSheet.RowHeader.Columns(0).Locked = False
		...
		With FpSpd
			...
			'NOTE SS .ActiveSheet.Cells(0, 0, .ActiveSheet.RowCount - 1, .ActiveSheet.ColumnCount - 1).ForeColor = Color.Black
			'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.BlockMode = False
			'2023/09/26 ADD↑
			...
			'.Row = -1
			'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Cells(0, Col原価, .ActiveSheet.RowCount - 1, Col原価).ForeColor = Color.Black
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col売価
			'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Row = -1
			'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Cells(0, Col売価, .ActiveSheet.RowCount - 1, Col売価).ForeColor = Color.Black
			...
			'.Row = -1
			'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Cells(0, Col社内在庫, .ActiveSheet.RowCount - 1, Col社内在庫).ForeColor = Color.Black
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col客先在庫参照
			'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Row = -1
			'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Cells(0, Col客先在庫参照, .ActiveSheet.RowCount - 1, Col客先在庫参照).ForeColor = Color.Black
			'2009/09/26 ADD↑
			...
			'.Lock = True
			.ActiveSheet.Columns(Col社内在庫).Locked = True
			'cRange = .ActiveSheet.Cells(0, Col社内在庫, .ActiveSheet.RowCount - 1, Col社内在庫)
			'cRange.Locked = True
			'col.Visible = False
			'col.Locked = True
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Columns(Col発注調整数).Locked = True
			'col.Visible = False
			'col.Locked = True
			'2016/12/21 ADD↑

			'Col見積数量、Col金額、Col仕入業者名、Col仕入先名、Col送り先名、Col作業区分名
			.ActiveSheet.Columns(Col見積数量).Locked = True
			.ActiveSheet.Columns(Col金額).Locked = True
			.ActiveSheet.Columns(Col仕入金額).Locked = True
			.ActiveSheet.Columns(Col売上税区分).Locked = True
			.ActiveSheet.Columns(Col消費税額).Locked = True
			.ActiveSheet.Columns(Col仕入業者CD).Locked = False
			.ActiveSheet.Columns(Col仕入業者名).Locked = True
			.ActiveSheet.Columns(Col仕入先CD).Locked = False
			.ActiveSheet.Columns(Col仕入先名).Locked = True
			.ActiveSheet.Columns(Col送り先CD).Locked = False
			.ActiveSheet.Columns(Col送り先名).Locked = True
			.ActiveSheet.Columns(Col作業区分CD).Locked = False
			.ActiveSheet.Columns(Col作業区分名).Locked = True

			'.ActiveSheet.Columns(Col社内在庫).Locked = True
			.ActiveSheet.Columns(Col社内在庫参照).Locked = True
			'.ActiveSheet.Columns(Col客先在庫).Locked = False
			.ActiveSheet.Columns(Col客先在庫参照).Locked = True
			'.ActiveSheet.Columns(Col転用).Locked = False
			.ActiveSheet.Columns(Col発注調整数).Locked = True
			.ActiveSheet.Columns(Col発注数).Locked = True
			.ActiveSheet.Columns(Col数量合計).Locked = True

			.ActiveSheet.Columns(Col仕入済数).Locked = True
			.ActiveSheet.Columns(Col仕入済CNT).Locked = True
			.ActiveSheet.Columns(Col売上済CNT).Locked = True

			If Environment.GetCommandLineArgs(0).ToUpper().Contains("DEBUG") Then
			Else
				'製品区分を非表示にします。
				'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Col = Col製品区分
				...
				'.ColHidden = True
				.ActiveSheet.Columns(Col製品区分).Visible = False
				'製品区分を非表示にします。
				'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Col = Col見積明細連番
				'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.ColHidden = True
				.ActiveSheet.Columns(Col見積明細連番).Visible = False
			End If
			'初期位置
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col見積区分
			...
			If wColsFrozen = vbNullString Then
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.ColsFrozen の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.ColsFrozen = Col名称
				.ActiveSheet.FrozenColumnCount = Col名称
			Else
				'UPGRADE_WARNING: オブジェクト fpSpd.ColsFrozen の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.ColsFrozen = CShort(wColsFrozen)
				.ActiveSheet.FrozenColumnCount = CInt(wColsFrozen)
			End If
			'-----------------
		End With
		...
		With FpSpd
			...
			For i = 0 To .ActiveSheet.RowCount - 1
				'行のサイズを変更を禁止
				.ActiveSheet.Rows(i).Resizable = False
			Next i
	...
	Private Sub FpSpd_Format()
		...
		With workbook
			...
			'他社納品日付(GcDateTime化)
			Dim gcdateyyyy As New GrapeCity.Win.Spread.InputMan.CellType.GcDateTimeCellType()
			gcdateyyyy.AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'gcdateyyyy.ShortcutKeys.Remove(Keys.F2 Or Keys.F5)
			gcdateyyyy.ShortcutKeys.Remove(Keys.F2)
			gcdateyyyy.ShortcutKeys.Remove(Keys.F5)
			gcdateyyyy.MinDate = "1990/01/01"
			gcdateyyyy.MaxDate = "2100/12/31"
			gcdateyyyy.DropDownCalendar.BackColor = Color.Ivory
			gcdateyyyy.DropDownCalendar.FlatStyle = FlatStyle.Popup
			gcdateyyyy.DropDownCalendar.HeaderFormat = ("yyyy/MM")
			gcdateyyyy.DropDownCalendar.HeaderStyle = New GrapeCity.Win.Spread.InputMan.CellType.Style(Color.Lavender, Color.Blue)
			gcdateyyyy.DropDownCalendar.ShowTodayMark = False
			gcdateyyyy.DisplayFields.Clear()
			gcdateyyyy.DisplayFields.AddRange("yyyy/MM/dd")
			gcdateyyyy.Fields.Clear()
			gcdateyyyy.Fields.AddRange("yyyy/MM/dd")
			.ActiveSheet.Columns(Col他社納品日付).CellType = gcdateyyyy

			'製品NO(GcTextBox化)
			'Dim gctextbox As New GrapeCity.Win.Spread.InputMan.CellType.GcTextBoxCellType()
			'gctextbox.AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'gctextbox.AllowSpace = GrapeCity.Win.Spread.InputMan.CellType.AllowSpace.Narrow
			'gctextbox.MaxLength = 7
			'gctextbox.ShortcutKeys.Remove(Keys.F2)
			'gctextbox.FormatString = "A9-,/"
			'gctextbox.AutoConvert = True
			'.ActiveSheet.Columns(Col製品NO).CellType = gctextbox
			'FpSpd.ActiveSheet.Columns(Col製品NO).ImeMode = System.Windows.Forms.ImeMode.Alpha
			'FpSpd.ActiveSheet.Columns(Col製品NO).Locked = False

			'U区分・M区分(GcTextBox化)
			Dim gctextboxAlpha As New GrapeCity.Win.Spread.InputMan.CellType.GcTextBoxCellType()
			gctextboxAlpha.AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			gctextboxAlpha.MaxLength = 1
			gctextboxAlpha.ShortcutKeys.Remove(Keys.F2)
			gctextboxAlpha.FormatString = "A"
			gctextboxAlpha.AutoConvert = True
			.ActiveSheet.Columns(ColU区分).CellType = gctextboxAlpha
			FpSpd.ActiveSheet.Columns(ColU区分).ImeMode = System.Windows.Forms.ImeMode.Alpha
			.ActiveSheet.Columns(ColM区分).CellType = gctextboxAlpha
			FpSpd.ActiveSheet.Columns(ColM区分).ImeMode = System.Windows.Forms.ImeMode.Alpha

			'入庫日・出庫日(GcDateTime化)
			Dim gcdateyy As New GrapeCity.Win.Spread.InputMan.CellType.GcDateTimeCellType()
			gcdateyy.AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.None
			'gcdateyy.ShortcutKeys.Remove(Keys.F2 Or Keys.F5)
			gcdateyy.ShortcutKeys.Remove(Keys.F2)
			gcdateyy.ShortcutKeys.Remove(Keys.F5)
			gcdateyy.MinDate = "1990/01/01"
			gcdateyy.MaxDate = "2100/12/31"
			gcdateyy.DropDownCalendar.BackColor = Color.Ivory
			gcdateyy.DropDownCalendar.FlatStyle = FlatStyle.Popup
			gcdateyy.DropDownCalendar.HeaderFormat = ("yyyy/MM")
			gcdateyy.DropDownCalendar.HeaderStyle = New GrapeCity.Win.Spread.InputMan.CellType.Style(Color.Lavender, Color.Blue)
			gcdateyy.DropDownCalendar.ShowTodayMark = False
			gcdateyy.DisplayFields.Clear()
			gcdateyy.DisplayFields.AddRange("yy/MM/dd")
			gcdateyy.Fields.Clear()
			gcdateyy.Fields.AddRange("yy/MM/dd")
			.ActiveSheet.Columns(Col入庫日).CellType = gcdateyy
			.ActiveSheet.Columns(Col出庫日).CellType = gcdateyy
			...
			.ActiveSheet.Cells(i, Col数量合計, .ActiveSheet.RowCount - 1, Col数量合計).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(i, Col数量合計, .ActiveSheet.RowCount - 1, Col数量合計).Formula = "sum(BA" & row & ":CD" & row & ")"   '2020/09/16 ADD
			'cRange.Formula = "sum(BA#:CD#)" '2020/09/16 ADD
			...
			'.Row = -1
			'UPGRADE_WARNING: オブジェクト fpSpd.Formula の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Cells(i, Col見積数量, .ActiveSheet.RowCount - 1, Col見積数量).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(i, Col見積数量, .ActiveSheet.RowCount - 1, Col見積数量).Formula = "AZ" & row & "-AW" & row & "-AU" & row    '2020/09/16 ADD
			'cRange.Formula = "AZ#-AW#-AU#" '2020/09/16 ADD
			...
			'.Row = -1
			'UPGRADE_WARNING: オブジェクト fpSpd.Formula の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Cells(i, Col発注数, .ActiveSheet.RowCount - 1, Col発注数).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(i, Col発注数, .ActiveSheet.RowCount - 1, Col発注数).Formula = "AZ" & row & "-AW" & row & "-AU" & row & "-AS" & row & "+AX" & row  '2020/09/16 ADD
			'cRange.Formula = "AZ#-AW#-AU#-AS#+AX#" '2020/09/16 ADD
			...
			'Next i
			.ActiveSheet.Cells(0, Col定価, .ActiveSheet.RowCount - 1, Col定価).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col原価, .ActiveSheet.RowCount - 1, Col原価).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col売価, .ActiveSheet.RowCount - 1, Col売価).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col金額, .ActiveSheet.RowCount - 1, Col金額).NumberFormat = "#,###,###,##0;[赤]-#,###,###,##0;"
			.ActiveSheet.Cells(0, Col社内在庫, .ActiveSheet.RowCount - 1, Col社内在庫).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col客先在庫, .ActiveSheet.RowCount - 1, Col客先在庫).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col転用, .ActiveSheet.RowCount - 1, Col発注調整数).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col仕分数1, .ActiveSheet.RowCount - 1, Col製品区分 - 1).NumberFormat = "#,##0.00;[赤]-#,##0.00;"
			.ActiveSheet.Cells(0, Col仕入済数, .ActiveSheet.RowCount - 1, Col仕入済数).NumberFormat = "#,##0.00;[赤]-#,##0.00"
		End With
	...
	Private Sub Fpspd_colUnLock()
		...
		With FpSpd
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Row2 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Row2 = .ActiveSheet.ActiveRowIndex
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = False
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col展開, .ActiveSheet.ActiveRowIndex, Col製品区分 - 1).Locked = False
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, ColSP区分, .ActiveSheet.ActiveRowIndex, ColSP区分).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Colエラー内容, .ActiveSheet.ActiveRowIndex, Colエラー内容).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col見積数量, .ActiveSheet.ActiveRowIndex, Col見積数量).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col金額, .ActiveSheet.ActiveRowIndex, Col消費税額).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col仕入業者名, .ActiveSheet.ActiveRowIndex, Col仕入業者名).Locked = True
			'2017/03/10 ADD↑
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col仕入先名, .ActiveSheet.ActiveRowIndex, Col仕入先名).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col送り先名, .ActiveSheet.ActiveRowIndex, Col送り先名).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col社内在庫, .ActiveSheet.ActiveRowIndex, Col社内在庫).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col客先在庫参照, .ActiveSheet.ActiveRowIndex, Col客先在庫参照).Locked = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Lock = True
			.ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, Col発注調整数, .ActiveSheet.ActiveRowIndex, Col数量合計).Locked = True
		...
		With FpSpd
			...
			If .ActiveSheet.ActiveRowIndex = .ActiveSheet.RowCount Then
				If e.AdvanceNext = True Then
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					If .ActiveSheet.ActiveColumnIndex <> (Col仕分数1 + 29) Then
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				End If
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			ElseIf .ActiveSheet.ActiveRowIndex = 1 Then
	...
	Private Sub FpSpd_Change(sender As Object, e As FarPoint.Win.Spread.ChangeEventArgs) Handles FpSpd.Change
		If e.Column <> Col展開 Then '2015/12/01 ADD
	...
	Private Sub FpSpd_EditModeStarting(sender As Object, e As FarPoint.Win.Spread.EditModeStartingEventArgs) Handles FpSpd.EditModeStarting
		...
		With FpSpd
			...
			'cRange = .ActiveSheet.Cells(.ActiveSheet.ActiveRowIndex, 0, .ActiveSheet.ActiveRowIndex, .ActiveSheet.ColumnCount)
			If .ActiveSheet.Rows(.ActiveSheet.ActiveRowIndex).BackColor <> System.Drawing.ColorTranslator.FromOle(&HFFFFC0) Then
				'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		Select Case Col
			Case ColPC区分
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldPc = FpSpd.ActiveSheet.GetText(Row, ColPC区分)
			Case Col製品NO
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldPc = FpSpd.ActiveSheet.GetText(Row, ColPC区分)
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldSei = FpSpd.ActiveSheet.GetText(Row, Col製品NO)
			Case Col仕様NO
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldPc = FpSpd.ActiveSheet.GetText(Row, ColPC区分)
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldSei = FpSpd.ActiveSheet.GetText(Row, Col製品NO)
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldSiy = FpSpd.ActiveSheet.GetText(Row, Col仕様NO)
				'        Case 6, 7
				'             'IMEモード[使用不可]
	...
	''' <summary>
	''' FpSpd編集開始、Keyイベントのハンドルの追加
	''' </summary>
	''' <param name="sender"></param>
	''' <param name="e"></param>
	Private Sub FpSpd_EditModeOn(ByVal sender As Object, ByVal e As System.EventArgs) Handles FpSpd.EditModeOn

		'セルの編集開始のタイミングで各Keyイベントをハンドルします
		Dim KeyDownHandler As KeyEventHandler = AddressOf FpSpd_KeyDown
		AddHandler FpSpd.EditingControl.KeyDown, KeyDownHandler

		Dim KeyPressHandler As KeyPressEventHandler = AddressOf FpSpd_KeyPress
		AddHandler FpSpd.EditingControl.KeyPress, KeyPressHandler

	End Sub

	''' <summary>
	''' FpSpd編集終了、Keyイベントのハンドルの削除
	''' </summary>
	''' <param name="sender"></param>
	''' <param name="e"></param>
	Private Sub FpSpd_EditModeOff(ByVal sender As Object, ByVal e As System.EventArgs) Handles FpSpd.EditModeOff

		With FpSpd.ActiveSheet
			Dim row = .ActiveRowIndex
			Dim col = .ActiveColumnIndex
			'Debug.WriteLine($"CellType: {FpSpd.ActiveSheet.GetCellType(row, col)}")
			'If TypeOf .GetCellType(row, col) Is GrapeCity.Win.Spread.InputMan.CellType.GcTextBoxCellType Then
			If TypeOf .GetCellType(row, col) Is FarPoint.Win.Spread.CellType.TextCellType Then
				' 対象セルの値を全て大文字にする
				Dim str As String = .ActiveCell().Value()
				If str IsNot Nothing Then
					.SetValue(row, col, str.ToUpper)
				End If
			End If
		End With
		...
		Dim KeyDownHandler As KeyEventHandler = AddressOf FpSpd_KeyDown
		RemoveHandler FpSpd.EditingControl.KeyDown, KeyDownHandler

		Dim KeyPressHandler As KeyPressEventHandler = AddressOf FpSpd_KeyPress
		RemoveHandler FpSpd.EditingControl.KeyPress, KeyPressHandler
	...
	Private Sub FpSpd_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles FpSpd.KeyDown
		...
		If KeyCode = System.Windows.Forms.Keys.Left And (Control.ModifierKeys And Keys.Shift) = Keys.Shift Then
			With FpSpd
				'初期位置
				'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Col = Col見積区分
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Action = FPSpreadADO.ActionConstants.ActionActiveCell
				.ActiveSheet.SetActiveCell(.ActiveSheet.ActiveRowIndex, Col見積区分)
				KeyCode = 0
				...
				'.LeftCol = Col見積区分
				.SetViewportLeftColumn(0, Col見積区分)
			End With
		End If
		'SHIFT+右矢印で仕分数1に進む
		'If KeyCode = System.Windows.Forms.Keys.Right And Shift = VB6.ShiftConstants.ShiftMask Then
		If KeyCode = System.Windows.Forms.Keys.Right And (Control.ModifierKeys And Keys.Shift) = Keys.Shift Then
			With FpSpd
				'初期位置
				'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Col = Col仕分数1
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Action = FPSpreadADO.ActionConstants.ActionActiveCell
				.ActiveSheet.SetActiveCell(.ActiveSheet.ActiveRowIndex, Col仕分数1)
				KeyCode = 0
			End With
		End If
		'SHIFT+上矢印で先頭に戻る
		'If KeyCode = System.Windows.Forms.Keys.Up And Shift = VB6.ShiftConstants.ShiftMask Then
		If KeyCode = System.Windows.Forms.Keys.Up And (Control.ModifierKeys And Keys.Shift) = Keys.Shift Then
			With FpSpd
				'UPGRADE_WARNING: オブジェクト fpSpd.DataRowCnt の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'TODO SS 'Call fpSpd_LeaveCell(.ActiveSheet.ActiveColumnIndex, .ActiveSheet.ActiveRowIndex, Col見積区分, .ActiveSheet.NonEmptyRowCount, False)
				'TODO SS Dim le As LeaveCellEventArgs = FarPoint.Win.Spread.LeaveCellEventArgs
				'TODO SS Call fpSpd_LeaveCell(fpSpd, le)
				'初期位置
				'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Col = Col見積区分
				'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		If KeyCode = System.Windows.Forms.Keys.Down And (Control.ModifierKeys And Keys.Shift) = Keys.Shift Then
			With FpSpd
				'UPGRADE_WARNING: オブジェクト fpSpd.DataRowCnt の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'TODO SS 'Call fpSpd_LeaveCell(.ActiveSheet.ActiveColumnIndex, .ActiveSheet.ActiveRowIndex, Col見積区分, .ActiveSheet.NonEmptyRowCount, False)
				'TODO SS dim e as LeaveCellEventArgs = FarPoint.Win.Spread.LeaveCellEventArgs
				'TODO SS Call fpSpd_LeaveCell(fpSpd, e)
				'初期位置
				'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Col = Col見積区分
				'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.Action = FPSpreadADO.ActionConstants.ActionActiveCell
				'.ActiveSheet.SetActiveCell(.ActiveSheet.NonEmptyRowCount, Col見積区分)
				.ActiveSheet.SetActiveCell(clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1, Col見積区分)
				KeyCode = 0
			End With
		End If
	...
	Private Sub FpSpd_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles FpSpd.KeyPress
		Dim KeyAscii As Integer = Asc(e.KeyChar) ' ASCII コードを取得
		'Dim fpSpd As Object
		Dim check As Boolean
		Dim getdata As Object
		...
		Dim ge As FarPoint.Win.Spread.CellType.GeneralEditor = Nothing
		If TypeOf FpSpd.EditingControl Is FarPoint.Win.Spread.CellType.GeneralEditor Then
			ge = CType(FpSpd.EditingControl, FarPoint.Win.Spread.CellType.GeneralEditor)
		End If
		If ge Is Nothing Then
			Try
				ge = FpSpd.ActiveSheet.ActiveCell.Editor
		...
		With FpSpd.ActiveSheet
			...
			Select Case .ActiveColumnIndex
				...
				Case ColPC区分, Col製品NO
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					getdata = .GetText(.ActiveRowIndex, .ActiveColumnIndex)
					check = True
					If check Then
						...
						'If KeyAscii = Asc(" ") And (ge.SelectionStart = 0 And ge.SelectionLength = Len(getdata)) Then
						If KeyAscii = Asc(" ") AndAlso (ge IsNot Nothing AndAlso ge.SelectionStart = 0 AndAlso ge.SelectionLength = Len(getdata) OrElse ge Is Nothing) Then
							KeyAscii = 0
							SelSeiInfChk.ResParentForm = Me
							'VB6.ShowForm(SelSeiInfChk, VB6.FormShowConstants.Modal, Me)
							SelSeiInfChk.ShowDialog(Me)
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Action = FPSpreadADO.ActionConstants.ActionActiveCell
							.SetActiveCell(.ActiveRowIndex, .ActiveColumnIndex)
							If DspSelData() Then
								LcbFunc(10).Text = "ﾁｪｯｸ"
							End If
							'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							HoldPc = FpSpd.ActiveSheet.GetText(.ActiveRowIndex, ColPC区分) '2004/02/05 ADD
							'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							HoldSei = FpSpd.ActiveSheet.GetText(.ActiveRowIndex, Col製品NO) '2004/02/05 ADD
				...
				Case ColW To ColH2 'サイズ
					...
					If KeyAscii <> System.Windows.Forms.Keys.Back Then ' バックスペースは例外
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'fpSpd.Col = .ActiveColumnIndex
						'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'fpSpd.Row = .ActiveRowIndex
						...
						If ge.SelectedText = .GetText(.ActiveRowIndex, .ActiveColumnIndex) Then Exit Sub
						'UPGRADE_WARNING: オブジェクト fpSpd.Text の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					...
					If check Then
						...
						If KeyAscii = Asc(" ") AndAlso (ge IsNot Nothing AndAlso ge.SelectionStart = 0 AndAlso ge.SelectionLength = Len(getdata) OrElse ge Is Nothing) Then
							...
							If cSiiresaki.ShowDialog = True Then
								...
								'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.SetText(.ActiveRowIndex, .ActiveColumnIndex, cSiiresaki.仕入先CD)
								SendReturnKey()
								LcbFunc(10).Text = "ﾁｪｯｸ"
							Else
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					...
					If check Then
						...
						If KeyAscii = Asc(" ") AndAlso (ge IsNot Nothing AndAlso ge.SelectionStart = 0 AndAlso ge.SelectionLength = Len(getdata) OrElse ge Is Nothing) Then
							...
							If cHaisosaki.ShowDialog = True Then
								...
								'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.SetText(.ActiveRowIndex, .ActiveColumnIndex, cHaisosaki.配送先CD)
								SendReturnKey()
								LcbFunc(10).Text = "ﾁｪｯｸ"
							Else
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				Case ColU区分
					...
					If InStr("URBHZ", Chr(KeyAscii)) = 0 Then '2024/07/16 ADD
						KeyAscii = 0
					End If
					'2016/06/22 ADD↓
				Case Col作業区分CD
	...
	Private Sub FpSpd_LeaveCell(sender As Object, e As LeaveCellEventArgs) Handles FpSpd.LeaveCell
		...
		Dim chkPc As Boolean
		Dim getPc As Object
		Dim chkSei As Boolean
		Dim getSei As Object
		'Dim chkSiy As Boolean
		Dim getSiy As Object
			...
			Select Case e.Column
				...
				Case ColPC区分 '3
					If check = False Then
						...
						If getdata <> HoldPc Then
							...
							getSei = .ActiveSheet.GetText(e.Row, Col製品NO)
							'UPGRADE_WARNING: オブジェクト chkSei の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							If chkSei <> False Then
								...
								getSiy = .ActiveSheet.GetText(e.Row, Col仕様NO)
								...
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								Call Entry_Chk(0, CShort(e.Row), CStr(getdata), CStr(getSei), CStr(getSiy))
								'原価・売価
								Call Get率(e.Row, Col原価)
								Call Get率(e.Row, Col売価)
								Call Get金額(e.Row)
								Call Calc合計()
							Else
							End If
					...
					Else
						...
						If getdata = HoldPc Then
							'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, e.Column, "" & getdata)
						Else
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト chkSei の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getSei = .ActiveSheet.GetText(e.Row, Col製品NO)
				...
				Case Col製品NO '4
					...
					If check = False Then
						...
						If getdata <> HoldSei Then
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col製品NO, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col仕様NO, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Colベース色, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col名称, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColW, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColH, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColD1, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColD2, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColH1, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColH2, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Colエラー内容, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col定価, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, ColU区分, "") '2005/10/14
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col原価, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col売価, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col単位, "")
							'2017/03/10 ADD↓
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col仕入業者CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col仕入業者名, "")
							'2017/03/10 ADD↑
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col仕入先CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col仕入先名, "")
							...
							Call Calc合計()
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col製品区分, "") '2003/11/05
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col社内在庫参照, "") '2010/01/27 ADD
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(e.Row, Col客先在庫参照, "") '2010/01/27 ADD
							'2015/10/26 ADD↓
							'名称をロック解除する。
							'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.BlockMode = True
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Lock = False
							.ActiveSheet.Cells(e.Row, ColW, e.Row, ColH2).Locked = False
					...
					Else
						...
						Else
							...
							getPc = .ActiveSheet.GetText(e.Row, ColPC区分)
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト chkSiy の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getSiy = .ActiveSheet.GetText(e.Row, Col仕様NO)
							'UPGRADE_WARNING: オブジェクト getSiy の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							...
							Call Entry_Chk(0, CShort(e.Row), CStr(getPc), CStr(getdata), CStr(getSiy))
							'原価・売価
							Call Get率(e.Row, Col原価)
							Call Get率(e.Row, Col売価)
							Call Get金額(e.Row)
				...
				Case Col仕様NO '5
					...
					Else
						...
						Else
							...
							'UPGRADE_WARNING: オブジェクト getSei の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト getPc の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							Call Entry_Chk(0, CShort(e.Row), CStr(getPc), CStr(getSei), CStr(getdata))
							'原価・売価
							Call Get率(e.Row, Col原価)
							Call Get率(e.Row, Col売価)
							Call Get金額(e.Row)
				...
				Case Col定価
					...
					If getdata <> HoldCD Then
						'原価・売価
						Call Get単価(e.Row, Col仕入率)
						Call Get単価(e.Row, Col売上率)
						Call Get金額(e.Row)
						Call Calc合計()
					End If
					'            Case Col原価, Col売価
					...
					If getdata <> HoldCD Then
						Select Case Chk原価率(e.Row)
							Case False
								...
								'.Row = Row
								'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								cRange = .ActiveSheet.Cells(e.Row, Col原価, e.Row, Col原価)
								cRange.ForeColor = Color.Red
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.Col = Col売価
								'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.Row = Row
								'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								cRange = .ActiveSheet.Cells(e.Row, Col売価, e.Row, Col売価)
								cRange.ForeColor = Color.Red
								'                            .SetFocus
				...
				Case Col仕入率
					...
					If getdata <> HoldCD Then
						...
						'2008/01/23 ADD↓
						Select Case Chk原価率(e.Row, Get単価(e.Row, Col仕入率, False))
							Case False
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.Col = Col原価
								'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				Case Col売上率
					...
					If getdata <> HoldCD Then
						...
						'                    Call Get単価(Row, Col, False)
						'2008/01/23 ADD↓
						Select Case Chk原価率(e.Row,  , Get単価(e.Row, Col売上率, False))
							Case False
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.Col = Col原価
								'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				Case Col社内在庫
					...
					If getdata <> HoldCD Then
						...
						'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						If CDec(NullToZero(clsSPD.GetTextEX(Col仕入済CNT, e.Row))) <> 0 Then '2018/06/19 ADD
							'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							If CDec(NullToZero(clsSPD.GetTextEX(Col発注数, e.Row))) < CDec(NullToZero(clsSPD.GetTextEX(Col仕入済数, e.Row))) Then
								'UPGRADE_WARNING: オブジェクト fpSpd.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.Focus()
								CriticalAlarm("仕入済みです。")
								'UPGRADE_WARNING: オブジェクト HoldCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(e.Row, e.Column, "" & HoldCD) '元に戻す
								'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'.Col = .ActiveSheet.ActiveColumnIndex
								'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				Case Col仕入業者CD
					...
					If check = False Then
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(e.Row, Col仕入業者名, Get仕入先略称(getdata))
					Else
						'仕入先CD
						'UPGRADE_WARNING: オブジェクト HoldCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						If getdata <> HoldCD Then
							...
							Else
								...
								If ISInt(getdata) Then
									'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									getdata = CType(getdata, Integer).ToString(New String("0"c, 4))
									'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									.ActiveSheet.SetText(e.Row, Col仕入業者CD, "" & getdata)
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									.ActiveSheet.SetText(e.Row, Col仕入業者名, Get仕入先略称(getdata))
								End If
								''                            '2015/09/28 ADD↓
				...
				Case Col仕入先CD
					...
					If check = False Then
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(e.Row, Col仕入先名, Get仕入先略称(getdata))
					Else
						'仕入先CD
						'UPGRADE_WARNING: オブジェクト HoldCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						If getdata <> HoldCD Then
							...
							Else
								...
								If ISInt(getdata) Then
									...
									'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									.ActiveSheet.SetText(e.Row, Col仕入先CD, "" & getdata)
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									.ActiveSheet.SetText(e.Row, Col仕入先名, Get仕入先略称(getdata))
									...
									'.BlockMode = True
									'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									cRange = .ActiveSheet.Cells(e.Row, 0, e.Row, .ActiveSheet.ColumnCount - 1)
									cRange.ForeColor = Getインボイス番号NGColor(getdata)
									'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'.BlockMode = False
									'2023/09/26 ADD↑
								End If
								...
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								cUriSirTanka.仕入先CD = getdata
								cUriSirTanka.製品NO = clsSPD.GetTextEX(Col製品NO, e.Row)
								cUriSirTanka.仕様NO = clsSPD.GetTextEX(Col仕様NO, e.Row)

								If cUriSirTanka.GetbyID = True Then
									If CDbl([tx_大小口区分].Text) = 0 Then
										'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'.ActiveSheet.SetText(Row, Col原価, NullToZero(cUriSirTanka.大口仕入単価, 0).ToString("#")) '2024/07/19 DEL
										'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'.ActiveSheet.SetText(Row, Col売価, NullToZero(cUriSirTanka.大口売上単価, 0).ToString("#")) '2024/07/19 DEL
										.ActiveSheet.SetText(e.Row, Col原価, NullToZero(cUriSirTanka.大口仕入単価, 0)) '2024/07/19 ADD
										.ActiveSheet.SetText(e.Row, Col売価, NullToZero(cUriSirTanka.大口売上単価, 0)) '2024/07/19 ADD
									Else
										'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'.ActiveSheet.SetText(Row, Col原価, NullToZero(cUriSirTanka.小口仕入単価, 0).ToString("#")) '2024/07/19 DEL
										'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
										'.ActiveSheet.SetText(Row, Col売価, NullToZero(cUriSirTanka.小口売上単価, 0).ToString("#")) '2024/07/19 DEL
										.ActiveSheet.SetText(e.Row, Col原価, NullToZero(cUriSirTanka.小口仕入単価, 0)) '2024/07/19 ADD
										.ActiveSheet.SetText(e.Row, Col売価, NullToZero(cUriSirTanka.小口売上単価, 0)) '2024/07/19 ADD
									End If
								End If
								'2015/09/28 ADD↑
				...
				Case Col送り先CD
					...
					If check = False Then
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(e.Row, Col送り先名, Get配送先略称(getdata))
					Else
						'配送先CD
						'UPGRADE_WARNING: オブジェクト HoldCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						If getdata <> HoldCD Then
							If ISInt(getdata) Then
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								getdata = CType(getdata, Integer).ToString(New String("0"c, 2))
								'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(e.Row, Col送り先CD, "" & getdata)
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(e.Row, Col送り先名, Get配送先略称(getdata))
							End If
						End If
				...
				Case Col作業区分CD
					...
					If getdata <> HoldCD Then
						'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(e.Row, Col作業区分名, ModKubuns.Get作業区分名(NullToZero(getdata, "")))
					End If
			End Select
		End With

		'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		getdata = FpSpd.ActiveSheet.GetText(e.Row, ColU区分)
		...
		If e.Row <> e.NewRow Then
			With FpSpd
				...
				If e.NewRow >= 0 Then
					...
					'            End If
					'2017/07/03 ADD
					Call RowBackColorSet2(clsSPD.GetTextEX(ColU区分, e.NewRow), e.NewRow)
				End If
				'2017/07/03 ADD
				Call RowBackColorSet2(clsSPD.GetTextEX(ColU区分, e.Row), e.Row)
			End With
		End If
	...
	Private Sub Entry_Chk(ByRef KIRIWAKE As Short, ByRef Row As Integer, ByRef PCKBN As String, ByRef SEIHNO As String, ByRef SIYONO As String)
		...
		Dim chkHaiso As Boolean
		Dim getHaiso As Object

		Dim SeihKB As Integer
		Dim bufName As String '名前取得用バッファ
		Dim bufBase As String
		Dim bufW As Short
		Dim bufD As Short
		...
		With FpSpd
			...
			Select Case SeihKB
				Case -1
					'エラーの時
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(Row, Col製品区分, "")
					'---2004/03/05 ADD
					If KIRIWAKE = 1 Then
						'配送先
						'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						...
						getHaiso = .ActiveSheet.GetText(Row, Col送り先CD)
						If getHaiso.ToString().Trim() = "" Then
							chkHaiso = False
						Else
							chkHaiso = True
						End If
						...
						End If
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(Row, Col送り先CD, getHaiso)
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(Row, Col送り先名, Get配送先略称(getHaiso))
					End If
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = False
					.ActiveSheet.Cells(Row, ColW, Row, ColH2).Locked = False
				...
				Case 0, 3
					...
					Select Case Get製品情報VDB(SeihKB, PCKBN, SEIHNO, SIYONO, bufName, bufBase, bufW, bufD, bufH, bufD1, bufD2, bufH1, bufH2, bufTeika, bufGenka, bufBaika, bufTANI, bufSIRECD, bufUZeiKBN, bufSZeiKBN, bufHIYOUKBN)
						...
						Case 0
							...
							'定価
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col定価, If(bufTeika = 0, "", bufTeika))
							'原価
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col原価, If(bufGenka = 0, "", bufGenka))
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColU区分, "") '2005/10/14
							'売価
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col売価, If(bufBaika = 0, "", bufBaika))
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColM区分, "")
							'売上税区分
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col売上税区分, bufUZeiKBN)
							'配送先
							'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'UPGRADE_WARNING: オブジェクト chkHaiso の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							getHaiso = .ActiveSheet.GetText(Row, Col送り先CD)
							...
							'製品区分
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col製品区分, SeihKB)
							'仕入先略称
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col仕入先名, Get仕入先略称(bufSIRECD))

							If KIRIWAKE = 0 Then
								'選択画面、手入力の場合
								'ベース色
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Colベース色, bufBase)
								'名称
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col名称, bufName)
								'単位
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col単位, bufTANI)

								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColW, If(bufW = 0, "", bufW)) 'W
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColD, If(bufD = 0, "", bufD)) 'D
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColH, If(bufH = 0, "", bufH)) 'H
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColD1, If(bufD1 = 0, "", bufD1)) 'D1
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColD2, If(bufD2 = 0, "", bufD2)) 'D2
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColH1, If(bufH1 = 0, "", bufH1)) 'H1
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, ColH2, If(bufH2 = 0, "", bufH2)) 'H2
								'2017/03/10 ADD↓
								'仕入業者
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col仕入業者CD, bufSIRECD)
								'仕入先略称
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col仕入業者名, Get仕入先略称(bufSIRECD))
								'2017/03/10 ADD↑
								'仕入先
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col仕入先CD, bufSIRECD)
							End If
							...
							cUriSirTanka.Initialize()
							cUriSirTanka.得意先CD = [rf_得意先CD].Text
							cUriSirTanka.仕入先CD = clsSPD.GetTextEX(Col仕入先CD, Row) '2024/01/19 ADD
							...
							If cUriSirTanka.GetbyID = True Then
								If CDbl([tx_大小口区分].Text) = 0 Then
									...
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'.ActiveSheet.SetText(Row, Col売価, NullToZero(cUriSirTanka.大口売上単価, 0).ToString("#")) '2024/07/19 DEL
									.ActiveSheet.SetText(Row, Col原価, NullToZero(cUriSirTanka.大口仕入単価, 0)) '2024/07/19 ADD
									.ActiveSheet.SetText(Row, Col売価, NullToZero(cUriSirTanka.大口売上単価, 0)) '2024/07/19 ADD
								Else
									'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'.ActiveSheet.SetText(Row, Col原価, NullToZero(cUriSirTanka.小口仕入単価, 0).ToString("#")) '2024/07/19 DEL
									...
									'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
									'.ActiveSheet.SetText(Row, Col売価, NullToZero(cUriSirTanka.小口売上単価, 0).ToString("#")) '2024/07/19 DEL
									.ActiveSheet.SetText(Row, Col原価, NullToZero(cUriSirTanka.小口仕入単価, 0)) '2024/07/19 ADD
									.ActiveSheet.SetText(Row, Col売価, NullToZero(cUriSirTanka.小口売上単価, 0)) '2024/07/19 ADD
								End If
							End If
							'2015/09/28 ADD↑
							...
							If (bufHIYOUKBN = 1) Then
								'通常
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col作業区分CD, 1)
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col作業区分名, ModKubuns.Get作業区分名(CStr(1)))
							End If
							If (HD_業種区分 = 1) Then
								'内装
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col作業区分CD, 3)
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col作業区分名, ModKubuns.Get作業区分名(CStr(3)))
							End If
							If (HD_物件種別 = 2) Then
								'コールセンター
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col作業区分CD, 2)
								'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
								.ActiveSheet.SetText(Row, Col作業区分名, ModKubuns.Get作業区分名(CStr(2)))
							End If
							'2024/02/20 ADD↑
						...
						Case -1
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Colベース色, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col名称, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColW, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColH, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColD1, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColD2, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColH1, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColH2, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col定価, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColU区分, "") '2005/10/14
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col原価, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col売価, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, ColM区分, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col単位, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col売上税区分, "")
							'2017/03/10 ADD↓
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col仕入業者CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col仕入業者名, "")
							'2017/03/10 ADD↑
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col仕入先CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col仕入先名, "")
							'---2004/03/05.DEL
							...
							'2009/09/26 ADD↓
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col社内在庫参照, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							.ActiveSheet.SetText(Row, Col客先在庫参照, "")
							'2009/09/26 ADD↑
		...
		With FpSpd
			...
			If cSeihin.GetbyID = True Then
				...
				If cSeihin.サイズ変更区分 = 0 Then '2020/10/10 ADD
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
					.ActiveSheet.Cells(Row, ColW, Row, ColH2).Locked = True
				Else
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = True
					'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Private Sub Comment_spd(ByRef Col As Integer, ByRef Row As Integer)
		...
		With FpSpd
			Select Case Col
				...
				Case 0
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "チェック：展開する"
					'ボタン名設定
					Call SetUpFuncs("展開")
				Case Col見積区分
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "見積区分を入力して下さい。  コメント：A･C 空白：S"
					'ボタン名設定
					Call SetUpFuncs("見積区分")
				Case ColSP区分
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "ＳＰ区分を入力して下さい。"
					'ボタン名設定
					Call SetUpFuncs("SP区分")
				Case ColPC区分
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "ＰＣ区分を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("PC区分")
				Case Col製品NO
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "製品NOを入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("製品NO")
				Case Col仕様NO
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "仕様NOを入力して下さい。"
					'ボタン名設定
					Call SetUpFuncs("仕様NO")
					'IMEモードを「半角カタカナ」にする
					Call ImmOpenModeSet(Me.Handle, Win32API_IME.ConversionMODE.HANKANA)
				Case Colベース色
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "ベース色を入力して下さい。"
					'ボタン名設定
				...
				Case Col名称
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "名称を入力して下さい。"
					'ボタン名設定
					Call SetUpFuncs("名称")
					'IMEモードを「全角ひらがな」にする
				...
				Case Col単位
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "単位を入力して下さい。"
					'ボタン名設定
					Call SetUpFuncs("単位")
					'IMEモードを「全角ひらがな」にする
					Call ImmOpenModeSet(Me.Handle, Win32API_IME.ConversionMODE.ZENHIRA)
				...
				Case Col仕入業者CD
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "仕入業者を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("仕入業者")
					'2017/03/10 ADD↑
				Case Col仕入先CD
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "仕入先を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("仕入先")
				Case Col送り先CD
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "送り先を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("送り先")
					'2018/05/03 ADD↓
				Case Col入庫日
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "入庫日を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("入庫日")
					'2017/05/03 ADD↑
					'2020/09/16 ADD↓
				Case Col出庫日
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "出庫日を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("出庫日")
					'2020/09/16 ADD↑
				Case Col社内在庫
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "社内在庫数を入力して下さい。　選択画面：Space"
					'ボタン名設定
					Call SetUpFuncs("社内在庫数")
				Case Col客先在庫
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "客先在庫数を入力して下さい。　選択画面：Space"
					'ボタン名設定
				...
				Case ColU区分
					...
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					'sb_Msg.Items.Item(0).Text = "原価未確定:U 売価未確定:B 注意書き:R 発注保留:H" '2017/07/03 ADD
					sb_Msg.Items.Item(0).Text = "原価未確定:U 売価未確定:B 注意書き:R 発注保留:H 発注済:Z" '2024/07/16 ADD
					'ボタン名設定
					Call SetUpFuncs("U")
				Case ColM区分
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "単価を固定したい場合、Mを入力して下さい。"
					'ボタン名設定
					Call SetUpFuncs("M")
				Case Col作業区分CD
					...
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "作業区分を入力して下さい。（1:工事 2:コール 3:内装 4:ｸﾚｰﾑ）" '2023/04/04 ADD
					'ボタン名設定
					Call SetUpFuncs(buf)
					'2019/12/12 ADD↓
				Case Col追番R
					'UPGRADE_WARNING: コレクション sb_Msg.Panels の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
					sb_Msg.Items.Item(0).Text = "レビット取込用の場合、Rを入力して下さい。" '2017/12/12 ADD
					'ボタン名設定
					Call SetUpFuncs("追番R")
					'2019/12/12 ADD↑
				Case Col仕分数1 To Col仕分数1 + 29
	...
	Private Sub Op_Disp_CheckedChanged(sender As Object, e As EventArgs)
		Dim rdo As RadioButton = DirectCast(sender, RadioButton)
		Dim index As Integer = DirectCast(rdo.Tag, Integer) - 1 ' インデックスを取得
		...
		If sender.Checked Then
			'Dim Index As Integer = op_Disp.GetIndex(eventSender)
			'Dim fpSpd As Object
			'スプレッドの表示項目の変更
			'------------------------------------------
			...
			Select Case index
				Case 0 '見積情報
					With FpSpd
						'UPGRADE_WARNING: オブジェクト fpSpd.LeftCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.LeftCol = 1
						.SetViewportLeftColumn(0, 0)
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Colベース色
						col = .ActiveSheet.Columns(Colベース色)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = ColD1
						col = .ActiveSheet.Columns(ColD1)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = ColD2
						col = .ActiveSheet.Columns(ColD2)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = ColH1
						col = .ActiveSheet.Columns(ColH1)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = ColH2
						col = .ActiveSheet.Columns(ColH2)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = ColU区分
						col = .ActiveSheet.Columns(ColU区分)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col原価
						col = .ActiveSheet.Columns(Col原価)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col仕入率
						col = .ActiveSheet.Columns(Col仕入率)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col金額
						col = .ActiveSheet.Columns(Col金額)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'2017/03/10 ADD↓
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col仕入業者CD
						col = .ActiveSheet.Columns(Col仕入業者CD)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col仕入業者名
						col = .ActiveSheet.Columns(Col仕入業者名)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'2017/03/10 ADD↑
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col仕入先CD
						col = .ActiveSheet.Columns(Col仕入先CD)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col仕入先名
						col = .ActiveSheet.Columns(Col仕入先名)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col送り先CD
						col = .ActiveSheet.Columns(Col送り先CD)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Col送り先名
						col = .ActiveSheet.Columns(Col送り先名)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Colエラー内容
						col = .ActiveSheet.Columns(Colエラー内容)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.ColHidden = True
						col.Visible = False
					End With
				...
				Case 3 '取引先情報
					With FpSpd
						'UPGRADE_WARNING: オブジェクト fpSpd.LeftCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.LeftCol = Col仕入先CD
						.SetViewportLeftColumn(0, Col仕入先CD)
						'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Col = Colベース色
						col = .ActiveSheet.Columns(Colベース色)
						'UPGRADE_WARNING: オブジェクト fpSpd.ColHidden の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Private Sub Op_Disp_MouseUp(sender As Object, e As MouseEventArgs)
		Dim rdo As RadioButton = DirectCast(sender, RadioButton)
		Dim index As Integer = DirectCast(rdo.Tag, Integer) ' インデックスを取得
		'Dim Button As Short = sender.Button \ &H100000
		'Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6Conv.PixelsToTwipsX(e.X)
		Dim Y As Single = VB6Conv.PixelsToTwipsY(e.Y)
		'Dim Index As Short = op_Disp.GetIndex(sender)
		'元の位置に戻る
		If PreviousControl IsNot Nothing Then
			PreviousControl.Focus()
		End If
	...
	Private Function Get製品情報DB(ByVal PCKB As String, ByVal SEIHNO As String, ByVal SIYONO As String, ByRef SeihKBN As Short) As Short
		...
		'---製品情報存在チェック
		sql = "SELECT 製品区分 " & "FROM TM製品情報 " & "WHERE PC区分 = '" & Strings.Left(PCKB & Space(1), 1) & "' " & "AND 製品No = '" & Strings.Left(SQLString(SEIHNO) & Space(7), 7) & "' " & "AND 仕様No = '" & Strings.Left(SQLString(SIYONO) & Space(7), 7) & "'"
	...
	Private Function Get単価DB(ByVal SeihKB As Short, ByVal TOKUCD As String, ByVal OKKubn As Short, ByVal PCKUBN As String, ByVal SEIHNO As String, ByVal SIYONO As String, ByRef Genka As Decimal, ByRef Baika As Decimal) As Short
		...
		With rs
			...
			Else
				If OKKubn = 0 Then
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					Genka = NullToZero(.Fields("大口仕入単価").Value, 0)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					Baika = NullToZero(.Fields("大口売上単価").Value, 0)
				Else
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					Genka = NullToZero(.Fields("小口仕入単価").Value, 0)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					Baika = NullToZero(.Fields("小口売上単価").Value, 0)
				End If
				Get単価DB = 0
			End If
		End With
...
Get単価DB_Err:
	...
	Private Function Get製品情報VDB(ByVal SKUBN As Short, ByRef PCKUBN As String, ByVal SEIHNO As String, ByVal SIYONO As String, ByRef IDName As String, ByRef BaseCol As String, ByRef SizeW As Short, ByRef SizeD As Short, ByRef SizeH As Short, ByRef SizeD1 As Short, ByRef SizeD2 As Short, ByRef SizeH1 As Short, ByRef SizeH2 As Short, ByRef Teika As Decimal, ByRef Genka As Decimal, ByRef Baika As Decimal, ByRef TANIName As String, ByRef SIRECD As String, ByRef UZEIKBN As Short, ByRef SZEIKBN As Short, ByRef HIYOUKBN As Short) As Short
		...
		Select Case SKUBN
			Case 0
				whr = " 製品区分 = 0" & " AND 製品NO = '" & SQLString(Trim(SEIHNO)) & "'" & " AND 仕様NO = '" & SQLString(SIYONO) & "'" & " AND 廃盤FLG = 0" '2015/09/11 ADD
			Case 1
		...
		sql += " 定価, 仕入単価, 売上単価, 単位名, 仕入先, 売上税区分, 仕入税区分 "
		sql += ",費用区分" '2024/02/20 ADD
		sql += " FROM VM製品情報 "
		sql += " WHERE" & whr
		...
		With rs
			...
			Else
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				IDName = NullToZero(.Fields("名称").Value, vbNullString)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				BaseCol = NullToZero(.Fields("ベース色").Value, vbNullString)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeW = NullToZero(.Fields("W").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeD = NullToZero(.Fields("D").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeH = NullToZero(.Fields("H").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeD1 = NullToZero(.Fields("D1").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeD2 = NullToZero(.Fields("D2").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeH1 = NullToZero(.Fields("H1").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SizeH2 = NullToZero(.Fields("H2").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Teika = NullToZero(.Fields("定価").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Genka = NullToZero(.Fields("仕入単価").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Baika = NullToZero(.Fields("売上単価").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				TANIName = NullToZero(.Fields("単位名").Value, vbNullString)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SIRECD = NullToZero(.Fields("仕入先").Value, vbNullString)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				UZEIKBN = NullToZero(.Fields("売上税区分").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				SZEIKBN = NullToZero(.Fields("仕入税区分").Value, 0)
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HIYOUKBN = NullToZero(.Fields("費用区分").Value, 0) '2024/02/20 ADD
				Get製品情報VDB = 0
			End If
		End With
		ReleaseRs(rs)
...
Get製品情報VDB_Err:
	...
	Private Function Upload_Chk() As Short
		...
		If clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1 = 0 Then
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'fpSpd.Col = fpSpd.ActiveSheet.ActiveRow
			'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'fpSpd.Row = fpSpd.ActiveSheet.ActiveRowIndex
			'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		With cmd.Parameters
			...
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i見積番号").Value = SpcToNull(rf_見積番号.Text, 0)
			.Item("@i見積日付").Value = CType(tx_見積日付.Text, DateTime).ToString("yyyy/MM/dd")
			...
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i合計金額").Value = SpcToNull(tx_合計金額.Text, 0) '2020/06/18 ADD

			.Item("@i業種区分").Value = SpcToNull(HD_業種区分, 0) '2024/06/25 ADD
		...
		If grs.State <> 0 Then
			...
			Else
				...
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				gErrNo = NullToZero(cmd.Parameters("@wErr行番号").Value.ToString(), "") '2005/03/26 ADD
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				w仕分数入力MAX列 = NullToZero(CInt(cmd.Parameters("@w仕分MAX列").Value), 0) '2017/05/10 ADD
			End If
		Else
			Upload_Chk = -1
...
Upload_Chk_err: '---エラー時
	...
	Private Function SetCheckTempD(ByRef rs As ADODB.Recordset) As Boolean
		...
		'シートのクリア
		'NOTE SS Call clsSPD.SprClearText()
		Call FpSpd_Format() 'GcFormat
		...
		With FpSpd
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col2 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.MaxCols の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col2 = .ActiveSheet.RowCount
			'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Row = 1
			'UPGRADE_WARNING: オブジェクト fpSpd.Row2 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト fpSpd.MaxRows の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Row2 = .ActiveSheet.ColumnCount
			'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.Rows(0).BackColor = System.Drawing.ColorTranslator.FromOle(&HFFFFFF)
			'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.BlockMode = False
		End With
		...
		With FpSpd
			...
			Do Until rs.EOF
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col展開, Trim(rs.Fields("展開CHK").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col見積区分, Trim(rs.Fields("見積区分").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Colクレーム区分, CType(Trim(rs.Fields("クレーム明細区分").Value & ""), Integer).ToString("#")) '2016/06/22 ADD

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col他社伝票番号, Trim(rs.Fields("他社伝票番号").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col他社納品日付, Trim(rs.Fields("他社納品日付").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColSP区分, Trim(rs.Fields("SP区分").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColPC区分, Trim(rs.Fields("PC区分").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col製品NO, Trim(rs.Fields("製品NO").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col仕様NO, Trim(rs.Fields("仕様NO").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Colベース色, Trim(rs.Fields("ベース色").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col名称, Trim(rs.Fields("漢字名称").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColW, CType(rs.Fields("W").Value & "", Integer).ToString("#"))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColD, CType(rs.Fields("D").Value & "", Integer).ToString("#"))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColH, CType(rs.Fields("H").Value & "", Integer).ToString("#"))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColD1, CType(rs.Fields("D1").Value & "", Integer).ToString("#"))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColD2, CType(rs.Fields("D2").Value & "", Integer).ToString("#"))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColH1, CType(rs.Fields("H1").Value & "", Integer).ToString("#"))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColH2, CType(rs.Fields("H2").Value & "", Integer).ToString("#"))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Colエラー内容, Trim(rs.Fields("エラー内容").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col定価, If(Trim(rs.Fields("定価").Value & "") = "0.0000", "", Trim(rs.Fields("定価").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColU区分, Trim(rs.Fields("U区分").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col原価, If(Trim(rs.Fields("仕入単価").Value & "") = "0.0000", "", Trim(rs.Fields("仕入単価").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col仕入率, If(Trim(rs.Fields("仕入率").Value & "") = "0.0000", "", Trim(rs.Fields("仕入率").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col売価, If(Trim(rs.Fields("売上単価").Value & "") = "0.0000", "", Trim(rs.Fields("売上単価").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col売上率, If(Trim(rs.Fields("売上率").Value & "") = "0.0000", "", Trim(rs.Fields("売上率").Value & "")))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, ColM区分, Trim(rs.Fields("M区分").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'NOTE SS .ActiveSheet.SetText(wLine, Col見積数量, If(Trim(rs.Fields("見積数量").Value & "") = "0.0000", "", Trim(rs.Fields("見積数量").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col単位, Trim(rs.Fields("単位名").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col金額, If(Trim(rs.Fields("売上金額").Value & "") = "0.0000", "", Trim(rs.Fields("売上金額").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col仕入金額, If(Trim(rs.Fields("仕入金額").Value & "") = "0.0000", "", Trim(rs.Fields("仕入金額").Value & "")))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col売上税区分, Trim(rs.Fields("売上税区分").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col消費税額, If(Trim(rs.Fields("消費税額").Value & "") = "0.0000", "", Trim(rs.Fields("消費税額").Value & "")))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col明細備考, Trim(rs.Fields("明細備考").Value & "")) '2018/05/03 ADD
				'            fpSpd.SetText Col入出庫日, wLine, Trim$(rs.Fields("入出庫日").Value & "") '2018/05/03 ADD
				If (rs.Fields("入庫日").Value).ToString = "" Then
					.ActiveSheet.SetText(wLine, Col入庫日, "")
				Else
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wLine, Col入庫日, CType(Trim(rs.Fields("入庫日").Value & ""), DateTime).ToString("yy/MM/dd")) '2018/05/03 ADD
				End If
				If (rs.Fields("出庫日").Value).ToString = "" Then
					.ActiveSheet.SetText(wLine, Col出庫日, "")
				Else
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wLine, Col出庫日, CType(Trim(rs.Fields("出庫日").Value & ""), DateTime).ToString("yy/MM/dd")) '2020/09/16 ADD
				End If

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col追番R, Trim(rs.Fields("追番R").Value & "")) '2019/12/12 ADD

				Select Case Trim(rs.Fields("見積区分").Value & "")
					Case "A", "C", "S"
						'2017/05/14 ADD↓
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入業者CD, "")
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入業者名, "")
						'2017/05/14 ADD↑
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入先CD, "")
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入先名, "")
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col送り先CD, "")
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col送り先名, "")
					Case Else
						'2017/05/14 ADD↓
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入業者CD, Trim(rs.Fields("仕入業者CD").Value & ""))
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入業者名, Trim(rs.Fields("仕入業者名").Value & ""))
						'2017/05/14 ADD↑
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入先CD, Trim(rs.Fields("仕入先CD").Value & ""))
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col仕入先名, Trim(rs.Fields("仕入先名").Value & ""))
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col送り先CD, Trim(rs.Fields("配送先CD").Value & ""))
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(wLine, Col送り先名, Trim(rs.Fields("配送先名").Value & ""))
				End Select
				'2016/06/22 ADD↓
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col作業区分CD, CType(Trim(rs.Fields("作業区分CD").Value & ""), Integer).ToString("#"))
				'        fpSpd.SetText Col作業区分名, wLine, Trim$(rs.Fields("作業区分名").Value & "")
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col作業区分名, ModKubuns.Get作業区分名(CType(Trim(rs.Fields("作業区分CD").Value & ""), Integer).ToString("#")))
				'2016/06/22 ADD↑


				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col社内在庫, If(Trim(rs.Fields("社内在庫数").Value & "") = "0.0000", "0", Trim(rs.Fields("社内在庫数").Value & "")))
				'        fpSpd.SetText Col社内在庫参照, wLine, If(Trim$(rs.Fields("社内在庫数").Value & "") = "0", "", Trim$(rs.Fields("社内在庫数").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col客先在庫, If(Trim(rs.Fields("客先在庫数").Value & "") = "0.0000", "", Trim(rs.Fields("客先在庫数").Value & "")))
				.ActiveSheet.SetValue(wLine, Col客先在庫, If(Trim(rs.Fields("客先在庫数").Value & "") = "0.0000", Nothing, Trim(rs.Fields("客先在庫数").Value & "")))
				'        fpSpd.SetText Col客先在庫参照, wLine, If(Trim$(rs.Fields("客先在庫数").Value & "") = "0", "", Trim$(rs.Fields("客先在庫数").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col転用, If(Trim(rs.Fields("転用数").Value & "") = "0.0000", "", Trim(rs.Fields("転用数").Value & "")))
				.ActiveSheet.SetValue(wLine, Col転用, If(Trim(rs.Fields("転用数").Value & "") = "0.0000", Nothing, Trim(rs.Fields("転用数").Value & "")))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col発注調整数, If(Trim(rs.Fields("発注調整数").Value & "") = "0.0000", "0", Trim(rs.Fields("発注調整数").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'NOTE SS .ActiveSheet.SetText(wLine, Col発注数, If(Trim(rs.Fields("発注数").Value & "") = "0", "", Trim(rs.Fields("発注数").Value & "")))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'NOTE SS .ActiveSheet.SetText(wLine, Col数量合計, If(Trim(rs.Fields("総数量").Value & "") = "0", "", Trim(rs.Fields("総数量").Value & "")))


				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col製品区分, Trim(rs.Fields("製品区分").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col見積明細連番, Trim(rs.Fields("見積明細連番").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col仕入済数, Trim(rs.Fields("仕入済数").Value & ""))

				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col仕入済CNT, Trim(rs.Fields("仕入済CNT").Value & "")) '2018/06/19 ADD
				...
				If Trim(rs.Fields("仕入済CNT").Value & "") <> "0" Then '2018/06/19 ADD
					...
					With FpSpd
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = True
						.ActiveSheet.Cells(wLine, Col展開, wLine, Col展開).Locked = True
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = True
						.ActiveSheet.Cells(wLine, ColSP区分, wLine, Col定価).Locked = True
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = True
						.ActiveSheet.Cells(wLine, Col原価, wLine, Col仕入率).Locked = True
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = True
						.ActiveSheet.Cells(wLine, Col仕入業者CD, wLine, Col送り先CD).Locked = True
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = False
						.ActiveSheet.Cells(wLine, Col明細備考, wLine, Col明細備考).Locked = True
				...
				End If
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				.ActiveSheet.SetText(wLine, Col売上済CNT, Trim(rs.Fields("売上済CNT").Value & ""))
				If Trim(rs.Fields("売上済CNT").Value & "") <> "0" Then
					...
					With FpSpd
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = True
						.ActiveSheet.Cells(wLine, Col展開, wLine, Col売上済CNT).Locked = True
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'.Lock = False
						.ActiveSheet.Cells(wLine, Col明細備考, wLine, Col明細備考).Locked = False

						'入庫日はロック解除 2024/03/27 ADD
						.ActiveSheet.Cells(wLine, Col入庫日, wLine, Col入庫日).Locked = False
				...
				For X = 1 To 30
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wLine, Col仕分数1 + X - 1, IIf(Trim(rs.Fields("仕分数" & X).Value & "") = "0.0000", "", Trim(rs.Fields("仕分数" & X).Value & ""))) '2017/06/27 ADD
				...
				'2017/07/03 ADD
				Call RowBackColorSet2(clsSPD.GetTextEX(ColU区分, CInt(wLine)), CInt(wLine))

				Call Lock_Seihin(wLine, clsSPD.GetTextEX(Col製品NO, CInt(wLine)), clsSPD.GetTextEX(Col仕様NO, CInt(wLine))) '2020/10/10 ADD
				'2020/10/10 DEL↓
				''            '2015/10/26 ADD↓
				''            '在庫管理する場合、名称をロックする。
				''            cSeihin.Initialize
				...
				If clsSPD.GetTextEX(Colエラー内容, CInt(wLine)) Like "原価率*" Then '2015/03/10 ADD
					'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Col = Col原価
					'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Row = wLine
					'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wLine, Col原価, wLine, Col原価)
					cRange.ForeColor = Color.Red
					'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Col = Col売価
					'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Row = wLine
					'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wLine, Col売価, wLine, Col売価)
					cRange.ForeColor = Color.Red
				Else
					'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Col = Col原価
				...
				'.BlockMode = True
				'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				cRange = .ActiveSheet.Cells(wLine, 0, wLine, .ActiveSheet.ColumnCount - 1)
				cRange.ForeColor = Getインボイス番号NGColor(Trim(rs.Fields("仕入先CD").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.BlockMode = False
				'2023/09/26 ADD↑
	...
	Public Function Get単価(ByRef Row As Integer, ByRef Col As Integer, Optional ByRef SetSpd As Boolean = True) As Decimal
		...
		With FpSpd
			...
			.SuspendLayout()
			'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			wTeika = .ActiveSheet.GetText(Row, Col定価) '定価
			If wTeika.ToString = "" Then
				check = False
			Else
				check = True
			End If
			If check Then
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				wRitu = .ActiveSheet.GetText(Row, Col) '％
				If wRitu.ToString = "" Then
					check = False
				Else
					check = True
				End If
				If check Then
					...
					If SetSpd = True Then '2008/01/23 ADD
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(Row, Col - 1, wTanka.ToString("#.##")) '2014/08/06 UPD
					End If
				Else
					wTanka = 0
				End If
	...
	Public Sub Get率(ByRef Row As Integer, ByRef Col As Integer)
		...
		With FpSpd
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			wTeika = .ActiveSheet.GetText(Row, Col定価) '定価
			If wTeika.ToString = "" OrElse wTeika.ToString = "0.00 " Then
				check = False
			Else
				check = True
			End If
			If check Then
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				wTanka = .ActiveSheet.GetText(Row, Col) '単価
				If wTanka.ToString = "" OrElse wTanka.ToString = "0.00 " Then
					check = False
				Else
					check = True
				End If
				If check Then
					...
					If wTeika <> "0" Then 'ZERO割抑制 2003/11/20  ADD
						...
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(Row, Col + 1, wRitu.ToString("#.##"))
					Else
						wRitu = 0
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						.ActiveSheet.SetText(Row, Col + 1, "")
					End If
	...
	Private Function Chk原価率(ByRef Row As Integer, Optional ByRef wGenka As Object = Nothing, Optional ByRef wBaika As Object = Nothing) As Boolean
		...
		With FpSpd
			...
			If IsNothing(wGenka) Then
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				getdata = .ActiveSheet.GetText(Row, Col原価) '仕入単価
				If getdata.ToString().Trim() = "" Then
					check = False
				Else
					check = True
			...
			If IsNothing(wBaika) Then
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				getdata = .ActiveSheet.GetText(Row, Col売価) '売上単価
				If getdata.ToString().Trim() = "" Then
					check = False
				Else
					check = True
		...
		If wRitu > gGenRituMax Then
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(Row, Colエラー内容, "原価率上限オーバー") '2008/02/20 ADD
		...
		If wRitu < gGenRituMin Then
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(Row, Colエラー内容, "原価率下限オーバー") '2008/02/20 ADD
			Chk原価率 = False
			Exit Function
		End If
	...
	Private Sub Get金額(ByRef Row As Integer)
		...
		With FpSpd
			...
			.SuspendLayout()
			'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			getdata = .ActiveSheet.GetText(Row, Col見積数量) '数量
			If getdata.ToString().Trim() = "" Then
				check = False
			Else
				check = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.SetText(Row, Col金額, wUriKin)
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.SetText(Row, Col仕入金額, wGenKin)
...
keisan_err:
	...
	Private Sub Get消費税(ByRef Row As Integer)
		...
		With FpSpd
			...
			.SuspendLayout()
			'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			getdata = .ActiveSheet.GetText(Row, Col売上税区分) '売上税区分
			If getdata.ToString().Trim() = "" Then
				check = False
			Else
				check = True
			...
			End If
			'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			getdata = .ActiveSheet.GetText(Row, Col金額) '売上金額
			If getdata.ToString().Trim() = "" Then
				check = False
			Else
				check = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.ActiveSheet.SetText(Row, Col消費税額, wZeiKin)
...
SetImportData_err: '---エラー時
	...
	Private Function Upload() As Boolean
		...
		With cmd.Parameters
			...
			.Item("@i見積日付").Value = CType(HD_見積日付, DateTime).ToString("yyyy/MM/dd")
			...
			'UPGRADE_WARNING: オブジェクト HD_納期S の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i納期S").Value = If(HD_納期S Is Nothing OrElse IsDBNull(HD_納期S), System.DBNull.Value, CType(HD_納期S, DateTime).ToString("yyyy/MM/dd"))
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i納期E").Value = If(HD_納期E Is Nothing OrElse IsDBNull(HD_納期E), System.DBNull.Value, CType(HD_納期E, DateTime).ToString("yyyy/MM/dd"))
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@iオープン日").Value = If(HD_OPEN日 Is Nothing OrElse IsDBNull(HD_OPEN日), System.DBNull.Value, CType(HD_OPEN日, DateTime).ToString("yyyy/MM/dd"))
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i受注日付").Value = If(HD_受注日付 Is Nothing OrElse IsDBNull(HD_受注日付), System.DBNull.Value, CType(HD_受注日付, DateTime).ToString("yyyy/MM/dd"))
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i合計金額").Value = SpcToNull(tx_合計金額.Text, 0)
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i原価合計").Value = SpcToNull(tx_原価合計.Text, 0)
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i原価率").Value = SpcToNull((rf_原価率.Text), 0)
			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i外税額").Value = SpcToNull(tx_外税額.Text, 0)
			.Item("@CompName").Value = GetPCName()

			'NOTE SS Label Object から取得できない為Textの右端を取得する
			rawText = rf_得意先別見積番号.ToString
			extractedText = rawText.Substring(rawText.LastIndexOf("Text: ") + 6)

			'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			.Item("@i得意先別見積番号").Value = SpcToNull((extractedText.ToString), 0) '2005/07/04 ADD
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i受付日付").Value = If(HD_受付日付 Is Nothing OrElse IsDBNull(HD_受付日付), System.DBNull.Value, CType(HD_受付日付, DateTime).ToString("yyyy/MM/dd"))
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i完工日付").Value = If(HD_完工日付 Is Nothing OrElse IsDBNull(HD_完工日付), System.DBNull.Value, CType(HD_完工日付, DateTime).ToString("yyyy/MM/dd"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i完了日付").Value = If(HD_完了日付 Is Nothing OrElse IsDBNull(HD_完了日付), System.DBNull.Value, CType(HD_完了日付, DateTime).ToString("yyyy/MM/dd"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			.Item("@i請求予定日").Value = If(HD_請求予定日 Is Nothing OrElse IsDBNull(HD_請求予定日), System.DBNull.Value, CType(HD_請求予定日, DateTime).ToString("yyyy/MM/dd"))
		...
		If rf_見積番号.Text = "" Then
			...
			pParentForm.rf_見積番号.Text = CStr(wNUMBER) '2017/04/07 ADD
			'2017/04/07 ADD↓
			'ロック情報生成
	...
	Private Function SiwakeUpload() As Boolean
		...
		If Not IsNothing(gSiwakeTBL) Then
			For i = 0 To UBound(gSiwakeTBL, 2)
				...
				sql += "(見積番号, 仕分番号, 名称, 略称, 納期, 時間, 他社部門CD) "
				sql += "VALUES "
				sql += "("
				sql += wNUMBER & ","
				sql += i + 1 & ","
				sql += "'" & SQLString(gSiwakeTBL(0, i)) & "',"
				sql += "'" & SQLString(gSiwakeTBL(1, i)) & "',"
				...
				'sql += If(gSiwakeTBL(2, i) = vbNullString, "Null", SQLDate(gSiwakeTBL(2, i), DBType)) & ","
				sql += If(gSiwakeTBL(2, i) Is Nothing, "Null", SQLDate(gSiwakeTBL(2, i), DBType)) & ","
				'UPGRADE_WARNING: オブジェクト gSiwakeTBL() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'sql += If(gSiwakeTBL(3, i) = vbNullString, "Null", "'" & SQLString(gSiwakeTBL(3, i)) & "'") & ","
				'sql += If(gSiwakeTBL(3, i) Is Nothing, "Null", "'" & SQLString(gSiwakeTBL(3, i)) & "'") & ","
				sql += If(gSiwakeTBL(3, i) Is Nothing, "Null", "'" & SQLString(CType(gSiwakeTBL(3, i), DateTime).ToString("HH:mm")) & "'") & ","
				sql += "'" & SQLString(gSiwakeTBL(4, i)) & "'"
				sql += ")"
				'2016/03/07 ADD↑
...
SiwakeUpload_err: '---エラー時
	...
	Private Function InsDataTmp() As Boolean
		...
		ReDim WkTBLS(clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1, FpSpd.ActiveSheet.ColumnCount)
		'スプレッド上のデータを配列に
		'UPGRADE_WARNING: オブジェクト fpSpd.GetArray の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'WkTBLS = FpSpd.ActiveSheet.GetArray(0, 0, FpSpd.ActiveSheet.NonEmptyRowCount, FpSpd.ActiveSheet.ColumnCount)
		WkTBLS = FpSpd.ActiveSheet.GetArray(0, 0, clsSPD.GetLastNonEmptyRowEx("MT02F00") + 1, FpSpd.ActiveSheet.ColumnCount)
		...
		If Trim(WkTBLS(0, ColW)) = "@" Or Trim(WkTBLS(0, ColD)) = "@" Or Trim(WkTBLS(0, ColH)) = "@" Or Trim(WkTBLS(0, ColD1)) = "@" Or Trim(WkTBLS(0, ColD2)) = "@" Or Trim(WkTBLS(0, ColH1)) = "@" Or Trim(WkTBLS(0, ColH2)) = "@" Then
		...
		For i = 0 To wMaxRow
			...
			rs.Fields("見積区分").Value = If(WkTBLS(i, Col見積区分) Is Nothing, "", WkTBLS(i, Col見積区分)) '2003/10/29 ADD

			'Select Case WkTBLS(i, Col見積区分).ToString '2010/06/16 ADD
			Select Case rs.Fields("見積区分").Value '2010/06/16 ADD
				Case "A", "C", "S" 'ｺﾒﾝﾄは除外する
					...
					If rs.Fields("見積区分").Value = "S" Then
					...
					Else
						...
						rs.Fields("漢字名称").Value = WkTBLS(i, Col名称).ToString
					End If
					rs.Fields("W").Value = 0
					rs.Fields("D").Value = 0
					rs.Fields("H").Value = 0
					...
					rs.Fields("U区分").Value = If(WkTBLS(i, ColU区分) Is Nothing, "", WkTBLS(i, ColU区分)) '2017/07/03 ADD
					rs.Fields("M区分").Value = ""
				...
				Case Else
					...
					'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'rs.Fields("展開CHK").Value = SpcToNull(WkTBLS(i, 0), 0).ToString
					If WkTBLS(i, 0) Is Nothing OrElse SpcToNull(WkTBLS(i, 0), 0).ToString = "False" Then
						rs.Fields("展開CHK").Value = 0
					Else
						rs.Fields("展開CHK").Value = 1
					End If
					...
					rs.Fields("SP区分").Value = If(WkTBLS(i, ColSP区分) Is Nothing, "", WkTBLS(i, ColSP区分))
					...
					rs.Fields("PC区分").Value = If(WkTBLS(i, ColPC区分) Is Nothing, "", WkTBLS(i, ColPC区分))
					...
					rs.Fields("製品NO").Value = If(WkTBLS(i, Col製品NO) Is Nothing, "", WkTBLS(i, Col製品NO))
					...
					rs.Fields("仕様NO").Value = If(WkTBLS(i, Col仕様NO) Is Nothing, "", WkTBLS(i, Col仕様NO))
					...
					rs.Fields("ベース色").Value = If(WkTBLS(i, Colベース色) Is Nothing, "", WkTBLS(i, Colベース色))
					'UPGRADE_WARNING: オブジェクト WkTBLS(i, Col名称) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("漢字名称").Value = If(WkTBLS(i, Col名称) Is Nothing, "", WkTBLS(i, Col名称))
					'UPGRADE_WARNING: オブジェクト WkTBLS() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					If InStr(If(WkTBLS(i, ColW) Is Nothing, "", WkTBLS(i, ColW)), "@") <> 0 Then
					...
					If InStr(If(WkTBLS(i, ColD) Is Nothing, "", WkTBLS(i, ColD)), "@") <> 0 Then
					...
					If InStr(If(WkTBLS(i, ColH) Is Nothing, "", WkTBLS(i, ColH)), "@") <> 0 Then
					...
					If InStr(If(WkTBLS(i, ColD1) Is Nothing, "", WkTBLS(i, ColD1)), "@") <> 0 Then
					...
					If InStr(If(WkTBLS(i, ColD2) Is Nothing, "", WkTBLS(i, ColD2)), "@") <> 0 Then
					...
					If InStr(If(WkTBLS(i, ColH1) Is Nothing, "", WkTBLS(i, ColH1)), "@") <> 0 Then
					...
					If InStr(If(WkTBLS(i, ColH2) Is Nothing, "", WkTBLS(i, ColH2)), "@") <> 0 Then
					...
					End If
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("エラー内容").Value = If(WkTBLS(i, Colエラー内容) Is Nothing, "", NullToZero(WkTBLS(i, Colエラー内容), DBNull.Value).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					...
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("U区分").Value = If(WkTBLS(i, ColU区分) Is Nothing, "", NullToZero(WkTBLS(i, ColU区分), DBNull.Value).ToString) '2005/10/14.ADD
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("M区分").Value = If(WkTBLS(i, ColM区分) Is Nothing, "", NullToZero(WkTBLS(i, ColM区分), DBNull.Value).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					...
					rs.Fields("単位名").Value = If(WkTBLS(i, Col単位) Is Nothing, "", WkTBLS(i, Col単位).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					...
					'2017/03/10 ADD↓
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("仕入業者CD").Value = If(WkTBLS(i, Col仕入業者CD) Is Nothing, "", NullToZero(WkTBLS(i, Col仕入業者CD).ToString, DBNull.Value).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("仕入業者名").Value = If(WkTBLS(i, Col仕入業者名) Is Nothing, "", NullToZero(WkTBLS(i, Col仕入業者名).ToString, DBNull.Value).ToString)
					'2017/03/10 ADD↑

					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("仕入先CD").Value = If(WkTBLS(i, Col仕入先CD) Is Nothing, "", NullToZero(WkTBLS(i, Col仕入先CD).ToString, DBNull.Value).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("仕入先名").Value = If(WkTBLS(i, Col仕入先名) Is Nothing, "", NullToZero(WkTBLS(i, Col仕入先名).ToString, DBNull.Value).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("配送先CD").Value = If(WkTBLS(i, Col送り先CD) Is Nothing, "", NullToZero(WkTBLS(i, Col送り先CD).ToString, DBNull.Value).ToString)
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("配送先名").Value = If(WkTBLS(i, Col送り先名) Is Nothing, "", NullToZero(WkTBLS(i, Col送り先名).ToString, DBNull.Value).ToString)
					...
					'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
					If SpcToNull(WkTBLS(i, Col製品区分)) Is Nothing Then
						'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
						rs.Fields("製品区分").Value = System.DBNull.Value
						'            rs![製品区分] = 0
					Else
						'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						rs.Fields("製品区分").Value = SpcToNull(WkTBLS(i, Col製品区分).ToString)
					End If

					For j = 1 To 30
						If WkTBLS(i, Col仕分数1 + j - 1) Is Nothing Then
							rs.Fields("仕分数" & CStr(j)).Value = 0
						ElseIf WkTBLS(i, Col仕分数1 + j - 1).ToString = "" Then
							rs.Fields("仕分数" & CStr(j)).Value = 0
						Else
							'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							rs.Fields("仕分数" & CStr(j)).Value = NullToZero(WkTBLS(i, Col仕分数1 + j - 1).ToString, 0)
						End If
					Next
					...
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("他社伝票番号").Value = If(WkTBLS(i, Col他社伝票番号) Is Nothing, "", NullToZero(WkTBLS(i, Col他社伝票番号), DBNull.Value).ToString) '2014/02/24 ADD
					If SpcToNull(WkTBLS(i, Col他社納品日付)) Is Nothing Then
						rs.Fields("他社納品日付").Value = DBNull.Value
					Else
						'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						rs.Fields("他社納品日付").Value = NullToZero(WkTBLS(i, Col他社納品日付), DBNull.Value) '2015/09/29 ADD
					End If
					...
					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("明細備考").Value = If(WkTBLS(i, Col明細備考) Is Nothing, "", NullToZero(WkTBLS(i, Col明細備考), DBNull.Value).ToString) '2018/05/03 ADD
					If SpcToNull(WkTBLS(i, Col入庫日)) Is Nothing Then
						rs.Fields("入庫日").Value = DBNull.Value '2018/05/03 ADD
					Else
						'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						rs.Fields("入庫日").Value = NullToZero(WkTBLS(i, Col入庫日), DBNull.Value) '2018/05/03 ADD
					End If
					If SpcToNull(WkTBLS(i, Col出庫日)) Is Nothing Then
						rs.Fields("出庫日").Value = DBNull.Value '2020/09/16 ADD
					Else
						'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						rs.Fields("出庫日").Value = NullToZero(WkTBLS(i, Col出庫日), DBNull.Value) '2020/09/16 ADD
					End If

					'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					rs.Fields("追番R").Value = If(WkTBLS(i, Col追番R) Is Nothing, "", NullToZero(WkTBLS(i, Col追番R), DBNull.Value).ToString) '2019/12/12 ADD
	...
	Private Function InsDataTmpCheck() As Boolean
		...
		For i = 1 To UBound(TempData)
			...
			rs.Fields("売上単価").Value = 0
			rs.Fields("売上率").Value = 0
			rs.Fields("U区分").Value = "" '2005/10/14.ADD
			rs.Fields("M区分").Value = ""
			rs.Fields("見積数量").Value = 0
			'UPGRADE_WARNING: オブジェクト TempData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			rs.Fields("単位名").Value = TempData(i, 19).ToString
			rs.Fields("売上金額").Value = 0
			rs.Fields("仕入金額").Value = 0
			rs.Fields("売上税区分").Value = 0
			rs.Fields("消費税額").Value = 0
...
InsDataTmpCheck_err: '---エラー時
	...
	Private Function Download(ByRef MituNo As Integer) As Integer
		'Dim fpSpd As Object
		Dim rs As ADODB.Recordset
		Dim sql As String
		...
		sql += "ISNULL(UM.売上済CNT,0) AS 売上済CNT"
		'    sql = sql & "  ,在庫区分 = ISNULL(SE.在庫区分,1)" '2015/10/26 ADD
		sql += "  ,サイズ変更区分 = ISNULL(SE.サイズ変更区分,1)" '2015/10/26 ADD
		sql += "        FROM    TD見積シートM AS MM"
		sql += "        LEFT JOIN   ("
		sql += "                     SELECT 見積明細連番, 仕入済数 = SUM(仕入数量),仕入済CNT = COUNT(見積明細連番)"
		sql += "                        FROM TD仕入明細内訳"
		sql += "                        GROUP BY 見積明細連番"
		sql += "                     )AS HCM"
		sql += "                     ON MM.見積明細連番 = HCM.見積明細連番"
		sql += "        LEFT JOIN   ("
		sql += "                     SELECT 見積明細連番, 売上済CNT = COUNT(見積明細連番)"
		sql += "                        FROM TD売上明細V2"
		sql += "                        GROUP BY 見積明細連番"
		sql += "                     )AS UM"
		sql += "                     ON MM.見積明細連番 = UM.見積明細連番"
		'2015/10/26↓
		sql += "        LEFT JOIN   ("
		'sql +=  "                     SELECT 製品NO,仕様NO,在庫区分"
		sql += "                     SELECT 製品NO,仕様NO,在庫区分,サイズ変更区分" '2020/10/10 ADd
		sql += "                        FROM TM製品"
		sql += "                     )AS SE"
		sql += "                     ON MM.製品NO = SE.製品NO"
		sql += "                     AND MM.仕様NO = SE.仕様NO"
		'2015/10/26↑
		sql += "    WHERE MM.見積番号 = " & MituNo
		sql += "    ORDER BY 行番号"
			...
			With rs
				If Not .EOF Then
					...
					Do Until .EOF
						...
						wMeisai(CInt(.Fields("行番号").Value) - 1, CInt(.Fields("仕分番号").Value) - 1) = If(.Fields("数量").Value = 0, "", .Fields("数量").Value)
						.MoveNext()
					Loop
					...
					Call FpSpd.ActiveSheet.SetArray(0, Col仕分数1, wMeisai)
					'UPGRADE_WARNING: オブジェクト fpSpd.AutoCalc の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.AutoCalculation = True
				End If
			End With
				...
				Do Until .EOF
					With FpSpd
						If rs.Fields("略称").Value = vbNullString Then
							...
							'UPGRADE_WARNING: オブジェクト fpSpd.Text の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Text = i - Col仕分数1 + 1
							'.ActiveSheet.SetText(0, i, i - Col仕分数1 + 1)
							.Sheets(0).ColumnHeader.Columns(i).Label = i - Col仕分数1 + 1
						Else
							'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							'.Row = 0
							'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							...
							'.ActiveSheet.SetText(0, i, rs.Fields("略称").Value)
							.Sheets(0).ColumnHeader.Columns(i).Label = rs.Fields("略称").Value
						End If
					End With
					i += 1
					.MoveNext()
...
Download_Err:
	...
	'2015/09/29 ADD↓
	Private Sub SetupItems(ByRef rs As ADODB.Recordset, ByRef wMaxRow As Integer)
		'Dim fpSpd As Object
		Dim cRange As FarPoint.Win.Spread.Cell
		...
		Do Until rs.EOF
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col見積区分, Trim(rs.Fields("見積区分").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Colクレーム区分, CType(Trim(rs.Fields("クレーム明細区分").Value & ""), Integer).ToString("#")) '2016/06/22 ADD

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col他社伝票番号, Trim(rs.Fields("他社伝票番号").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col他社納品日付, Trim(rs.Fields("他社納品日付").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColSP区分, Trim(rs.Fields("SP区分").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColPC区分, Trim(rs.Fields("PC区分").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col製品NO, Trim(rs.Fields("製品NO").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col仕様NO, Trim(rs.Fields("仕様NO").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Colベース色, Trim(rs.Fields("ベース色").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col名称, Trim(rs.Fields("漢字名称").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColW, CType(rs.Fields("W").Value & "", Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColD, CType(rs.Fields("D").Value & "", Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColH, CType(rs.Fields("H").Value & "", Integer).ToString("#"))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColD1, CType(rs.Fields("D1").Value & "", Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColD2, CType(rs.Fields("D2").Value & "", Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColH1, CType(rs.Fields("H1").Value & "", Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColH2, CType(rs.Fields("H2").Value & "", Integer).ToString("#"))
			'2015/10/26 ADD↓
			With FpSpd
				'在庫管理する場合、名称をロックする。
				...
				If rs.Fields("サイズ変更区分").Value = 0 Then '2020/10/10 ADD
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, ColW, i, ColH2).Locked = True
				...
				Else
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = False
					.ActiveSheet.Cells(i, ColW, i, ColH2).Locked = False
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
				End If
			End With
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Colエラー内容, Trim(rs.Fields("エラー内容").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col定価, If(Trim(rs.Fields("定価").Value & "") = "0.0000", "", Trim(rs.Fields("定価").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColU区分, Trim(rs.Fields("U区分").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col原価, If(Trim(rs.Fields("仕入単価").Value & "") = "0.0000", "", Trim(rs.Fields("仕入単価").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col仕入率, If(Trim(rs.Fields("仕入率").Value & "") = "0.0000", "", Trim(rs.Fields("仕入率").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col売価, If(Trim(rs.Fields("売上単価").Value & "") = "0.0000", "", Trim(rs.Fields("売上単価").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col売上率, If(Trim(rs.Fields("売上率").Value & "") = "0.0000", "", Trim(rs.Fields("売上率").Value & "")))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, ColM区分, Trim(rs.Fields("M区分").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'NOTE SS fpSpd.ActiveSheet.SetText(i, Col見積数量, If(Trim(rs.Fields("見積数量").Value & "") = "0.0000", "", Trim(rs.Fields("見積数量").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col単位, Trim(rs.Fields("単位名").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col金額, If(Trim(rs.Fields("売上金額").Value & "") = "0.0000", "", Trim(rs.Fields("売上金額").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col仕入金額, If(Trim(rs.Fields("仕入金額").Value & "") = "0.0000", "", Trim(rs.Fields("仕入金額").Value & "")))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col売上税区分, Trim(rs.Fields("売上税区分").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col消費税額, If(Trim(rs.Fields("消費税額").Value & "") = "0.0000", "", Trim(rs.Fields("消費税額").Value & "")))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col明細備考, Trim(rs.Fields("明細備考").Value & "")) '2018/05/03 ADD
			'        fpSpd.SetText Col入出庫日, i, Trim$(rs.Fields("入出庫日").Value & "") '2018/05/03 ADD
			If (rs.Fields("入庫日").Value).ToString = "" Then
				FpSpd.ActiveSheet.SetText(i, Col入庫日, "")
			Else
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				FpSpd.ActiveSheet.SetText(i, Col入庫日, CType(rs.Fields("入庫日").Value, DateTime).ToString("yy/MM/dd")) '2018/05/03 ADD
			End If
			If (rs.Fields("出庫日").Value).ToString = "" Then
				FpSpd.ActiveSheet.SetText(i, Col出庫日, "")
			Else
				'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'fpSpd.ActiveSheet.SetText(i, Col出庫日, VB6.Format(Trim(rs.Fields("出庫日").Value & ""), "yy/MM/dd")) '2020/09/16 ADD
				FpSpd.ActiveSheet.SetText(i, Col出庫日, CType(rs.Fields("出庫日").Value, DateTime).ToString("yy/MM/dd")) '2020/09/16 ADD
				'fpSpd.ActiveSheet.SetText(i, Col出庫日, DateTime.Parse(Trim(rs.Fields("出庫日").Value & "")).ToString("yy/MM/dd")) '2020/09/16 ADD
			End If

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col追番R, Trim(rs.Fields("追番R").Value & "")) '2019/12/12 ADD

			Select Case Trim(rs.Fields("見積区分").Value & "")
				Case "A", "C", "S"
					'2017/03/10 ADD↓
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入業者CD, "")
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入業者名, "")
					'2017/03/10 ADD↑
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入先CD, "")
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入先名, "")
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col送り先CD, "")
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col送り先名, "")
				Case Else
					'2017/03/10 ADD↓
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入業者CD, Trim(rs.Fields("仕入業者CD").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入業者名, Trim(rs.Fields("仕入業者名").Value & ""))
					'2017/03/10 ADD↑
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入先CD, Trim(rs.Fields("仕入先CD").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col仕入先名, Trim(rs.Fields("仕入先名").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col送り先CD, Trim(rs.Fields("配送先CD").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(i, Col送り先名, Trim(rs.Fields("配送先名").Value & ""))
			End Select
			'2016/06/22 ADD↓
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col作業区分CD, CType(Trim(rs.Fields("作業区分CD").Value & ""), Integer).ToString("#"))
			'        fpSpd.SetText Col作業区分名, i, Trim$(rs.Fields("作業区分名").Value & "")
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col作業区分名, ModKubuns.Get作業区分名(CType(Trim(rs.Fields("作業区分CD").Value & ""), Integer).ToString("#")))
			'2016/06/22 ADD↑


			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col社内在庫, If(Trim(rs.Fields("社内在庫数").Value & "") = "0.0000", "0", Trim(rs.Fields("社内在庫数").Value & "")))
			'        fpSpd.SetText Col社内在庫参照, i, If(Trim$(rs.Fields("社内在庫数").Value & "") = "0", "", Trim$(rs.Fields("社内在庫数").Value & ""))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col客先在庫, If(Trim(rs.Fields("客先在庫数").Value & "") = "0.0000", "", Trim(rs.Fields("客先在庫数").Value & "")))
			FpSpd.ActiveSheet.SetValue(i, Col客先在庫, If(Trim(rs.Fields("客先在庫数").Value & "") = "0.0000", Nothing, Trim(rs.Fields("客先在庫数").Value & "")))
			'        fpSpd.SetText Col客先在庫参照, i, If(Trim$(rs.Fields("客先在庫数").Value & "") = "0", "", Trim$(rs.Fields("客先在庫数").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col転用, If(Trim(rs.Fields("転用数").Value & "") = "0.0000", "", Trim(rs.Fields("転用数").Value & "")))
			FpSpd.ActiveSheet.SetValue(i, Col転用, If(Trim(rs.Fields("転用数").Value & "") = "0.0000", Nothing, Trim(rs.Fields("転用数").Value & "")))

			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col発注調整数, If(Trim(rs.Fields("発注調整数").Value & "") = "0.0000", "0", Trim(rs.Fields("発注調整数").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'NOTE SS fpSpd.ActiveSheet.SetText(i, Col発注数, If(Trim(rs.Fields("発注数").Value & "") = "0", "", Trim(rs.Fields("発注数").Value & "")))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'NOTE SS fpSpd.ActiveSheet.SetText(i, Col数量合計, If(Trim(rs.Fields("総数量").Value & "") = "0", "", Trim(rs.Fields("総数量").Value & "")))


			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col製品区分, Trim(rs.Fields("製品区分").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col見積明細連番, Trim(rs.Fields("見積明細連番").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col仕入済数, Trim(rs.Fields("仕入済数").Value & ""))
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col仕入済CNT, Trim(rs.Fields("仕入済CNT").Value & "")) '2018/06/19 ADD
			...
			If Trim(rs.Fields("仕入済CNT").Value & "") <> "0" Then '2018/06/19 ADD
				...
				With FpSpd
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, Col展開, i, Col展開).Locked = True
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, ColSP区分, i, Col定価).Locked = True
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, Col原価, i, Col仕入率).Locked = True
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, Col仕入業者CD, i, Col送り先CD).Locked = True
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, Col入庫日, i, Col入庫日).Locked = True
					'2018/05/30 ADD↑
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, Col出庫日, i, Col出庫日).Locked = True
					'2020/09/16 ADD↑
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = False
					.ActiveSheet.Cells(i, Col明細備考, i, Col明細備考).Locked = False
			...
			End If
			'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			FpSpd.ActiveSheet.SetText(i, Col売上済CNT, Trim(rs.Fields("売上済CNT").Value & ""))
			If Trim(rs.Fields("売上済CNT").Value & "") <> "0" Then
				'仕入発生してたらロックして変更不可にする
				With FpSpd
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.Lock の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.Lock = True
					.ActiveSheet.Cells(i, Col展開, i, Col売上済CNT).Locked = True
			...
			'        End If
			'2017/07/03 ADD
			Call RowBackColorSet2(clsSPD.GetTextEX(ColU区分, CInt(i)), CInt(i))
			...
			With FpSpd
				...
				'.BlockMode = True
				'UPGRADE_WARNING: オブジェクト fpSpd.ForeColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				cRange = .ActiveSheet.Cells(i, 0, i, .ActiveSheet.ColumnCount - 1)
				cRange.ForeColor = Getインボイス番号NGColor(Trim(rs.Fields("仕入先CD").Value & ""))
				'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'.BlockMode = False
			End With
		...
		'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'fpSpd.Action = FPSpreadADO.ActionConstants.ActionActiveCell
		FpSpd.ActiveSheet.SetActiveCell(0, Col展開)
		...
		Else
			With FpSpd
				...
				For i = LBound(SelData, 1) To UBound(SelData, 1)
					'UPGRADE_WARNING: オブジェクト fpSpd.MaxRows の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					If wRow + i > .ActiveSheet.RowCount Then
						Exit For
					End If

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColPC区分, SelData(i, 0))
					If SelData(i, 0) Is Nothing Then
						SelData(i, 0) = ""
					End If
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetValue(wRow + i, Col製品NO, SelData(i, 1))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col仕様NO, SelData(i, 2))
					If SelData(i, 2) Is Nothing Then
						SelData(i, 2) = ""
					End If
					'UPGRADE_WARNING: オブジェクト SelData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Private Function DspKokData(ByRef wRow As Integer) As Boolean
		...
		Else
			With FpSpd
				...
				For i = LBound(SelData, 1) To UBound(SelData, 1)
					'UPGRADE_WARNING: オブジェクト fpSpd.MaxRows の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					If wRow + i > FpSpd.ActiveSheet.RowCount Then
						Exit For
					End If
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColPC区分, SelData(i, 0)) 'PC区分
					If SelData(i, 0) Is Nothing Then
						SelData(i, 0) = ""
					End If
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col製品NO, SelData(i, 1)) '製品NO
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col仕様NO, SelData(i, 2)) '仕様NO
					If SelData(i, 2) Is Nothing Then
						SelData(i, 2) = ""
					End If
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Colベース色, SelData(i, 3)) 'ベース色
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col名称, SelData(i, 4)) '名称
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColW, SelData(i, 5)) 'W
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColD, SelData(i, 6)) 'D
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColH, SelData(i, 7)) 'H
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColD1, SelData(i, 8)) 'D1
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColD2, SelData(i, 9)) 'D2
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColH1, SelData(i, 10)) 'H1
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, ColH2, SelData(i, 11)) 'H2
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col単位, SelData(i, 12)) '単位
					'2017/03/10 ADD↓
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col仕入業者CD, SelData(i, 13)) '仕入先
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col仕入業者名, Get仕入先略称(SelData(i, 13)))
					'2017/03/10 ADD↑
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col仕入先CD, SelData(i, 13)) '仕入先
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(wRow + i, Col仕入先名, Get仕入先略称(SelData(i, 13)))
					'各マスタより項目セット
					'UPGRADE_WARNING: オブジェクト SelData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Public Sub DspGenka(ByRef Ritu As Decimal)
		...
		With FpSpd
			...
			For i = 0 To clsSPD.GetLastNonEmptyRowEx("MT02F00")
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				getdata = .ActiveSheet.GetText(i, Col定価) '定価
				If getdata.ToString().Trim() = "" Then
					check = False
				Else
					check = True
				...
				If check Then
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(i, Col原価, wGenka)
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(i, Col仕入率, (Ritu).ToString("#.##"))
				Else
					wBaika = 0
				End If
		...
		With FpSpd
			...
			For i = 0 To clsSPD.GetLastNonEmptyRowEx("MT02F00")
				...
				If check Then
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(i, Col売価, wBaika)
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					.ActiveSheet.SetText(i, Col売上率, (Ritu).ToString("#.##"))
				Else
					wBaika = 0
				End If
	...
	Public Sub Calc合計()
		...
		Dim wUZeiKBN As Integer '売上税区分
		Dim KAZEITotal As Decimal '課税対象額(TAX計算用)

		Dim wMituKbn As String '2010/01/05 ADD
		...
		With FpSpd
			...
			For i = 0 To .ActiveSheet.RowCount - 1
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				getdata = .ActiveSheet.GetText(i, Col見積数量) '見積数量
				If getdata.ToString().Trim() = "" Then
					check = False
				Else
					check = True
				...
				'2010/01/05 ADD↓
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				getdata = .ActiveSheet.GetText(i, Col見積区分) '見積区分
				If getdata.ToString().Trim() = "" Then
					check = False
				Else
					check = True
				...
				Select Case wMituKbn '2010/01/06 ADD
					...
					Case Else
						'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						getdata = .ActiveSheet.GetText(i, Col金額) '売上金額
						If getdata.ToString().Trim() = "" Then
							check = False
						Else
							check = True
						...
						End If
						'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						getdata = .ActiveSheet.GetText(i, Col仕入金額) '仕入金額
						If getdata.ToString().Trim() = "" Then
							check = False
						Else
							check = True
						...
						If check Then
							'UPGRADE_WARNING: オブジェクト getdata の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							wGenKin = CDec(getdata)
						Else
							wGenKin = 0
						End If
						'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						getdata = .ActiveSheet.GetText(i, Col売上税区分) '売上税区分
						If getdata.ToString().Trim() = "" Then
							check = False
						Else
							check = True
		...
		If wUriKei <> 0 Then
			rf_原価率.Text = ((wGenKei / wUriKei) * 100).ToString("0.00")
		Else
			rf_原価率.Text = (0).ToString("0.00")
		End If

		rf_原価合計.Text = (wGenKei).ToString("#,##0") & KIN_FMT '2018/11/01 ADD
		'    rf_合計金額.Caption = Format$(wUriKei, "#,##0") & " (円)"
		rf_合計金額.Text = (wUriKei).ToString("#,##0") & KIN_FMT '2014/07/10 ADD
		...
		'2015/08/28 ADD
		[rf_税込金額].Text = (CDec(rf_合計金額.Text) + CDec(HD_出精値引) + CDec(tx_外税額.Text)).ToString("#,##0") & KIN_FMT
...
Calc合計_err: '---エラー時
	...
	Private Function SiwakeDL(ByRef MituNo As Integer) As Integer
		Dim rs As ADODB.Recordset
		Dim sql As String
		Dim wMeisai As Object
		Dim wLine As Integer
...
Download_Err:
	...
	Private Function Get仕入先略称(ByRef ID As Object) As String
		...
		With rs
			...
			Else
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Get仕入先略称 = NullToZero(.Fields("略称").Value, vbNullString)
			End If
		End With
		ReleaseRs(rs)
...
Get仕入先略称_Err:
	...
	Private Function Get配送先略称(ByRef ID As Object) As String
		...
		With rs
			...
			Else
				'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Get配送先略称 = NullToZero(.Fields("略称").Value, vbNullString)
			End If
		End With
		ReleaseRs(rs)
...
Get配送先略称_Err:
	...
	Private Function SpdRowDisp() As Object
		...
		With FpSpd
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = ColSP区分
			col = .ActiveSheet.Columns(ColSP区分)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = ColPC区分
			col = .ActiveSheet.Columns(ColPC区分)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col売上率
			col = .ActiveSheet.Columns(Col売上率)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = ColM区分
			col = .ActiveSheet.Columns(ColM区分)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col見積数量
			col = .ActiveSheet.Columns(Col見積数量)
			...
			col = .ActiveSheet.Columns(Col社内在庫, Col社内在庫参照)
			'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.BlockMode = True
			...
			col = .ActiveSheet.Columns(Col客先在庫, Col客先在庫参照)
			'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.BlockMode = True
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col発注数
			col = .ActiveSheet.Columns(Col発注数)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col他社伝票番号
			col = .ActiveSheet.Columns(Col他社伝票番号)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col他社納品日付
			col = .ActiveSheet.Columns(Col他社納品日付)
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'.Col = Col明細備考
			col = .ActiveSheet.Columns(Col明細備考)
	...
	Public Sub DspGetData(ByRef rs As ADODB.Recordset, ByRef DspRow As Integer)
		...
		With FpSpd
			...
			Do Until rs.EOF
				'2017/10/05 ADD↓
				If clsSPD.GetTextEX(Col見積区分, wLine) = "" And clsSPD.GetTextEX(Col製品NO, wLine) = "" And clsSPD.GetTextEX(Col仕様NO, wLine) = "" And clsSPD.GetTextEX(Col名称, wLine) = "" Then
					'見積区分・製品NO・仕様NO・名称が空白の場合、行に書き込む
					'空白以外は1行下げて確認する。
					'2017/10/05 ADD↑

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col見積区分, Trim(rs.Fields("見積区分").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Colクレーム区分, CType(Trim(rs.Fields("クレーム明細区分").Value & ""), Integer).ToString("#")) '2016/06/22 ADD

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col他社伝票番号, Trim(rs.Fields("他社伝票番号").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col他社納品日付, Trim(rs.Fields("他社納品日付").Value & ""))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColSP区分, Trim(rs.Fields("SP区分").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColPC区分, Trim(rs.Fields("PC区分").Value & ""))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col製品NO, Trim(rs.Fields("製品NO").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col仕様NO, Trim(rs.Fields("仕様NO").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Colベース色, Trim(rs.Fields("ベース色").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col名称, Trim(rs.Fields("漢字名称").Value & ""))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColW, CType(rs.Fields("W").Value & "", Integer).ToString("#"))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColD, CType(rs.Fields("D").Value & "", Integer).ToString("#"))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColH, CType(rs.Fields("H").Value & "", Integer).ToString("#"))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColD1, CType(rs.Fields("D1").Value & "", Integer).ToString("#"))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColD2, CType(rs.Fields("D2").Value & "", Integer).ToString("#"))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColH1, CType(rs.Fields("H1").Value & "", Integer).ToString("#"))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColH2, CType(rs.Fields("H2").Value & "", Integer).ToString("#"))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col明細備考, Trim(rs.Fields("明細備考").Value & "")) '2018/05/03 ADD

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Colエラー内容, Trim(rs.Fields("エラー内容").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col定価, If(Trim(rs.Fields("定価").Value & "") = "0.0000", "", Trim(rs.Fields("定価").Value & "")))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColU区分, Trim(rs.Fields("U区分").Value & ""))
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, ColM区分, Trim(rs.Fields("M区分").Value & ""))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'NOTE SS FpSpd.ActiveSheet.SetText(wLine, Col見積数量, If(Trim(rs.Fields("見積数量").Value & "") = "0.0000", "", Trim(rs.Fields("見積数量").Value & "")))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col単位, Trim(rs.Fields("単位名").Value & ""))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col金額, If(Trim(rs.Fields("売上金額").Value & "") = "0.0000", "", Trim(rs.Fields("売上金額").Value & "")))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col仕入金額, If(Trim(rs.Fields("仕入金額").Value & "") = "0.0000", "", Trim(rs.Fields("仕入金額").Value & "")))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col売上税区分, Trim(rs.Fields("売上税区分").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col消費税額, If(Trim(rs.Fields("消費税額").Value & "") = "0.0000", "", Trim(rs.Fields("消費税額").Value & "")))

					Select Case Trim(rs.Fields("見積区分").Value & "")
						Case "A", "C", "S"
							'2017/05/14 ADD↓
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入業者CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入業者名, "")
							'2017/05/14 ADD↑
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入先CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入先名, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col送り先CD, "")
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col送り先名, "")
						Case Else
							'2017/05/14 ADD↓
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入業者CD, Trim(rs.Fields("仕入業者CD").Value & ""))
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入業者名, Trim(rs.Fields("仕入業者名").Value & ""))
							'2017/05/14 ADD↑
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入先CD, Trim(rs.Fields("仕入先CD").Value & ""))
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col仕入先名, Trim(rs.Fields("仕入先名").Value & ""))
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col送り先CD, Trim(rs.Fields("配送先CD").Value & ""))
							'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
							FpSpd.ActiveSheet.SetText(wLine, Col送り先名, Trim(rs.Fields("配送先名").Value & ""))
					End Select
					'2016/06/22 ADD↓
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col作業区分CD, CType(Trim(rs.Fields("作業区分CD").Value & ""), Integer).ToString("#"))
					'        fpSpd.SetText Col作業区分名, wLine, Trim$(rs.Fields("作業区分名").Value & "")
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col作業区分名, ModKubuns.Get作業区分名(CType(Trim(rs.Fields("作業区分CD").Value & ""), Integer).ToString("#")))
					'2016/06/22 ADD↑


					'            fpSpd.SetText Col社内在庫, wLine, If(Trim$(rs.Fields("社内在庫数").Value & "") = "0", "", Trim$(rs.Fields("社内在庫数").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col社内在庫, "0")
					'        fpSpd.SetText Col社内在庫参照, wLine, If(Trim$(rs.Fields("社内在庫数").Value & "") = "0", "", Trim$(rs.Fields("社内在庫数").Value & ""))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col客先在庫, If(Trim(rs.Fields("客先在庫数").Value & "") = "0.0000", "", Trim(rs.Fields("客先在庫数").Value & "")))
					FpSpd.ActiveSheet.SetValue(wLine, Col客先在庫, If(Trim(rs.Fields("客先在庫数").Value & "") = "0.0000", Nothing, Trim(rs.Fields("客先在庫数").Value & "")))
					'        fpSpd.SetText Col客先在庫参照, wLine, If(Trim$(rs.Fields("客先在庫数").Value & "") = "0", "", Trim$(rs.Fields("客先在庫数").Value & ""))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col転用, If(Trim(rs.Fields("転用数").Value & "") = "0.0000", "", Trim(rs.Fields("転用数").Value & "")))
					FpSpd.ActiveSheet.SetValue(wLine, Col転用, If(Trim(rs.Fields("転用数").Value & "") = "0.0000", Nothing, Trim(rs.Fields("転用数").Value & "")))

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col発注調整数, If(Trim(rs.Fields("発注調整数").Value & "") = "0.0000", "0", Trim(rs.Fields("発注調整数").Value & "")))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'NOTE SS FpSpd.ActiveSheet.SetText(wLine, Col発注数, If(Trim(rs.Fields("発注数").Value & "") = "0", "", Trim(rs.Fields("発注数").Value & "")))
					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'NOTE SS FpSpd.ActiveSheet.SetText(wLine, Col数量合計, If(Trim(rs.Fields("総数量").Value & "") = "0", "", Trim(rs.Fields("総数量").Value & "")))


					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col製品区分, Trim(rs.Fields("製品区分").Value & ""))

					If (rs.Fields("入庫日").Value).ToString = "" Then
						FpSpd.ActiveSheet.SetText(wLine, Col入庫日, "")
					Else
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						FpSpd.ActiveSheet.SetText(wLine, Col入庫日, CType(Trim(rs.Fields("入庫日").Value & ""), DateTime).ToString("yy/MM/dd")) '2018/08/06 ADD
					End If

					If (rs.Fields("出庫日").Value).ToString = "" Then
						FpSpd.ActiveSheet.SetText(wLine, Col出庫日, "")
					Else
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						FpSpd.ActiveSheet.SetText(wLine, Col出庫日, CType(Trim(rs.Fields("出庫日").Value & ""), DateTime).ToString("yy/MM/dd")) '2020/09/16 ADD
					End If

					'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					FpSpd.ActiveSheet.SetText(wLine, Col追番R, Trim(rs.Fields("追番R").Value & "")) '2019/12/12 ADD
					...
					For X = 1 To 30
						...
						'                fpSpd.SetText Col仕分数1 + X - 1, wLine, Format$(Trim$(rs.Fields("仕分数" & X).Value & ""), "#")
						'UPGRADE_WARNING: オブジェクト fpSpd.SetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						FpSpd.ActiveSheet.SetText(wLine, Col仕分数1 + X - 1, If(Trim(rs.Fields("仕分数" & X).Value & "") = "0.0000", "", Trim(rs.Fields("仕分数" & X).Value & ""))) '2017/06/27 ADD
					Next
		...
		'UPGRADE_WARNING: オブジェクト fpSpd.Col の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'fpSpd.Col = fpSpd.ActiveSheet.ActiveColumnIndex '2003/11/25 ADD
		'UPGRADE_WARNING: オブジェクト fpSpd.Row の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'fpSpd.Row = fpSpd.ActiveSheet.ActiveRowIndex
		'    fpSpd.Col = 1
		...
		'Dim check As Boolean
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Select Case FpSpd.ActiveSheet.ActiveColumnIndex
			Case ColPC区分
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldPc = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, ColPC区分)
			Case Col製品NO
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldPc = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, ColPC区分)
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldSei = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, Col製品NO)
			Case Col仕様NO
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldPc = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, ColPC区分)
				...
				'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				HoldSiy = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, Col仕様NO)
				'        Case 6, 7
				'             'IMEモード[使用不可]
				'            ImmAssociateContext Me.hwnd, 0&
				'        Case 14 To 18
		...
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト fpSpd.GetText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		HoldCD = FpSpd.ActiveSheet.GetText(FpSpd.ActiveSheet.ActiveRowIndex, FpSpd.ActiveSheet.ActiveColumnIndex)
		...
		With FpSpd
			Select Case Mode
				Case 0
					...
					'.Row2 = wRow
					'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(&HFFFFFF)
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
				Case 1
					'行の背景色を黄色にする
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(&H80FFFF)
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
			End Select
		End With
		...
		With FpSpd
			Select Case Mode
				Case ""
					...
					'.Row = wRow
					'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount - 1)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(&HFFFFFF)
					'                .BlockMode = False
				Case "U"
					'行の背景色を黄色にする
				...
				Case "R"
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount - 1)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(242, 220, 219))
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
				Case "H"
					'行の背景色を灰色にする
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount - 1)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(217, 217, 217))
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
				Case "B"
					'行の背景色を青色にする
					...
					'UPGRADE_WARNING: オブジェクト fpSpd.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount - 1)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(220, 230, 241))
					'UPGRADE_WARNING: オブジェクト fpSpd.BlockMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'.BlockMode = False
				...
				Case "Z"
					'行の背景色を青色にする
					cRange = .ActiveSheet.Cells(wRow, 0, wRow, .ActiveSheet.ColumnCount - 1)
					cRange.BackColor = System.Drawing.ColorTranslator.FromOle(RGB(204, 255, 204))
					'2024/07/16 ADD↑
			End Select
		End With
	End Sub
	...
	Private Sub Cb検索_Click(sender As Object, e As EventArgs) Handles Cb検索.Click
		'Dim fpSpd As Object
		Dim ret As Integer
		...
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveCol の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト fpSpd.ActiveRow の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'ret = clsSPD.Search(fpSpd.ActiveSheet.ActiveRowIndex, fpSpd.ActiveSheet.ActiveColumnIndex, [tx_製品NO].Text) '2014/11/13 ADD
		ret = clsSPD.SearchCol(Col製品NO, 0, FpSpd.ActiveSheet.RowCount - 1, [tx_製品NO].Text) '2014/11/13 ADD
		'2013/02/12 ADD↑
		If ret = -1 Then
		...
		Else
			...
			'UPGRADE_WARNING: オブジェクト fpSpd.Action の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'fpSpd.Action = FPSpreadADO.ActionConstants.ActionActiveCell
			FpSpd.ActiveSheet.SetActiveCell(ret, FpSpd.ActiveSheet.ActiveColumnIndex)
			'        End If
...
Delete発注情報_Err:
	...
	Private Sub Cb端数値引計算_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Cb端数値引計算.Click
		...
		'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		w端数抜金額 = ISRoundDown(w税込金額, CDec(NullToZero(tx_端数値引桁数.Text, 0)) * -1)

		w端数値引金額 = (w税込金額 - w端数抜金額) - (ISHasuu_rtn(HD_消費税端数, (w税込金額 - w端数抜金額) / (100 + gZEI) * gZEI, KIN_HASU))

		'マイナス表示
		[rf_端数値引金額].Text = (w端数値引金額 * -1).ToString("#,##0") & KIN_FMT
...
keisan_err:
	...
	Private Sub CbWel1パー算出_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CbWel1パー算出.Click
		...
		With FpSpd
			'最終行取得
			'For i = .ActiveSheet.NonEmptyRowCount - 1 To 0 Step -1
			For i = clsSPD.GetLastNonEmptyRowEx("MT02F00") To 0 Step -1
				getdata = .ActiveSheet.GetText(i, Col製品NO) '製品NO
				If Not getdata.ToString().Trim() = "" Then
					Exit For
				End If
			Next
			MaxRow = i + 1
		...
		'UPGRADE_WARNING: オブジェクト fpSpd.MaxCols の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト fpSpd.DataRowCnt の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		ReDim WkTBLS(MaxRow, FpSpd.ActiveSheet.ColumnCount) '大きさ変えて

		'UPGRADE_WARNING: オブジェクト fpSpd.GetArray の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		WkTBLS = FpSpd.ActiveSheet.GetArray(0, 0, MaxRow, FpSpd.ActiveSheet.ColumnCount) '値をセット

		Kei = 0
		'Loop
		For i = 0 To UBound(WkTBLS)
			'2016/02/09 ADD↓
			With cSeihin
				.Initialize()
				'UPGRADE_WARNING: オブジェクト WkTBLS(i, Col製品NO) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				If .GetbyID = True Then
					If .[費用区分] = 0 Then '材料費
						'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						Kei += SpcToNull(WkTBLS(i, Col金額), 0)
					End If
				Else
					'コードがない場合は材料費とする
					'UPGRADE_WARNING: オブジェクト SpcToNull() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		...
		'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'rf_1パー金額.Text = (System.Math.Round(Kei * NullToZero([tx_Welパー算出].Text / 100, 0))).ToString("#,##0") '2017/01/17 ADD
		rf_1パー金額.Text = System.Math.Round(Kei * CDbl(NullToZero([tx_Welパー算出].Text / 100, 0))).ToString("#,##0") '2017/01/17 ADD
		WriteIni("Disp", "WelPercent", ([tx_Welパー算出].Text), INIFile) '2017/01/17 ADD
	End Sub
	'2015/10/19 ADD↑

	'2023/09/26 ADD↓
	Private Function Getインボイス番号NGColor(ByRef siicd As Object) As Color
		...
		If cSiiresaki.GetbyID Then
			If cSiiresaki.インボイス登録番号 = "" Then
				Getインボイス番号NGColor = Color.Red
			Else
				Getインボイス番号NGColor = Color.Black
			End If
		Else
			Getインボイス番号NGColor = Color.Red
		End If
	...
	Private Sub tx_見積確定区分_Change(Sender As Object, e As EventArgs) Handles tx_見積確定区分.Change

		If Loaded = False Then Exit Sub

		LcbFunc(10).Text = "ﾁｪｯｸ"

		HD_見積確定区分 = NullToZero([tx_見積確定区分].Text)  '2024/06/21 ADD
