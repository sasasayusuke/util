...
Public Class TokSen_cls
	...
	Private Sub TokSen_cls_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub TokSen_cls_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Resize
	...
	Private Sub TokSen_cls_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
		'Dim i, j As Integer
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "得意先CD", CInt(VB6Conv.TwipsToPixelsX(1050)))
			.Columns.Add("", "得意先名1", CInt(VB6Conv.TwipsToPixelsX(3500)))
			.Columns.Add("", "得意先名2", CInt(VB6Conv.TwipsToPixelsX(3500)))
		End With
...
Form_Load_Err:
	...
	Private Sub TokSen_cls_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
	...
	Private Function Download() As Boolean
		...
		If [tx_検索ID].Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " 得意先CD >= '" & SQLString([tx_検索ID].Text) & "'"
		End If
		If tx_検索名.Text <> vbNullString Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & " 得意先名1 LIKE '%" & SQLString(tx_検索名.Text) & "%'"
		End If
		...
		Do Until rs.EOF
			Buf = New String("0"c, TokuIDLength) & "0" 'ひとつ余計にする
