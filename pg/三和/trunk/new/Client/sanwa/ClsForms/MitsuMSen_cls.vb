...
Public Class MitsuMSen_cls
	...
	'値返還用
	Public m_Parent As clsMitsumoriM
	...
	Private Sub MitsuMSen_cls_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub MitsuMSen_cls_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Resize
	...
	Private Sub MitsuMSen_cls_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Load
		'Dim i, j As Integer
		...
		With SelListVw
			.Columns.Clear()
			.Columns.Add("", "見積明細連番", CInt(VB6Conv.TwipsToPixelsX(0)))
			.Columns.Add("", "見積番号", CInt(VB6Conv.TwipsToPixelsX(0)))
			.Columns.Add("", "見積日付", CInt(VB6Conv.TwipsToPixelsX(0))) '2020/09/16 ADD
			.Columns.Add("", "見積件名", CInt(VB6Conv.TwipsToPixelsX(0)))
			.Columns.Add("", "行番号", CInt(VB6Conv.TwipsToPixelsX(0)))
			.Columns.Add("", "製品NO", CInt(VB6Conv.TwipsToPixelsX(1500)))
			.Columns.Add("", "仕様NO", CInt(VB6Conv.TwipsToPixelsX(1000)))
			.Columns.Add("", "ﾍﾞｰｽ色", CInt(VB6Conv.TwipsToPixelsX(1000)))
			.Columns.Add("", "漢字名称", CInt(VB6Conv.TwipsToPixelsX(4600)))
			.Columns.Add("", "Ｗ", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "Ｄ", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "Ｈ", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "Ｄ１", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "Ｄ２", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "Ｈ１", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "Ｈ２", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "備考", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("見積数量", CInt(VB6Conv.TwipsToPixelsX(1300)), System.Windows.Forms.HorizontalAlignment.Right)
			.Columns.Add("", "単位", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("定価", CInt(VB6Conv.TwipsToPixelsX(1300)), System.Windows.Forms.HorizontalAlignment.Right)
			.Columns.Add("仕入単価", CInt(VB6Conv.TwipsToPixelsX(1300)), System.Windows.Forms.HorizontalAlignment.Right)
			.Columns.Add("売上単価", CInt(VB6Conv.TwipsToPixelsX(1300)), System.Windows.Forms.HorizontalAlignment.Right)
			.Columns.Add("", "売上税区分", CInt(VB6Conv.TwipsToPixelsX(0)))
			.Columns.Add("", "", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "仕入業者名", CInt(VB6Conv.TwipsToPixelsX(1395)))
			.Columns.Add("", "", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "出荷元名", CInt(VB6Conv.TwipsToPixelsX(1395)))
			.Columns.Add("", "", CInt(VB6Conv.TwipsToPixelsX(600)))
			.Columns.Add("", "送り先名", CInt(VB6Conv.TwipsToPixelsX(1395)))
...
Form_Load_Err:
	...
	Private Sub MitsuMSen_cls_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
...
EventExitSub:
	...
	Private Sub tx_仕入業者CD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles tx_仕入業者CD.KeyPress
		Dim KeyAscii As Integer = Asc(eventArgs.KeyChar)
		If KeyAscii = Asc(" ") And ([tx_仕入業者CD].SelStart = 0 And [tx_仕入業者CD].SelLength = Len([tx_仕入業者CD].Text)) Then
			KeyAscii = 0
			'---参照画面表示
			SelectF = True
	...
	Private Sub tx_仕入先CD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles tx_仕入先CD.KeyPress
		Dim KeyAscii As Integer = Asc(eventArgs.KeyChar)
		If KeyAscii = Asc(" ") And ([tx_仕入先CD].SelStart = 0 And [tx_仕入先CD].SelLength = Len([tx_仕入先CD].Text)) Then
			KeyAscii = 0
			'---参照画面表示
			SelectF = True
			If cSiiresaki.ShowDialog = True Then
	...
	Private Function Item_Check(ByRef ItemNo As Integer) As Boolean
		...
		If ItemNo > [tx_仕入業者CD].TabIndex Then
			...
			If ISInt(([tx_仕入業者CD].Text)) Then
				...
				[tx_仕入業者CD].Text = CType([tx_仕入業者CD].Text, Integer).ToString(New String("0"c, [tx_仕入業者CD].MaxLength))
			End If
		End If
		...
		If ItemNo > [tx_仕入先CD].TabIndex Then
			...
			If ISInt(([tx_仕入先CD].Text)) Then
				...
				[tx_仕入先CD].Text = CType([tx_仕入先CD].Text, Integer).ToString(New String("0"c, [tx_仕入先CD].MaxLength))
			End If
		End If
	...
	Private Function Download() As Boolean
		...
		If IsCheckText([tx_得意先CD]) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MH.得意先CD LIKE '" & SQLString([tx_得意先CD].Text) & "%'"
		End If
		'納入先
		If IsCheckText([tx_納入先CD]) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MH.納入先CD Like '" & SQLString([tx_納入先CD].Text) & "%'"
		End If
		'見積件名
		If IsCheckText(tx_見積件名) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MH.見積件名 Like '%" & SQLString(tx_見積件名.Text) & "%'"
		End If
		'仕入業者
		If IsCheckText([tx_仕入業者CD]) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.仕入業者CD Like '" & SQLString([tx_仕入業者CD].Text) & "%'"
		End If
		'仕入先
		If IsCheckText([tx_仕入先CD]) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.仕入先CD Like '" & SQLString([tx_仕入先CD].Text) & "%'"
		End If
		'製品NO
		If IsCheckText(tx_検索製品) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.製品NO Like '" & SQLString(tx_検索製品.Text) & "%'"
		End If
		'仕様NO
		If IsCheckText(tx_検索仕様) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.仕様NO Like '" & SQLString(tx_検索仕様.Text) & "%'"
		End If
		'漢字名称
		If IsCheckText(tx_検索名称) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.漢字名称 Like '%" & SQLString(tx_検索名称.Text) & "%'"
		End If
		'W
		If IsCheckText(tx_W) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.W Like '%" & SQLString(tx_W.Text) & "%'"
		End If
		'D
		If IsCheckText(tx_D) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.D Like '%" & SQLString(tx_D.Text) & "%'"
		End If
		'H
		If IsCheckText([tx_H]) = True Then
			If whr <> "" Then
				whr = whr & " and "
			End If
			whr = whr & "MSM.H Like '%" & SQLString([tx_H].Text) & "%'"
		End If
		...
		Do Until rs.EOF
			...
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("見積日付").Value), ""), DateTime).ToString("yy/MM/dd")) '2020/09/19 ADD
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("W").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("D").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("H").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("D1").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("D2").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("H1").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("H2").Value), ""), Integer).ToString("#"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(NullToZero((rs.Fields("明細備考").Value), "")))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("見積数量").Value), ""), Integer).ToString("#,##0"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CStr(NullToZero((rs.Fields("単位名").Value), "")))

			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("定価").Value), ""), Integer).ToString("#,##0"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("仕入単価").Value), ""), Integer).ToString("#,##0"))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("売上単価").Value), ""), Integer).ToString("#,##0"))
			'        itmX.ListSubItems.Add , , Format$(NullToZero(rs("U区分").Value, ""), "#")
			'        itmX.ListSubItems.Add , , Format$(NullToZero(rs("M区分").Value, ""), "#")
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(CType(NullToZero((rs.Fields("売上税区分").Value), ""), Integer).ToString("#"))

			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("仕入業者CD").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("仕入業者名").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("仕入先CD").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("仕入先名").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("配送先CD").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("配送先名").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			itmX.SubItems.Add(NullToZero((rs.Fields("作業区分CD").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'itmX.SubItems.Add(CType(NullToZero((rs.Fields("製品区分").Value), ""), Integer).ToString("#"))
			itmX.SubItems.Add(NullToZero((rs.Fields("製品区分").Value), ""))
			'UPGRADE_WARNING: オブジェクト NullToZero() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'itmX.SubItems.Add(CType(NullToZero((rs.Fields("見積区分").Value), 0), Integer).ToString("#"))
			itmX.SubItems.Add(NullToZero((rs.Fields("見積区分").Value), ""))
			rs.MoveNext()
		Loop
		ReleaseRs(rs)
