...
Public Class SeiSenArray_cls
	...
	Public m_DialogResultCodes() As Object
	'クラス
	...
	Public ReadOnly Property DialogResultCodes() As Object
		Get
			...
			DialogResultCodes = VB6Conv.CopyArray(m_DialogResultCodes)
		End Get
	End Property
	...
	Private Sub SeiSenArray_cls_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub SeiSenArray_cls_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Resize
	...
	Private Sub SeiSenArray_cls_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Me.Load
		'Dim i, j As Integer
...
Form_Load_Err:
	...
	Private Sub SeiSenArray_cls_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
