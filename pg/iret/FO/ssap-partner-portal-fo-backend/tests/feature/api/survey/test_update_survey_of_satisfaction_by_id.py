...
class TestUpdateSurveyOfSatisfactionById:
    @pytest.mark.parametrize(
        "body, survey_model, expected, admin_models, user_supporter_mgr_models, user_models, get_user_model, survey_master_model, project_model",
        [
            (
                {
                    "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdXJ2ZXlfaWQiOiJjMGNkMzk1MC0zOTNlLTRiNjYtYjFhMC02NThiMjZmNzRmMmIiLCJpYXQiOjE2OTk0MDE2MDAsImV4cCI6MTc2Nzc5Nzk5OX0.Gfhh5aBRhCmvfo-6YkTjc9RPaLmdXVnSO1QUtTSEXKQ",
                    "answers": [
                        {
    ...
    def test_ok(
        ...
        mock_user_get.return_value = get_user_model
        ...
        response = client.put(
            f"/api/surveys/satisfaction/{survey_id}?version={version}", json=body
        )
