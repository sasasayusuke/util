...
def test_model_man_hour_supporter_organization_summary():
    ...
    supporter_organization_summary_item_by_query = (
        ManHourSupporterOrganizationSummaryModel.year_month_data_type_index.query(
            year_month, data_type
        )
    )

    assert str(supporter_organization_summary) == str(
        supporter_organization_summary_item
    )
...
def test_model_man_hour_project_summary():
    ...
    project_summary_item = ManHourProjectSummaryModel.get(data_type, year_month)
    project_summary_item_by_query = (
...
def test_model_man_hour_service_type_summary():
    ...
    service_type_summary = ManHourServiceTypeSummaryModel(data_type, year_month)
    ...
    service_type_summary_item_by_query = (
