...
class TestBulkCreateSurveySchedules:
    ...
    def test_ok(
        ...
        response = client.post(
            f"/api/schedules/survey/bulk/{project_id}",
            json=body,
    ...
    def test_auth_ok(
        ...
        survey_master_service_mock.return_value = SurveyMasterModel(
            id="89cbe2ed-f44c-4a1c-9408-c67b0ca2270d",
            revision=1,
            name="サービスアンケート",
            type="service",
        ...
        survey_master_completion_mock.return_value = SurveyMasterModel(
            id="89cbe2ed-f44c-4a1c-9408-c67b0ca2270d",
            revision=1,
            name="修了アンケート",
            type="completion",
