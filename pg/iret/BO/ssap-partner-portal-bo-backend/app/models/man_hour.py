...
class YearMonthDataTypeIndexForSupporter(GlobalSecondaryIndex):
    """GSI：年月データ区分検索
...
class YearMonthDataTypeIndexForSupporterSummary(GlobalSecondaryIndex):
    """GSI：年月データ区分検索
    複数ファセットを持つテーブルのため、別名でGSIを定義する
    """
...
class YearMonthDataTypeIndexForSupporterOrganizationSummary(GlobalSecondaryIndex):
    """GSI：年月データ区分検索
    複数ファセットを持つテーブルのため、別名でGSIを定義する
    """
...
class YearMonthDataTypeIndexForProjectSummary(GlobalSecondaryIndex):
    """GSI：年月データ区分検索
    複数ファセットを持つテーブルのため、別名でGSIを定義する
    """
...
class YearMonthDataTypeIndexForServiceTypeSummary(GlobalSecondaryIndex):
    """GSI：年月データ区分検索
    複数ファセットを持つテーブルのため、別名でGSIを定義する
    """
...
class ManHourSupporterModel(Model):
    ...
    year_month_data_type_index = YearMonthDataTypeIndexForSupporter()
...
class ManHourSupporterOrganizationSummaryModel(Model):
    ...
    year_month_data_type_index = YearMonthDataTypeIndexForSupporterOrganizationSummary()
...
class ManHourProjectSummaryModel(Model):
    ...
    year_month_data_type_index = YearMonthDataTypeIndexForProjectSummary()
...
class ManHourServiceTypeSummaryModel(Model):
    ...
    year_month_data_type_index = YearMonthDataTypeIndexForServiceTypeSummary()
