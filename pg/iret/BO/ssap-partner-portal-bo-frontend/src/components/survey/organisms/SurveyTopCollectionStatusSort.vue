<template>
  <CommonSort
    ...
    @clear="clear"
  >
    <SurveyTopCollectionStatusSortInput
...
import SurveyTopCollectionStatusSortInput from '~/components/survey/molecules/SurveyTopCollectionStatusSortInput.vue'
...
export default BaseComponent.extend({
  ...
  computed: {
    /** 表示年 */
    selectedYear() {
      return format(new Date(this.param.yearMonthFrom), 'yyyy')
    },
  },
  methods: {
    /**
