...
class SeikyusyoService(BaseService):
    """請求書発行"""
    ...
    def delete(self,session,request):
        ...
        select_query = "select 見積番号,請求日付 from TD売上請求H where 見積番号 = {}".format(estimate_no)
        ...
        delete_query = "delete from TD売上請求H where 見積番号 = {}".format(estimate_no)
