// 製品検索ダイアログ作成
{
    ...
    create_searchDialog(dialogId,'TM製品',[
        ...
        {type:'number',id:'W',label:'W',forColumnName:'W',options:{
            width:'wide',
            newLine:true,
        }},
        {type:'number',id:'D',label:'D',forColumnName:'D',options:{
            width:'wide',
        }},
        {type:'number',id:'H',label:'H',forColumnName:'H',options:{
            width:'wide',
        }},
        {type:'number',id:'D1',label:'D1',forColumnName:'D1',options:{
            width:'wide',
            newLine:true,
        }},
        {type:'number',id:'D2',label:'D2',forColumnName:'D2',options:{
            width:'wide',
        }},
        {type:'number',id:'H1',label:'H1',forColumnName:'H1',options:{
            width:'wide',
        }},
        {type:'number',id:'H2',label:'H2',forColumnName:'H2',options:{
            width:'wide',
        }},
