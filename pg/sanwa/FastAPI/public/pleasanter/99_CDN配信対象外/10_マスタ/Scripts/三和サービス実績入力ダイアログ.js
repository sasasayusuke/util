{
    ...
    commonModifyLink(dialogName, function() {openDialog(dialogId,'750','px',function(){
		...
		$('#sanwaServiceAchivementInput .h300').css("height","auto");
		$('#sanwaServiceAchivementInput .wrapper').css("min-height","auto");
    })})
}
	// テーブルを強化する関数
...
async function sanwaServiceAchivementInput_func(dialogId,category,dialogName,btnLabel){
	...
	try{
		...
		const result = $('#sanwaServiceAchivementInput').prev().children('.ui-dialog-title').text();
		var button_str = btnLabel
		if(!confirm(button_str + 'します。\nよろしいですか？'))return;
		if(result == '三和サービス実績入力  -- 修正'){
			if(button_str == '保存'){
				button_str = '更新'
			}
		}
		...
		let item_params = {
			...
			"@売額_貨物自_三商":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_0_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_三商":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_0_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物自_店装":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_1_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_店装":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_1_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物自_サンプラ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_2_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_サンプラ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_2_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物自_三シャ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_3_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_三シャ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_3_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物自_トラン":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_4_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_トラン":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_4_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物自_その他":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_5_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_その他":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_5_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物自_事故":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_6_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物自_事故":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_6_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_三商":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_7_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_三商":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_7_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_店装":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_8_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_店装":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_8_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_サンプラ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_9_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_サンプラ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_9_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_三シャ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_10_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_三シャ":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_10_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_トラン":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_11_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_トラン":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_11_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_その他":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_12_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_その他":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_12_1 input`).val().replaceAll(',',''),0),
			"@売額_貨物庸_事故":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_13_0 input`).val().replaceAll(',',''),0),
			"@原額_貨物庸_事故":SpcToNull($(`#sanwaServiceAchivementInput_tbl1_13_1 input`).val().replaceAll(',',''),0),
			"@人件一般費_貨物":SpcToNull($('#sanwaServiceAchivementInput_tbl1PersonExpense').val().replaceAll(',',''),0),
			"@営業外費_貨物":SpcToNull($('#sanwaServiceAchivementInput_tbl1NonSaleExpense').val().replaceAll(',',''),0),
			"@売額_物流_ルート":SpcToNull($('#sanwaServiceAchivementInput_tbl2_0_0 input').val().replaceAll(',',''),0),
			"@原額_物流_ルート":SpcToNull($('#sanwaServiceAchivementInput_tbl2_0_1 input').val().replaceAll(',',''),0),
			"@売額_物流_丸和":SpcToNull($('#sanwaServiceAchivementInput_tbl2_1_0 input').val().replaceAll(',',''),0),
			"@原額_物流_丸和":SpcToNull($('#sanwaServiceAchivementInput_tbl2_1_1 input').val().replaceAll(',',''),0),
			"@売額_物流_その他":SpcToNull($('#sanwaServiceAchivementInput_tbl2_2_0 input').val().replaceAll(',',''),0),
			"@原額_物流_その他":SpcToNull($('#sanwaServiceAchivementInput_tbl2_2_1 input').val().replaceAll(',',''),0),
			"@売額_物流_事故":SpcToNull($('#sanwaServiceAchivementInput_tbl2_3_0 input').val().replaceAll(',',''),0),
			"@原額_物流_事故":SpcToNull($('#sanwaServiceAchivementInput_tbl2_3_1 input').val().replaceAll(',',''),0),
			"@人件一般費_物流":SpcToNull($('#sanwaServiceAchivementInput_tbl2PersonExpense').val().replaceAll(',',''),0),
			"@営業外費_物流":SpcToNull($('#sanwaServiceAchivementInput_tbl2NonSaleExpense').val().replaceAll(',',''),0),
			"LoginId":$("#LoginId").val(),
		};
