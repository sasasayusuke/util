  ...
  <dl id="master-karte-sort">
    ...
    <dd>
      <v-row class="main-sort-row">
        ...
        <v-col cols="4">
          <TextFieldLabel
            :label="$t('master-karte.pages.list.sort.targetProject.headline')"
          />
          <RadioGroup
            v-model="localSearchParams.all"
            :values="allRadioButtonValues"
            :labels="allRadioButtonLabels"
            :horizontal="true"
            :bg-white="true"
          />
        </v-col>
          ...
          <v-expansion-panel-content>
            <div class="text-fields-row mb-6">
              ...
              <RadioGroup
                ...
                :values="isCurrentProgramRadioButtonValues"
                :labels="isCurrentProgramRadioButtonLabels"
                :horizontal="true"
                :bg-white="true"
              />
            </div>
            <v-row class="mb-2">
              <v-col cols="4">
                <TextFieldLabel
                  ...
                  :disabled="
                    ...
                    isCurrentProgramRadioButtonValues[1]
                  "
                />
                <Select
              ...
              <v-col cols="4">
                ...
                <TextField
                  ...
                  :disabled="
                    localDetailSearchParams.isCurrentProgram ===
                    isCurrentProgramRadioButtonValues[0]
                  "
                  :transmission-disabled="true"
                />
              </v-col>
...
export default BaseComponent.extend({
  ...
  data() {
    return {
      ...
      /** 対象案件のラジオボタン ラジオ一覧 */
      allRadioButtonLabels: [
        this.$t('master-karte.pages.list.sort.targetProject.charge'),
        this.$t('master-karte.pages.list.sort.targetProject.all'),
      ],
      /** 対象案件のラジオボタン バリュー一覧 */
      allRadioButtonValues: [false, true],
      /** 検索対象のラジオボタン ラベル一覧 */
      isCurrentProgramRadioButtonLabels: [
        this.$t(
      ...
      /** 検索対象のラジオボタン バリュー一覧 */
      isCurrentProgramRadioButtonValues: [true, false],
      /** 顧客セグメントのセレクターアイテム一覧 */
