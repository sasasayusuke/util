...
export default BaseComponent.extend({
  ...
  methods: {
    /** 支援期間開始日をセット */
    inputStartTime(val: string) {
      this.localAddSupportSchedule.startTime = val
    ...
    /** 支援期間終了日をセット */
    inputEndTime(val: string) {
      this.localAddSupportSchedule.endTime = val
      this.timeReversalCheck(
        this.localAddSupportSchedule.startTime,
        this.localAddSupportSchedule.endTime
      )
