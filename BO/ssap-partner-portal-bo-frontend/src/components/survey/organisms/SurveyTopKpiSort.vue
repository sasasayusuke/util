<template>
  <CommonSort
    ...
    @clear="clear"
  >
    <SurveyTopKpiSortInput :param="param" v-on="$listeners" @update="update" />
  </CommonSort>
</template>
...
import SurveyTopKpiSortInput from '~/components/survey/molecules/SurveyTopKpiSortInput.vue'
