...
# ref: https://pandas.pydata.org/docs/reference/api/pandas.date_range.html
...
# TODO: 支援スケジュール作成APIリファクタが終わったら消す
def get_continuous_date_for_each_week_old(
    start_date: datetime, end_date: datetime, day_of_week: str
) -> List:
    """指定期間中の週ごとの連続した日時データリストを取得します。
