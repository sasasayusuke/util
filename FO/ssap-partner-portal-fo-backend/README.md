# Sony Acceleration Platform PartnerPortal FrontOffice Backend

[![Job Status](https://inspecode.rocro.com/badges/github.com/staqct/ssap-partner-portal-fo-backend/status?token=6D3ka2SYT2v-oj5MObuvW2fPwzS-JaA42IpIFHch9Go)](https://inspecode.rocro.com/jobs/github.com/staqct/ssap-partner-portal-fo-backend/latest?completed=true)
[![Report](https://inspecode.rocro.com/badges/github.com/staqct/ssap-partner-portal-fo-backend/report?token=6D3ka2SYT2v-oj5MObuvW2fPwzS-JaA42IpIFHch9Go&branch=develop)](https://inspecode.rocro.com/reports/github.com/staqct/ssap-partner-portal-fo-backend/branch/develop/summary)
[![develop deploy workflow](https://github.com/staqct/ssap-partner-portal-fo-backend/actions/workflows/develop_deploy_workflow.yml/badge.svg?branch=develop)](https://github.com/staqct/ssap-partner-portal-fo-backend/actions/workflows/develop_deploy_workflow.yml)
[![Open API deploy](https://github.com/staqct/ssap-partner-portal-fo-backend/actions/workflows/open_api_deploy.yml/badge.svg)](https://github.com/staqct/ssap-partner-portal-fo-backend/actions/workflows/open_api_deploy.yml)
...
リポジトリをクローンし、/ssap-partner-portal-fo-backend に移動します。

```
git clone https://github.com/staqct/ssap-partner-portal-fo-backend
...
- [Open API](https://github.com/staqct/ssap-partner-portal-fo-backend/blob/develop/docs/api/openapi.yaml)
- [Swagger UI](https://openapi.dev.partner-portal.inhouse-sony-startup-acceleration-program.com/fo/swagger-ui/index.html)
- [Redoc](https://openapi.dev.partner-portal.inhouse-sony-startup-acceleration-program.com/fo/redoc.html)
