...
class TestUpdateMasterKartenById:
    ...
    def test_ok_current_program(self, mocker):
        ...
        pf_api_mock = mocker.patch.object(PlatformApiOperator, "update_program_by_id")
        ...
        response = client.put(
            "/api/master-karten/89cbe2ed-f44c-4a1c-9408-c67b0ca2270d?isCurrentProgram=true",
            json=body,
        )
    ...
    def test_ok_next_program(self, mocker):
        ...
        response = client.put(
            "/api/master-karten/89cbe2ed-f44c-4a1c-9408-c67b0ca2270d?isCurrentProgram=false",
            json=body,
        )
        assert response.status_code == 200
