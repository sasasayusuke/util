...
def test_model_survey_summary_user():
    ...
    summary_month = datetime.now().strftime("%Y/%m")
    data_type = "user#1"

    survey_summary_user = SurveySummaryUserModel(
        summary_month=summary_month,
        data_type=data_type,
        name="田中太郎",
        service_satisfaction_summary=1,
        service_satisfaction_average=1,
        service_satisfaction_unanswered=1,
        service_receive=1,
        completion_satisfaction_summary=1,
        completion_satisfaction_average=1,
        ...
        completion_continuation_percent=1,
        completion_continuation_unanswered=1,
        completion_recommended_summary=1,
        completion_recommended_average=1,
        completion_recommended_unanswered=1,
        completion_sales_summary=1,
        completion_sales_average=1,
        completion_sales_unanswered=1,
        completion_receive=1,
        quick_receive=1,
