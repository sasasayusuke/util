  ...
  <ModalEdit :title="title">
        ...
        <v-row>
          ...
          <v-col class="pa-0">
            ...
            <CommonDetailRow
              ...
              :value="localSurveyBulkCreate.service.requestDate"
              cols="4"
              required
              class="is-noborder"
              tall
            ...
            <CommonDetailRow
              ...
              :is-editing="isEditing"
              :value="$t('project.pages.edit.survey.row.sub.deadline.label')"
              cols="4"
              required
              tall
              class="is-noborder"
        ...
        <v-row>
          ...
          <v-col class="pa-0">
            ...
            <CommonDetailRow
              :label="$t('project.pages.edit.survey.row.sub.send.label')"
              :is-editing="isEditing"
              :value="localSurveyBulkCreate.completion.requestDate"
              cols="4"
              required
              class="is-noborder"
              tall
            ...
            <CommonDetailRow
              :label="$t('project.pages.edit.survey.row.sub.deadline.label')"
              :is-editing="isEditing"
              :value="localSurveyBulkCreate.completion.limitDate"
              cols="4"
              required
              tall
              class="is-noborder"
    ...
    <template #foot>
      <Button
        ...
        width="160"
        @click="$emit('click:closeBulkCreate')"
      >
      ...
      <Button
        ...
        @click="$emit('click:save', localSurveyBulkCreate)"
      >
...
export default BaseComponent.extend({
  ...
  created() {
    this.localSurveyBulkCreate.service.requestDate =
      this.getInitSendDaySetting('service')
    this.localSurveyBulkCreate.service.limitDate =
      this.getInitAnswerLimitDaySetting('service')
    this.localSurveyBulkCreate.completion.requestDate =
      this.getInitSendDaySetting('completion')
    this.localSurveyBulkCreate.completion.limitDate =
  ...
  methods: {
    ...
    serviceValidationCorrect() {
      ...
      this.localSurveyBulkCreate.service.requestDate = adjustNumber(
        this.localSurveyBulkCreate.service.requestDate,
    ...
    completionValidationCorrect() {
      ...
      this.localSurveyBulkCreate.completion.requestDate = adjustNumber(
        this.localSurveyBulkCreate.completion.requestDate,
        this.minRequestDateSetting,
        this.maxRequestDateSetting
      )
    ...
    setLocalParam() {
      ...
      if (
        ...
        //毎月○日:1-31
        this.localSurveyBulkCreate.service.requestDate = Number(
          this.serviceInput.requestDate.dayEveryMonth
        )
      }
      ...
      if (
        ...
        // 〇営業日後:1～30
        this.localSurveyBulkCreate.service.limitDate = Number(
          this.serviceInput.limitDate.daysAfterSent
        )
      }
      if (
      ...
      if (
        ...
        //毎月○日:1-31
        this.localSurveyBulkCreate.completion.requestDate = Number(
          this.completionInput.requestDate.dayEveryMonth
        )
      }
      ...
      if (
        ...
        // 〇営業日後:1～30
        this.localSurveyBulkCreate.completion.limitDate = Number(
          this.completionInput.limitDate.daysAfterSent
        )
      }
