  ...
  >
    <Sheet>
      <Button
        ...
        v-on="on"
      >
        <Icon class="m-button-profile__icon--in" size="36" color="btn_primary"
          >icon-org-account</Icon
        >
        <Icon class="m-button-profile__icon--out" size="36" color="btn_primary"
...
export default BaseComponent.extend({
  ...
  data() {
    return {
      items: [
        {
          label: this.$t('header.profile.menu.mailChange'),
          name: 'mailChange',
          href: `${process.env.SSAP_SITE_URL}email_reset/new`,
          otherPage: true,
        },
        {
          label: this.$t('header.profile.menu.passwordChange'),
          name: 'passwordChange',
          href: `${process.env.SSAP_SITE_URL}password/edit`,
          otherPage: true,
        },
        {
          label: this.$t('header.profile.menu.signOut'),
          name: 'signOut',
          onClick() {
            // VueXの削除
        ...
        {
          label: this.$t('header.profile.menu.resign'),
          name: 'resign',
