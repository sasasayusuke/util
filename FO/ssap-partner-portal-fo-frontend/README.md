# Sony Acceleration Platform Partner Portal FrontOffice Frontend

[![Job Status](https://inspecode.rocro.com/badges/github.com/staqct/ssap-partner-portal-fo-frontend/status?token=A4_6CC0SZrO8hVL9Z9ieh-Jh5ZlKkbhXbZGW_30eUYA)](https://inspecode.rocro.com/jobs/github.com/staqct/ssap-partner-portal-fo-frontend/latest?completed=true)
[![Report](https://inspecode.rocro.com/badges/github.com/staqct/ssap-partner-portal-fo-frontend/report?token=A4_6CC0SZrO8hVL9Z9ieh-Jh5ZlKkbhXbZGW_30eUYA&branch=develop)](https://inspecode.rocro.com/reports/github.com/staqct/ssap-partner-portal-fo-frontend/branch/develop/summary)
[![develop_deploy](https://github.com/staqct/ssap-partner-portal-fo-frontend/actions/workflows/develop_deploy.yml/badge.svg?branch=develop)](https://github.com/staqct/ssap-partner-portal-fo-frontend/actions/workflows/develop_deploy.yml)
...
```
git clone https://github.com/staqct/ssap-partner-portal-fo-frontend.git
cd ssap-partner-portal-fo-frontend/
npm ci
```
...
3. ~Remote-Container を起動~ リモートコンテナは動作が重いため、ローカルで作業する
